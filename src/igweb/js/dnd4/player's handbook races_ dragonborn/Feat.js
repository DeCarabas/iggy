(function(global, undefined) {
  ...
  te = Feat["Adaptable Breath"] = new RulesElement({
  ...
  te = Feat["Adaptable Breath II"] = new RulesElement({
  ...
  te = Feat["Adaptable Breath III"] = new RulesElement({
  ...
  te = Feat["Adaptable Breath IV"] = new RulesElement({
  ...
  te = Feat["Admixture Breath"] = new RulesElement({
  ...
  te = Feat["Ancient Soul"] = new RulesElement({
    name: "Ancient Soul",
    type: "Feat",
    id: "ID_FMP_FEAT_2175",
  ...
  te = Feat["Bolstering Breath"] = new RulesElement({
  ...
  te = Feat["Burning Breath"] = new RulesElement({
    name: "Burning Breath",
    type: "Feat",
    id: "ID_FMP_FEAT_2211",
    source: "Player's Handbook Races: Dragonborn",
  ...
  te = Feat["Concussive Breath"] = new RulesElement({
  ...
  te = Feat["Conflagration Breath"] = new RulesElement({
  ...
  te = Feat["Corrosive Breath"] = new RulesElement({
  ...
  te = Feat["Covenant of Io"] = new RulesElement({
    name: "Covenant of Io",
    type: "Feat",
    id: "ID_FMP_FEAT_2177",
    source: "Player's Handbook Races: Dragonborn",
  ...
  te = Feat["Critical Breath"] = new RulesElement({
  ...
  te = Feat["Daunting Breath"] = new RulesElement({
  ...
  te = Feat["Debilitating Breath"] = new RulesElement({
  ...
  te = Feat["Dissolving Breath"] = new RulesElement({
  ...
  te = Feat["Draconic Blast"] = new RulesElement({
    name: "Draconic Blast",
    type: "Feat",
    id: "ID_FMP_FEAT_2179",
    source: "Player's Handbook Races: Dragonborn",
  ...
  te = Feat["Draconic Combat Challenge"] = new RulesElement({
  ...
  te = Feat["Draconic Enmity"] = new RulesElement({
  ...
  te = Feat["Draconic Healing"] = new RulesElement({
  ...
  te = Feat["Draconic Hunter"] = new RulesElement({
  ...
  te = Feat["Draconic Majesty"] = new RulesElement({
  ...
  te = Feat["Draconic Restoration"] = new RulesElement({
  ...
  te = Feat["Draconic Triumph"] = new RulesElement({
  ...
  te = Feat["Dragonborn Zeal"] = new RulesElement({
  ...
  te = Feat["Focused Breath"] = new RulesElement({
    name: "Focused Breath",
    type: "Feat",
    id: "ID_FMP_FEAT_2202",
    source: "Player's Handbook Races: Dragonborn",
  ...
  te = Feat["Freezing Breath"] = new RulesElement({
  ...
  te = Feat["Frost Breath"] = new RulesElement({
    name: "Frost Breath",
    type: "Feat",
    id: "ID_FMP_FEAT_2214",
    source: "Player's Handbook Races: Dragonborn",
  ...
  te = Feat["Glorious Victory"] = new RulesElement({
  ...
  te = Feat["Hurl Breath"] = new RulesElement({
    name: "Hurl Breath",
    type: "Feat",
    id: "ID_FMP_FEAT_725",
    source: "Player's Handbook Races: Dragonborn,Dragon Magazine 365",
  ...
  te = Feat["Inspiring Triumph"] = new RulesElement({
  ...
  te = Feat["Io's Challenge"] = new RulesElement({
    name: "Io's Challenge",
    type: "Feat",
    id: "ID_FMP_FEAT_2205",
    source: "Player's Handbook Races: Dragonborn",
  ...
  te = Feat["Opportunity Breath"] = new RulesElement({
  ...
  te = Feat["Powerful Breath"] = new RulesElement({
  ...
  te = Feat["Raging Drake Form"] = new RulesElement({
  ...
  te = Feat["Spirit Breath"] = new RulesElement({
    name: "Spirit Breath",
    type: "Feat",
    id: "ID_FMP_FEAT_2216",
    source: "Player's Handbook Races: Dragonborn",
  ...
  te = Feat["Surprising Breath"] = new RulesElement({
  ...
  te = Feat["Thundering Breath"] = new RulesElement({
  ...
  te = Feat["Toxic Breath"] = new RulesElement({
    name: "Toxic Breath",
    type: "Feat",
    id: "ID_FMP_FEAT_2218",
    source: "Player's Handbook Races: Dragonborn",
