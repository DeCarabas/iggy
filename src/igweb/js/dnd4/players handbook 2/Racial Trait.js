define(['engine', 'dnd4model'], function(engine, dnd4model) {
  ...
  te = Racial_Trait["Astral Majesty"] = new engine.RulesElement({
    name: "Astral Majesty",
    type: "Racial Trait",
  ...
  te = Racial_Trait["Astral Resistance"] = new engine.RulesElement({
  ...
  te = Racial_Trait["Fade Away"] = new engine.RulesElement({
    name: "Fade Away",
    type: "Racial Trait",
  ...
  te = Racial_Trait["Furious Assault"] = new engine.RulesElement({
  ...
  te = Racial_Trait["Half-Orc Resilience"] = new engine.RulesElement({
  ...
  te = Racial_Trait["Immortal Origin"] = new engine.RulesElement({
  ...
  te = Racial_Trait["Longtooth Shifting"] = new engine.RulesElement({
  ...
  te = Racial_Trait["Master Trickster"] = new engine.RulesElement({
  ...
  te = Racial_Trait["Memory of a Thousand Lifetimes"] = new engine.RulesElement({
  ...
  te = Racial_Trait["Mountain's Tenacity"] = new engine.RulesElement({
  ...
  te = Racial_Trait["Powerful Athlete"] = new engine.RulesElement({
  ...
  te = Racial_Trait["Razorclaw Shifting"] = new engine.RulesElement({
  ...
  te = Racial_Trait["Reactive Stealth"] = new engine.RulesElement({
  ...
  te = Racial_Trait["Stone's Endurance"] = new engine.RulesElement({
  ...
  te = Racial_Trait["Swift Charge"] = new engine.RulesElement({
    name: "Swift Charge",
    type: "Racial Trait",
  ...
  te = Racial_Trait["Trickster's Cunning"] = new engine.RulesElement({
