define(['engine', 'dnd4model'], function(engine, dnd4model) {
  ...
  te = class_feature["Accurate Action"] = new engine.RulesElement({
  ...
  te = class_feature["Ambitious Effort"] = new engine.RulesElement({
  ...
  te = class_feature["Ambitious Effort Existing Power"] = new engine.RulesElement({
  ...
  te = class_feature["Ambitious Effort New Power"] = new engine.RulesElement({
  ...
  te = class_feature["Angelic Emanation"] = new engine.RulesElement({
  ...
  te = class_feature["Angelic Resistance"] = new engine.RulesElement({
  ...
  te = class_feature["Antagonistic Transposition"] = new engine.RulesElement({
  ...
  te = class_feature["Armor of Faith"] = new engine.RulesElement({
    name: "Armor of Faith",
    type: "class feature",
  ...
  te = class_feature["Avalanche Action"] = new engine.RulesElement({
  ...
  te = class_feature["Avenger's Censure"] = new engine.RulesElement({
  ...
  te = class_feature["Balance of Nature"] = new engine.RulesElement({
  ...
  te = class_feature["Barbarian Agility"] = new engine.RulesElement({
  ...
  te = class_feature["Bardic Training"] = new engine.RulesElement({
  ...
  te = class_feature["Bardic Virtue"] = new engine.RulesElement({
    name: "Bardic Virtue",
    type: "class feature",
  ...
  te = class_feature["Bear Form"] = new engine.RulesElement({
    name: "Bear Form",
    type: "class feature",
  ...
  te = class_feature["Bearer of Doom"] = new engine.RulesElement({
    name: "Bearer of Doom",
    type: "class feature",
  ...
  te = class_feature["Bear's Toughness"] = new engine.RulesElement({
  ...
  te = class_feature["Beast Senses"] = new engine.RulesElement({
    name: "Beast Senses",
    type: "class feature",
  ...
  te = class_feature["Bedazzling Orb Charisma"] = new engine.RulesElement({
  ...
  te = class_feature["Bedazzling Orb Intelligence"] = new engine.RulesElement({
  ...
  te = class_feature["Beguiling Bolt Charisma"] = new engine.RulesElement({
  ...
  te = class_feature["Beguiling Bolt Intelligence"] = new engine.RulesElement({
  ...
  te = class_feature["Bestow Grace"] = new engine.RulesElement({
    name: "Bestow Grace",
    type: "class feature",
  ...
  te = class_feature["Blessed of the Fey"] = new engine.RulesElement({
  ...
  te = class_feature["Blessing of Spring"] = new engine.RulesElement({
  ...
  te = class_feature["Blighting Action"] = new engine.RulesElement({
  ...
  te = class_feature["Blood Moon Action"] = new engine.RulesElement({
  ...
  te = class_feature["Blood Moon Hunger"] = new engine.RulesElement({
  ...
  te = class_feature["Blood Oath"] = new engine.RulesElement({
    name: "Blood Oath",
    type: "class feature",
  ...
  te = class_feature["Blood of Io"] = new engine.RulesElement({
    name: "Blood of Io",
    type: "class feature",
  ...
  te = class_feature["Bloodied Might"] = new engine.RulesElement({
    name: "Bloodied Might",
    type: "class feature",
  ...
  te = class_feature["Bloodthirsty Hammer"] = new engine.RulesElement({
  ...
  te = class_feature["Bloodwrath Fury"] = new engine.RulesElement({
  ...
  te = class_feature["Bloodwrath Stride"] = new engine.RulesElement({
  ...
  te = class_feature["Bloody Determination"] = new engine.RulesElement({
  ...
  te = class_feature["Bolts of Bedevilment Charisma"] = new engine.RulesElement({
  ...
  te = class_feature["Bolts of Bedevilment Constitution"] = new engine.RulesElement({
  ...
  te = class_feature["Bolts of Bedevilment Intelligence"] = new engine.RulesElement({
  ...
  te = class_feature["Bonds of Life Charisma"] = new engine.RulesElement({
  ...
  te = class_feature["Bonds of Life Intelligence"] = new engine.RulesElement({
  ...
  te = class_feature["Bonds of Life Wisdom"] = new engine.RulesElement({
  ...
  te = class_feature["Bone Crusher"] = new engine.RulesElement({
    name: "Bone Crusher",
    type: "class feature",
  ...
  te = class_feature["Booming Words"] = new engine.RulesElement({
    name: "Booming Words",
    type: "class feature",
  ...
  te = class_feature["Censure of Pursuit"] = new engine.RulesElement({
  ...
  te = class_feature["Censure of Retribution"] = new engine.RulesElement({
  ...
  te = class_feature["Champion of Humanity"] = new engine.RulesElement({
  ...
  te = class_feature["Chaos Action"] = new engine.RulesElement({
    name: "Chaos Action",
    type: "class feature",
  ...
  te = class_feature["Chaos Burst"] = new engine.RulesElement({
    name: "Chaos Burst",
    type: "class feature",
  ...
  te = class_feature["Chaos Power"] = new engine.RulesElement({
    name: "Chaos Power",
    type: "class feature",
  ...
  te = class_feature["Circle the Prey Dexterity"] = new engine.RulesElement({
  ...
  te = class_feature["Circle the Prey Strength"] = new engine.RulesElement({
  ...
  te = class_feature["Clever Versatililty"] = new engine.RulesElement({
  ...
  te = class_feature["Cloaked in Magic"] = new engine.RulesElement({
  ...
  te = class_feature["Companion Spirit"] = new engine.RulesElement({
  ...
  te = class_feature["Compensatory Insight"] = new engine.RulesElement({
  ...
  te = class_feature["Covenant of Preservation"] = new engine.RulesElement({
  ...
  te = class_feature["Covenant of Wrath"] = new engine.RulesElement({
  ...
  te = class_feature["Crafty Combatant"] = new engine.RulesElement({
  ...
  te = class_feature["Critical Jolt"] = new engine.RulesElement({
    name: "Critical Jolt",
    type: "class feature",
  ...
  te = class_feature["Critical Surge"] = new engine.RulesElement({
    name: "Critical Surge",
    type: "class feature",
  ...
  te = class_feature["Daily Mastery"] = new engine.RulesElement({
    name: "Daily Mastery",
    type: "class feature",
  ...
  te = class_feature["Demon Fury"] = new engine.RulesElement({
    name: "Demon Fury",
    type: "class feature",
  ...
  te = class_feature["Destiny Fulfilled"] = new engine.RulesElement({
  ...
  te = class_feature["Disappearing Trick"] = new engine.RulesElement({
  ...
  te = class_feature["Dissolution's Call"] = new engine.RulesElement({
  ...
  te = class_feature["Divine Covenant"] = new engine.RulesElement({
  ...
  te = class_feature["Divine Shroud Action"] = new engine.RulesElement({
  ...
  te = class_feature["Dominating Presence"] = new engine.RulesElement({
  ...
  te = class_feature["Doom's Reward"] = new engine.RulesElement({
    name: "Doom's Reward",
    type: "class feature",
  ...
  te = class_feature["Double Resistance"] = new engine.RulesElement({
    ...
    rules: function(model) {
      model.grant(model.elements.id["ID_INTERNAL_CLASS_FEATURE_SECOND_DRAGON_MAGIC"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Draconic Durability"] = new engine.RulesElement({
  ...
  te = class_feature["Draconic Outburst"] = new engine.RulesElement({
  ...
  te = class_feature["Draconic Power"] = new engine.RulesElement({
    name: "Draconic Power",
    type: "class feature",
  ...
  te = class_feature["Draconic Resilience"] = new engine.RulesElement({
  ...
  te = class_feature["Draconic Resilience Action"] = new engine.RulesElement({
  ...
  te = class_feature["Dragon Magic"] = new engine.RulesElement({
    name: "Dragon Magic",
    type: "class feature",
    ...
    rules: function(model) {
      model.grant(model.elements.id["ID_FMP_CLASS_FEATURE_1557"]);
      model.grant(model.elements.id["ID_FMP_CLASS_FEATURE_1558"]);
      model.grant(model.elements.id["ID_FMP_CLASS_FEATURE_1559"]);
      model.grant(model.elements.id["ID_FMP_CLASS_FEATURE_1560"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Dragon Soul"] = new engine.RulesElement({
    name: "Dragon Soul",
    type: "class feature",
  ...
  te = class_feature["Dragon Soul Acid"] = new engine.RulesElement({
  ...
  te = class_feature["Dragon Soul Cold"] = new engine.RulesElement({
  ...
  te = class_feature["Dragon Soul Fire"] = new engine.RulesElement({
  ...
  te = class_feature["Dragon Soul Lightning"] = new engine.RulesElement({
  ...
  te = class_feature["Dragon Soul Poison"] = new engine.RulesElement({
  ...
  te = class_feature["Dragon Soul Resistance"] = new engine.RulesElement({
  ...
  te = class_feature["Dragon Soul Thunder"] = new engine.RulesElement({
  ...
  te = class_feature["Dwarven Resurgence"] = new engine.RulesElement({
  ...
  te = class_feature["Eager Action"] = new engine.RulesElement({
    name: "Eager Action",
    type: "class feature",
  ...
  te = class_feature["Earthstrength"] = new engine.RulesElement({
    name: "Earthstrength",
    type: "class feature",
  ...
  te = class_feature["Echoed Malediction"] = new engine.RulesElement({
  ...
  te = class_feature["Elfsight"] = new engine.RulesElement({
    name: "Elfsight",
    type: "class feature",
  ...
  te = class_feature["Enduring Castigation"] = new engine.RulesElement({
  ...
  te = class_feature["Enduring Hope"] = new engine.RulesElement({
    name: "Enduring Hope",
    type: "class feature",
  ...
  te = class_feature["Enduring Oath"] = new engine.RulesElement({
    name: "Enduring Oath",
    type: "class feature",
  ...
  te = class_feature["Enduring Spirit"] = new engine.RulesElement({
  ...
  te = class_feature["Ensorcelled Mind Charisma"] = new engine.RulesElement({
  ...
  te = class_feature["Ensorcelled Mind Intelligence"] = new engine.RulesElement({
  ...
  te = class_feature["Ensorcelled Mind Wisdom"] = new engine.RulesElement({
  ...
  te = class_feature["Entwining Evocation"] = new engine.RulesElement({
  ...
  te = class_feature["Eternal Return"] = new engine.RulesElement({
    name: "Eternal Return",
    type: "class feature",
  ...
  te = class_feature["Fate's Clarity"] = new engine.RulesElement({
    name: "Fate's Clarity",
    type: "class feature",
  ...
  te = class_feature["Fearless Scoundrel"] = new engine.RulesElement({
  ...
  te = class_feature["Fearsome Disposition"] = new engine.RulesElement({
  ...
  te = class_feature["Feral Might"] = new engine.RulesElement({
    name: "Feral Might",
    type: "class feature",
  ...
  te = class_feature["Fervent Pursuit"] = new engine.RulesElement({
  ...
  te = class_feature["Fey Leap Action"] = new engine.RulesElement({
  ...
  te = class_feature["Feypath"] = new engine.RulesElement({
    name: "Feypath",
    type: "class feature",
  ...
  te = class_feature["Finishing Technique"] = new engine.RulesElement({
  ...
  te = class_feature["Font of Life"] = new engine.RulesElement({
    name: "Font of Life",
    type: "class feature",
  ...
  te = class_feature["Frenzied Blood"] = new engine.RulesElement({
    name: "Frenzied Blood",
    type: "class feature",
  ...
  te = class_feature["Frenzied Claws"] = new engine.RulesElement({
    name: "Frenzied Claws",
    type: "class feature",
  ...
  te = class_feature["Furious Action"] = new engine.RulesElement({
    name: "Furious Action",
    type: "class feature",
  ...
  te = class_feature["Fury of the Hidden Flame"] = new engine.RulesElement({
  ...
  te = class_feature["Ghost Panther Action"] = new engine.RulesElement({
  ...
  te = class_feature["Ghost Panther's Wisdom"] = new engine.RulesElement({
  ...
  te = class_feature["Glimpse of the Abyss"] = new engine.RulesElement({
  ...
  te = class_feature["Go for the Throat"] = new engine.RulesElement({
  ...
  te = class_feature["Grasping Spirit"] = new engine.RulesElement({
  ...
  te = class_feature["Great Bear's Action"] = new engine.RulesElement({
  ...
  te = class_feature["Great Protector's Prowess"] = new engine.RulesElement({
  ...
  te = class_feature["Guardian Action (Guardian of the Living Gate)"] = new engine.RulesElement({
  ...
  te = class_feature["Guardian Might"] = new engine.RulesElement({
    name: "Guardian Might",
    type: "class feature",
  ...
  te = class_feature["Halfling's Taunt Charisma"] = new engine.RulesElement({
  ...
  te = class_feature["Halfling's Taunt Dexterity"] = new engine.RulesElement({
  ...
  te = class_feature["Healing Guides"] = new engine.RulesElement({
    name: "Healing Guides",
    type: "class feature",
  ...
  te = class_feature["Healing Spirit"] = new engine.RulesElement({
    name: "Healing Spirit",
    type: "class feature",
  ...
  te = class_feature["Hellfire Action"] = new engine.RulesElement({
  ...
  te = class_feature["Heroic Action"] = new engine.RulesElement({
    name: "Heroic Action",
    type: "class feature",
  ...
  te = class_feature["Heroic Inspiration"] = new engine.RulesElement({
  ...
  te = class_feature["Hunter Action"] = new engine.RulesElement({
    name: "Hunter Action",
    type: "class feature",
  ...
  te = class_feature["Hunter's Fury"] = new engine.RulesElement({
    name: "Hunter's Fury",
    type: "class feature",
  ...
  te = class_feature["Immortal Foe"] = new engine.RulesElement({
    name: "Immortal Foe",
    type: "class feature",
  ...
  te = class_feature["Imperious Presence Charisma"] = new engine.RulesElement({
  ...
  te = class_feature["Imperious Presence Intelligence"] = new engine.RulesElement({
  ...
  te = class_feature["Imperious Presence Wisdom"] = new engine.RulesElement({
  ...
  te = class_feature["Inspire by Deed"] = new engine.RulesElement({
  ...
  te = class_feature["Inspire by Example"] = new engine.RulesElement({
  ...
  te = class_feature["Inspire by Word"] = new engine.RulesElement({
  ...
  te = class_feature["Inspire Ferocity"] = new engine.RulesElement({
  ...
  te = class_feature["Inspiring Attack Action"] = new engine.RulesElement({
  ...
  te = class_feature["Invigorating Action"] = new engine.RulesElement({
  ...
  te = class_feature["Iron Boughs"] = new engine.RulesElement({
    name: "Iron Boughs",
    type: "class feature",
  ...
  te = class_feature["Judgment of the Summer Court"] = new engine.RulesElement({
  ...
  te = class_feature["Keeper's Action"] = new engine.RulesElement({
  ...
  te = class_feature["Kneel Before the Turathi"] = new engine.RulesElement({
  ...
  te = class_feature["Leap to the Fray"] = new engine.RulesElement({
  ...
  te = class_feature["Lingering Rebuke"] = new engine.RulesElement({
  ...
  te = class_feature["Looming Presence"] = new engine.RulesElement({
  ...
  te = class_feature["Lorekeeper's Cunning"] = new engine.RulesElement({
  ...
  te = class_feature["Lorekeeper's Revelation"] = new engine.RulesElement({
  ...
  te = class_feature["Lorekeeper's Wisdom"] = new engine.RulesElement({
  ...
  te = class_feature["Majestic Word"] = new engine.RulesElement({
    name: "Majestic Word",
    type: "class feature",
  ...
  te = class_feature["Manifest the Divine"] = new engine.RulesElement({
    ...
    rules: function(model) {
      model.grant(model.elements.id["ID_INTERNAL_INTERNAL_POLYTHEIST"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Master of Ill Fortune"] = new engine.RulesElement({
  ...
  te = class_feature["Master of Wings"] = new engine.RulesElement({
  ...
  te = class_feature["Mountain Crush"] = new engine.RulesElement({
    name: "Mountain Crush",
    type: "class feature",
  ...
  te = class_feature["Multiclass Versatility"] = new engine.RulesElement({
  ...
  te = class_feature["Murderous Rage Dexterity"] = new engine.RulesElement({
  ...
  te = class_feature["Murderous Rage Strength"] = new engine.RulesElement({
  ...
  te = class_feature["Nature's Rage Charisma"] = new engine.RulesElement({
  ...
  te = class_feature["Nature's Rage Intelligence"] = new engine.RulesElement({
  ...
  te = class_feature["Nature's Rage Wisdom"] = new engine.RulesElement({
  ...
  te = class_feature["Nature's Wrath"] = new engine.RulesElement({
    name: "Nature's Wrath",
    type: "class feature",
  ...
  te = class_feature["Oath of Enmity"] = new engine.RulesElement({
    name: "Oath of Enmity",
    type: "class feature",
  ...
  te = class_feature["Pack Tactics"] = new engine.RulesElement({
    name: "Pack Tactics",
    type: "class feature",
  ...
  te = class_feature["Panther Ancestors"] = new engine.RulesElement({
  ...
  te = class_feature["Past-Life Acolytes"] = new engine.RulesElement({
  ...
  te = class_feature["Penance"] = new engine.RulesElement({
    name: "Penance",
    type: "class feature",
  ...
  te = class_feature["Primal Aspect"] = new engine.RulesElement({
    name: "Primal Aspect",
    type: "class feature",
  ...
  te = class_feature["Primal Guardian"] = new engine.RulesElement({
  ...
  te = class_feature["Primal Predator"] = new engine.RulesElement({
  ...
  te = class_feature["Primal Travel"] = new engine.RulesElement({
    name: "Primal Travel",
    type: "class feature",
  ...
  te = class_feature["Protector Spirit"] = new engine.RulesElement({
    ...
    rules: function(model) {
      ...
      model.grant(model.elements.id["ID_FMP_POWER_6521"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Rage Strike"] = new engine.RulesElement({
    name: "Rage Strike",
    type: "class feature",
    ...
    rules: function(model) {
      model.grant(model.elements.id["ID_FMP_POWER_4807"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Rageblood Vigor"] = new engine.RulesElement({
    ...
    rules: function(model) {
      model.grant(model.elements.id["ID_FMP_POWER_4809"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Rampage"] = new engine.RulesElement({
    name: "Rampage",
    type: "class feature",
  ...
  te = class_feature["Reaching Action"] = new engine.RulesElement({
  ...
  te = class_feature["Resourceful Action"] = new engine.RulesElement({
  ...
  te = class_feature["Resurgent Action"] = new engine.RulesElement({
  ...
  te = class_feature["Righteous Resurgence"] = new engine.RulesElement({
  ...
  te = class_feature["Savage Resilience"] = new engine.RulesElement({
  ...
  te = class_feature["Scales of the Dragon"] = new engine.RulesElement({
  ...
  te = class_feature["Second Dragon Magic"] = new engine.RulesElement({
  ...
  te = class_feature["Seeker of Foes"] = new engine.RulesElement({
    name: "Seeker of Foes",
    type: "class feature",
  ...
  te = class_feature["Serene Countenance"] = new engine.RulesElement({
  ...
  te = class_feature["Shield of Ill Fortune"] = new engine.RulesElement({
  ...
  te = class_feature["Skill Learning"] = new engine.RulesElement({
    name: "Skill Learning",
    type: "class feature",
  ...
  te = class_feature["Skill Versatility"] = new engine.RulesElement({
  ...
  te = class_feature["Sky Hunter's Action"] = new engine.RulesElement({
  ...
  te = class_feature["Sly Offensive Charisma"] = new engine.RulesElement({
  ...
  te = class_feature["Sly Offensive Dexterity"] = new engine.RulesElement({
  ...
  te = class_feature["Sneaky Gnome"] = new engine.RulesElement({
    name: "Sneaky Gnome",
    type: "class feature",
  ...
  te = class_feature["Soaring Charge"] = new engine.RulesElement({
    name: "Soaring Charge",
    type: "class feature",
  ...
  te = class_feature["Song of Rest"] = new engine.RulesElement({
    name: "Song of Rest",
    type: "class feature",
  ...
  te = class_feature["Speak with Spirits"] = new engine.RulesElement({
  ...
  te = class_feature["Spell Source"] = new engine.RulesElement({
    name: "Spell Source",
    type: "class feature",
  ...
  te = class_feature["Spirit Boon"] = new engine.RulesElement({
    name: "Spirit Boon",
    type: "class feature",
  ...
  te = class_feature["Spirit Combatant"] = new engine.RulesElement({
  ...
  te = class_feature["Spirit Shaman's Bounty"] = new engine.RulesElement({
  ...
  te = class_feature["Spirit Venom"] = new engine.RulesElement({
    name: "Spirit Venom",
    type: "class feature",
  ...
  te = class_feature["Spirit Wind Action"] = new engine.RulesElement({
  ...
  te = class_feature["Split Spell Action"] = new engine.RulesElement({
  ...
  te = class_feature["Staggering Fury"] = new engine.RulesElement({
  ...
  te = class_feature["Stalker Spirit"] = new engine.RulesElement({
    name: "Stalker Spirit",
    type: "class feature",
    ...
    rules: function(model) {
      ...
      model.grant(model.elements.id["ID_FMP_POWER_5510"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Stonebones"] = new engine.RulesElement({
    name: "Stonebones",
    type: "class feature",
  ...
  te = class_feature["Stonehide Action"] = new engine.RulesElement({
  ...
  te = class_feature["Strength of the Earth"] = new engine.RulesElement({
  ...
  te = class_feature["Sworn Action"] = new engine.RulesElement({
    name: "Sworn Action",
    type: "class feature",
  ...
  te = class_feature["Thaneborn Triumph"] = new engine.RulesElement({
    ...
    rules: function(model) {
      model.grant(model.elements.id["ID_FMP_POWER_4932"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["The Queen's Grace"] = new engine.RulesElement({
  ...
  te = class_feature["Thrall of Turath Charisma"] = new engine.RulesElement({
  ...
  te = class_feature["Thrall of Turath Constitution"] = new engine.RulesElement({
  ...
  te = class_feature["Thrall of Turath Intelligence"] = new engine.RulesElement({
  ...
  te = class_feature["Turathi Frenzy"] = new engine.RulesElement({
    name: "Turathi Frenzy",
    type: "class feature",
  ...
  te = class_feature["Twilight Walk"] = new engine.RulesElement({
    name: "Twilight Walk",
    type: "class feature",
  ...
  te = class_feature["Unbound Assault Dexterity"] = new engine.RulesElement({
  ...
  te = class_feature["Unbound Assault Strength"] = new engine.RulesElement({
  ...
  te = class_feature["Undying Wind"] = new engine.RulesElement({
    name: "Undying Wind",
    type: "class feature",
  ...
  te = class_feature["Unfeeling Rage"] = new engine.RulesElement({
    name: "Unfeeling Rage",
    type: "class feature",
  ...
  te = class_feature["Unfettered Power"] = new engine.RulesElement({
  ...
  te = class_feature["Unusual Reach"] = new engine.RulesElement({
    name: "Unusual Reach",
    type: "class feature",
  ...
  te = class_feature["Unveiled Action"] = new engine.RulesElement({
  ...
  te = class_feature["Variable Resistance"] = new engine.RulesElement({
  ...
  te = class_feature["Versatile Acton"] = new engine.RulesElement({
  ...
  te = class_feature["Versatile Breath"] = new engine.RulesElement({
  ...
  te = class_feature["Vicious Action"] = new engine.RulesElement({
    name: "Vicious Action",
    type: "class feature",
  ...
  te = class_feature["Virtue of Cunning"] = new engine.RulesElement({
  ...
  te = class_feature["Virtue of Valor"] = new engine.RulesElement({
  ...
  te = class_feature["Voice of Thunder"] = new engine.RulesElement({
  ...
  te = class_feature["Voice to Wake the Dead"] = new engine.RulesElement({
  ...
  te = class_feature["Warpath"] = new engine.RulesElement({
    name: "Warpath",
    type: "class feature",
  ...
  te = class_feature["Wild Magic"] = new engine.RulesElement({
    name: "Wild Magic",
    type: "class feature",
    ...
    rules: function(model) {
      model.grant(model.elements.id["ID_FMP_CLASS_FEATURE_1564"]);
      model.grant(model.elements.id["ID_FMP_CLASS_FEATURE_1565"]);
      model.grant(model.elements.id["ID_FMP_CLASS_FEATURE_1566"]);
      model.grant(model.elements.id["ID_FMP_CLASS_FEATURE_1567"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Wild Push"] = new engine.RulesElement({
    name: "Wild Push",
    type: "class feature",
  ...
  te = class_feature["Wild Resilience"] = new engine.RulesElement({
  ...
  te = class_feature["Wild Shape"] = new engine.RulesElement({
    name: "Wild Shape",
    type: "class feature",
  ...
  te = class_feature["Wild Soul"] = new engine.RulesElement({
    name: "Wild Soul",
    type: "class feature",
    ...
    rules: function(model) {
      model.grant(model.elements.id["ID_INTERNAL_COUNTSASFEATURE_WILD_MAGIC"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Wild Surge"] = new engine.RulesElement({
    name: "Wild Surge",
    type: "class feature",
  ...
  te = class_feature["Wildblood"] = new engine.RulesElement({
    name: "Wildblood",
    type: "class feature",
  ...
  te = class_feature["Wildrunner's Swiftness"] = new engine.RulesElement({
  ...
  te = class_feature["Wings of Action"] = new engine.RulesElement({
  ...
  te = class_feature["Words of Friendship"] = new engine.RulesElement({
    ...
    rules: function(model) {
      model.grant(model.elements.id["ID_FMP_POWER_2887"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Worthy Foe"] = new engine.RulesElement({
    name: "Worthy Foe",
    type: "class feature",
  ...
  te = class_feature["Writhing Roots"] = new engine.RulesElement({
    name: "Writhing Roots",
    type: "class feature",
  ...
  te = class_feature["Zealot's Veil"] = new engine.RulesElement({
    name: "Zealot's Veil",
    type: "class feature",
