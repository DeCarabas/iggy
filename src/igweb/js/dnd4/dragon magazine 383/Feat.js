(function(global, undefined) {
  ...
  te = Feat["Accidental Tells"] = new RulesElement({
    name: "Accidental Tells",
    type: "Feat",
    id: "ID_FMP_FEAT_2577",
    source: "Dragon Magazine 383",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=2577",
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_INTERNAL_INTERNAL_TIEFLING_BLOODLINE"]);
    }
  });
  byID[te.id] = te;
  
  te = Feat["Ancestral Wrath"] = new RulesElement({
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_INTERNAL_INTERNAL_BLOODLINE"]);
      model.grant(elements.id["ID_INTERNAL_INTERNAL_DWARVEN_BLOODLINE"]);
    }
  });
  byID[te.id] = te;
  
  te = Feat["Ape's Reach"] = new RulesElement({
    name: "Ape's Reach",
    type: "Feat",
    id: "ID_FMP_FEAT_2276",
    source: "Dragon Magazine 383",
  ...
  te = Feat["Bane's Tyrannical Transference"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_11278"]);
    }
  });
  byID[te.id] = te;
  
  te = Feat["Bard of All Trades"] = new RulesElement({
  ...
  te = Feat["Beast Form Eyes"] = new RulesElement({
  ...
  te = Feat["Buffeting Winds"] = new RulesElement({
    name: "Buffeting Winds",
    type: "Feat",
    id: "ID_FMP_FEAT_2551",
    source: "Dragon Magazine 383",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=2551",
    categories: ["Buffeting Winds", "ID_FMP_FEAT_2551"]
  });
  byID[te.id] = te;
  
  te = Feat["Cheetah's Speed"] = new RulesElement({
  ...
  te = Feat["Constrictor's Grasp"] = new RulesElement({
    name: "Constrictor's Grasp",
    type: "Feat",
    id: "ID_FMP_FEAT_2279",
    source: "Dragon Magazine 383",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=2279",
    categories: ["Constrictor's Grasp", "ID_FMP_FEAT_2279"]
  });
  byID[te.id] = te;
  
  te = Feat["Die Hard"] = new RulesElement({
    name: "Die Hard",
    type: "Feat",
    id: "ID_FMP_FEAT_2568",
    source: "Dragon Magazine 383",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=2568",
    categories: ["Die Hard", "ID_FMP_FEAT_2568"]
  });
  byID[te.id] = te;
  
  te = Feat["Don't Count Me Out"] = new RulesElement({
  ...
  te = Feat["Earth Cage"] = new RulesElement({
    name: "Earth Cage",
    type: "Feat",
    id: "ID_FMP_FEAT_2552",
    source: "Dragon Magazine 383",
  ...
  te = Feat["Elemental Boon"] = new RulesElement({
    name: "Elemental Boon",
    type: "Feat",
    id: "ID_FMP_FEAT_2553",
    source: "Dragon Magazine 383",
  ...
  te = Feat["Font of Chaos"] = new RulesElement({
    name: "Font of Chaos",
    type: "Feat",
    id: "ID_FMP_FEAT_2554",
    source: "Dragon Magazine 383",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=2554",
    categories: ["Font of Chaos", "ID_FMP_FEAT_2554"]
  });
  byID[te.id] = te;
  
  te = Feat["Forgeborn Heritage"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_10940"]);
  ...
  te = Feat["Frantic Recovery"] = new RulesElement({
  ...
  te = Feat["Go with the Flow"] = new RulesElement({
  ...
  te = Feat["Guardian's Mishaps"] = new RulesElement({
    name: "Guardian's Mishaps",
    type: "Feat",
    id: "ID_FMP_FEAT_2578",
    source: "Dragon Magazine 383",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=2578",
  ...
  te = Feat["Gusting Rebuke"] = new RulesElement({
    name: "Gusting Rebuke",
    type: "Feat",
    id: "ID_FMP_FEAT_2560",
    source: "Dragon Magazine 383",
  ...
  te = Feat["Improved Legacy"] = new RulesElement({
  ...
  te = Feat["Iron Hide Resilience"] = new RulesElement({
    name: "Iron Hide Resilience",
    type: "Feat",
    id: "ID_FMP_FEAT_2320",
    source: "Dragon Magazine 383",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=2320",
  ...
  te = Feat["Keen Hatred"] = new RulesElement({
    name: "Keen Hatred",
    type: "Feat",
    id: "ID_FMP_FEAT_2321",
    source: "Dragon Magazine 383",
  ...
  te = Feat["Lucky Misfortune"] = new RulesElement({
  ...
  te = Feat["Mantle of Misfortune"] = new RulesElement({
    name: "Mantle of Misfortune",
    type: "Feat",
    id: "ID_FMP_FEAT_2576",
    source: "Dragon Magazine 383",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=2576",
    categories: ["Mantle of Misfortune", "ID_FMP_FEAT_2576", "ID_INTERNAL_INTERNAL_TIEFLING_BLOODLINE", "Tiefling Bloodline"],
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_11299"]);
  ...
  te = Feat["Monkey's Rush"] = new RulesElement({
    name: "Monkey's Rush",
    type: "Feat",
    id: "ID_FMP_FEAT_2280",
    source: "Dragon Magazine 383",
  ...
  te = Feat["Mountain's Wrath"] = new RulesElement({
    name: "Mountain's Wrath",
    type: "Feat",
    id: "ID_FMP_FEAT_2561",
    source: "Dragon Magazine 383",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=2561",
    categories: ["Mountain's Wrath", "ID_FMP_FEAT_2561"]
  });
  byID[te.id] = te;
  
  te = Feat["Pain Doesn't Hurt"] = new RulesElement({
    name: "Pain Doesn't Hurt",
    type: "Feat",
    id: "ID_FMP_FEAT_2571",
    source: "Dragon Magazine 383",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=2571",
  ...
  te = Feat["Perfect Recovery"] = new RulesElement({
    name: "Perfect Recovery",
    type: "Feat",
    id: "ID_FMP_FEAT_2573",
    source: "Dragon Magazine 383",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=2573",
  ...
  te = Feat["Persistent Threat"] = new RulesElement({
    name: "Persistent Threat",
    type: "Feat",
    id: "ID_FMP_FEAT_2572",
    source: "Dragon Magazine 383",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=2572",
    categories: ["Persistent Threat", "ID_FMP_FEAT_2572"]
  });
  byID[te.id] = te;
  
  te = Feat["Progress of Erathis"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_11279"]);
    }
  });
  byID[te.id] = te;
  
  te = Feat["Roiling Storm"] = new RulesElement({
    name: "Roiling Storm",
    type: "Feat",
    id: "ID_FMP_FEAT_2556",
    source: "Dragon Magazine 383",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=2556",
    categories: ["Roiling Storm", "ID_FMP_FEAT_2556"]
  });
  byID[te.id] = te;
  
  te = Feat["Saving Breath"] = new RulesElement({
    name: "Saving Breath",
    type: "Feat",
    id: "ID_FMP_FEAT_2563",
    source: "Dragon Magazine 383",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=2563",
    categories: ["Saving Breath", "ID_FMP_FEAT_2563"]
  });
  byID[te.id] = te;
  
  te = Feat["Shifting Wind"] = new RulesElement({
    name: "Shifting Wind",
    type: "Feat",
    id: "ID_FMP_FEAT_2281",
    source: "Dragon Magazine 383",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=2281",
    categories: ["Shifting Wind", "ID_FMP_FEAT_2281"]
  });
  byID[te.id] = te;
  
  te = Feat["Skill Swap"] = new RulesElement({
    name: "Skill Swap",
    type: "Feat",
    id: "ID_FMP_FEAT_2580",
    source: "Dragon Magazine 383",
  ...
  te = Feat["Slithering Form"] = new RulesElement({
    name: "Slithering Form",
    type: "Feat",
    id: "ID_FMP_FEAT_2282",
    source: "Dragon Magazine 383",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=2282",
  ...
  te = Feat["Stampede"] = new RulesElement({
    name: "Stampede",
    type: "Feat",
    id: "ID_FMP_FEAT_2283",
    source: "Dragon Magazine 383",
  ...
  te = Feat["Storm Manifested"] = new RulesElement({
    name: "Storm Manifested",
    type: "Feat",
    id: "ID_FMP_FEAT_2557",
    source: "Dragon Magazine 383",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=2557",
    categories: ["Storm Manifested", "ID_FMP_FEAT_2557"]
  });
  byID[te.id] = te;
  
  te = Feat["Storm's Lightning"] = new RulesElement({
    name: "Storm's Lightning",
    type: "Feat",
    id: "ID_FMP_FEAT_2558",
    source: "Dragon Magazine 383",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=2558",
    categories: ["Storm's Lightning", "ID_FMP_FEAT_2558"]
  });
  byID[te.id] = te;
  
  te = Feat["Turtle's Shell"] = new RulesElement({
    name: "Turtle's Shell",
    type: "Feat",
    id: "ID_FMP_FEAT_2284",
    source: "Dragon Magazine 383",
  ...
  te = Feat["Untamed Fire"] = new RulesElement({
    name: "Untamed Fire",
    type: "Feat",
    id: "ID_FMP_FEAT_2559",
    source: "Dragon Magazine 383",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=2559",
  ...
  te = Feat["Wrathful Legacy"] = new RulesElement({
    name: "Wrathful Legacy",
    type: "Feat",
    id: "ID_FMP_FEAT_2322",
    source: "Dragon Magazine 383",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=2322",
    categories: ["Wrathful Legacy", "ID_FMP_FEAT_2322"]
  });
  byID[te.id] = te;
  
  te = Feat["Wrathful Resurgence"] = new RulesElement({
