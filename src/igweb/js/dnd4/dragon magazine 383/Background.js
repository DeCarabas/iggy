define(['engine', 'dnd4model'], function(engine, dnd4model) {
  ...
  te = Background["Child of the Wildlands"] = new engine.RulesElement({
  ...
  te = Background["Civilization's Herald"] = new engine.RulesElement({
  ...
  te = Background["Disgraced Scion"] = new engine.RulesElement({
  ...
  te = Background["Early Life - Child Prodigy"] = new engine.RulesElement({
  ...
  te = Background["Early Life - Divine Companionship"] = new engine.RulesElement({
  ...
  te = Background["Early Life - Imprisoned"] = new engine.RulesElement({
  ...
  te = Background["Early Life - Invited Underground"] = new engine.RulesElement({
  ...
  te = Background["Early Life - Isolated"] = new engine.RulesElement({
  ...
  te = Background["Early Life - Kidnapped"] = new engine.RulesElement({
  ...
  te = Background["Early Life - Lost Everything"] = new engine.RulesElement({
  ...
  te = Background["Early Life - Social Outcast"] = new engine.RulesElement({
  ...
  te = Background["Early Life - Test Subject"] = new engine.RulesElement({
  ...
  te = Background["Early Life - Well-Loved"] = new engine.RulesElement({
  ...
  te = Background["Keeper of Hate"] = new engine.RulesElement({
    name: "Keeper of Hate",
    type: "Background",
  ...
  te = Background["Orc Slayer"] = new engine.RulesElement({
    name: "Orc Slayer",
    type: "Background",
  ...
  te = Background["Parentage - Cult Raised"] = new engine.RulesElement({
  ...
  te = Background["Parentage - Draconic Adoption"] = new engine.RulesElement({
  ...
  te = Background["Parentage - Ill-Omened"] = new engine.RulesElement({
  ...
  te = Background["Parentage - Immortal Guardians"] = new engine.RulesElement({
  ...
  te = Background["Parentage - Impoverished"] = new engine.RulesElement({
  ...
  te = Background["Parentage - Minstrel Family"] = new engine.RulesElement({
  ...
  te = Background["Parentage - Monk Business"] = new engine.RulesElement({
  ...
  te = Background["Parentage - Noble"] = new engine.RulesElement({
  ...
  te = Background["Parentage - Orphan"] = new engine.RulesElement({
  ...
  te = Background["Parentage - Raised by Wolves"] = new engine.RulesElement({
  ...
  te = Background["Pivotal Event - Amazing Creation"] = new engine.RulesElement({
  ...
  te = Background["Pivotal Event - Divine Decree"] = new engine.RulesElement({
  ...
  te = Background["Pivotal Event - Escape"] = new engine.RulesElement({
  ...
  te = Background["Pivotal Event - Murder"] = new engine.RulesElement({
  ...
  te = Background["Pivotal Event - Portal Mishap"] = new engine.RulesElement({
  ...
  te = Background["Pivotal Event - Possession"] = new engine.RulesElement({
  ...
  te = Background["Pivotal Event - Transformation"] = new engine.RulesElement({
  ...
  te = Background["Pivotal Event - Unwholesome Journey"] = new engine.RulesElement({
  ...
  te = Background["Pivotal Event - You Die"] = new engine.RulesElement({
  ...
  te = Background["Pivotal Event - You Kill"] = new engine.RulesElement({
  ...
  te = Background["Recent Life - Demon-Hunter"] = new engine.RulesElement({
  ...
  te = Background["Recent Life - Explorer of the Ancient"] = new engine.RulesElement({
  ...
  te = Background["Recent Life - Fighting Undead"] = new engine.RulesElement({
  ...
  te = Background["Recent Life - Freeing Slaves"] = new engine.RulesElement({
  ...
  te = Background["Recent Life - Lost in the Feywild"] = new engine.RulesElement({
  ...
  te = Background["Recent Life - Mercenary Work"] = new engine.RulesElement({
  ...
  te = Background["Recent Life - Peaceful Life"] = new engine.RulesElement({
  ...
  te = Background["Recent Life - Spreading the Word"] = new engine.RulesElement({
  ...
  te = Background["Recent Life - Teambuilding Exercise"] = new engine.RulesElement({
  ...
  te = Background["Recent Life - Valued Prisoner"] = new engine.RulesElement({
  ...
  te = Background["The Breach"] = new engine.RulesElement({
    name: "The Breach",
    type: "Background",
