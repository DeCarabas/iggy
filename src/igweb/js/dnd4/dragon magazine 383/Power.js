(function(global, undefined) {
  ...
  te = Power["Altar of Confinement"] = new RulesElement({
  ...
  te = Power["Altar of Defense"] = new RulesElement({
  ...
  te = Power["Angelic Aura"] = new RulesElement({
    name: "Angelic Aura",
    type: "Power",
  ...
  te = Power["Angelic Harrier"] = new RulesElement({
  ...
  te = Power["Angelic Messenger"] = new RulesElement({
  ...
  te = Power["Angelic Protector"] = new RulesElement({
  ...
  te = Power["Arcane Whirlwind"] = new RulesElement({
  ...
  te = Power["Archer's Stairway"] = new RulesElement({
  ...
  te = Power["Arrow of the Savior"] = new RulesElement({
  ...
  te = Power["Assistance of the Strong Spirit"] = new RulesElement({
  ...
  te = Power["Aura of Flawed Nature"] = new RulesElement({
  ...
  te = Power["Back on Target"] = new RulesElement({
    name: "Back on Target",
    type: "Power",
  ...
  te = Power["Bane's Tyrannical Transference"] = new RulesElement({
  ...
  te = Power["Bear Hug"] = new RulesElement({
    name: "Bear Hug",
    type: "Power",
  ...
  te = Power["Behemoth's Club"] = new RulesElement({
  ...
  te = Power["Blessing of the Storm Father"] = new RulesElement({
  ...
  te = Power["Boiling Cloud"] = new RulesElement({
    name: "Boiling Cloud",
    type: "Power",
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_11076"]);
    }
  });
  byID[te.id] = te;
  
  te = Power["Boiling Cloud Attack"] = new RulesElement({
  ...
  te = Power["Brand the Heretic"] = new RulesElement({
  ...
  te = Power["Breath of Chaos"] = new RulesElement({
  ...
  te = Power["Brilliant Beacon"] = new RulesElement({
  ...
  te = Power["Burning Recollection"] = new RulesElement({
  ...
  te = Power["Cast the First Stone"] = new RulesElement({
  ...
  te = Power["Cherub's Song"] = new RulesElement({
    name: "Cherub's Song",
    type: "Power",
  ...
  te = Power["Cinderfall"] = new RulesElement({
    name: "Cinderfall",
    type: "Power",
  ...
  te = Power["Clarifying Rebuke"] = new RulesElement({
  ...
  te = Power["Cloud of Locusts"] = new RulesElement({
  ...
  te = Power["Cloud of Misfortune"] = new RulesElement({
  ...
  te = Power["Command of the Abyss"] = new RulesElement({
  ...
  te = Power["Corrosive Mist"] = new RulesElement({
    name: "Corrosive Mist",
    type: "Power",
  ...
  te = Power["Covering Volley"] = new RulesElement({
  ...
  te = Power["Craven Chorus"] = new RulesElement({
    name: "Craven Chorus",
    type: "Power",
  ...
  te = Power["Crimson Agony Tide"] = new RulesElement({
  ...
  te = Power["Curse of the Divine Plague"] = new RulesElement({
  ...
  te = Power["Dangerous Friends"] = new RulesElement({
  ...
  te = Power["Dawn's Blazing Fingers"] = new RulesElement({
  ...
  te = Power["Defensive Volley"] = new RulesElement({
  ...
  te = Power["Disorienting Ditty"] = new RulesElement({
  ...
  te = Power["Dissonant Imbuement"] = new RulesElement({
  ...
  te = Power["Driving Blades"] = new RulesElement({
    name: "Driving Blades",
    type: "Power",
  ...
  te = Power["Drown in Blood"] = new RulesElement({
    name: "Drown in Blood",
    type: "Power",
  ...
  te = Power["Drown in Mud"] = new RulesElement({
    name: "Drown in Mud",
    type: "Power",
  ...
  te = Power["Elemental Legacy"] = new RulesElement({
  ...
  te = Power["Entrapping Arrows"] = new RulesElement({
  ...
  te = Power["Erupting Volcano Attack"] = new RulesElement({
  ...
  te = Power["Fires of Judgment"] = new RulesElement({
  ...
  te = Power["Firescythe"] = new RulesElement({
    name: "Firescythe",
    type: "Power",
  ...
  te = Power["Flying Steel"] = new RulesElement({
    name: "Flying Steel",
    type: "Power",
  ...
  te = Power["Focus of Cascading Power"] = new RulesElement({
  ...
  te = Power["Force Ladder"] = new RulesElement({
    name: "Force Ladder",
    type: "Power",
  ...
  te = Power["Forge of Fire and Smoke"] = new RulesElement({
  ...
  te = Power["Forge Spirit Attack"] = new RulesElement({
  ...
  te = Power["Forge Strike"] = new RulesElement({
    name: "Forge Strike",
    type: "Power",
  ...
  te = Power["Form of the Erupting Volcano"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_11092"]);
    }
  });
  byID[te.id] = te;
  
  te = Power["Form of the Forge Spirit"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_11098"]);
    }
  });
  byID[te.id] = te;
  
  te = Power["Form of the Living Breach"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_11095"]);
    }
  });
  byID[te.id] = te;
  
  te = Power["Form of the Magma Brute"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_11082"]);
    }
  });
  byID[te.id] = te;
  
  te = Power["Form of the Primeval Ape"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_10839"]);
    }
  });
  byID[te.id] = te;
  
  te = Power["Form of the Primeval Bear"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_10841"]);
    }
  });
  byID[te.id] = te;
  
  te = Power["Form of the Primeval Boar"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_10843"]);
    }
  });
  byID[te.id] = te;
  
  te = Power["Form of the Primeval Cat"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_10851"]);
    }
  });
  byID[te.id] = te;
  
  te = Power["Form of the Primeval Lizard"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_10845"]);
    }
  });
  byID[te.id] = te;
  
  te = Power["Form of the Primeval Raptor"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_10853"]);
    }
  });
  byID[te.id] = te;
  
  te = Power["Form of the Primeval Serpent"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_10855"]);
    }
  });
  byID[te.id] = te;
  
  te = Power["Form of the Primeval Spider"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_10847"]);
    }
  });
  byID[te.id] = te;
  
  te = Power["Form of the Primeval Wolf"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_10849"]);
    }
  });
  byID[te.id] = te;
  
  te = Power["Form of the Seething Sandstorm"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_11088"]);
    }
  });
  byID[te.id] = te;
  
  te = Power["Form of the Vengeful Storm"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_11079"]);
    }
  });
  byID[te.id] = te;
  
  te = Power["Form of the Walking Conflagration"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_11073"]);
    }
  });
  byID[te.id] = te;
  
  te = Power["Fury of the Battle God"] = new RulesElement({
  ...
  te = Power["Gift of Incomparable Strength"] = new RulesElement({
  ...
  te = Power["Gray Roarer's Rampage"] = new RulesElement({
  ...
  te = Power["Guardian Arrow"] = new RulesElement({
    name: "Guardian Arrow",
    type: "Power",
  ...
  te = Power["Heaven's Bountiful Reward"] = new RulesElement({
  ...
  te = Power["Herder of Hulculmak"] = new RulesElement({
  ...
  te = Power["Hindering Shot"] = new RulesElement({
    name: "Hindering Shot",
    type: "Power",
  ...
  te = Power["Holy Outrage"] = new RulesElement({
    name: "Holy Outrage",
    type: "Power",
  ...
  te = Power["Imprisoning Arrows"] = new RulesElement({
  ...
  te = Power["Infectious Spark"] = new RulesElement({
  ...
  te = Power["Interrupting Volley"] = new RulesElement({
  ...
  te = Power["Kord's Strength"] = new RulesElement({
  ...
  te = Power["Lightning Spike"] = new RulesElement({
  ...
  te = Power["Living Breach Attack"] = new RulesElement({
  ...
  te = Power["Magma Brute Attack"] = new RulesElement({
  ...
  te = Power["Mantle of Misfortune"] = new RulesElement({
  ...
  te = Power["Massive Companion"] = new RulesElement({
  ...
  te = Power["Mighty Hew"] = new RulesElement({
    name: "Mighty Hew",
    type: "Power",
  ...
  te = Power["Musical Chairs"] = new RulesElement({
    name: "Musical Chairs",
    type: "Power",
  ...
  te = Power["Mystical Debris"] = new RulesElement({
  ...
  te = Power["Omen of Damnation"] = new RulesElement({
  ...
  te = Power["One Spirit, One Body"] = new RulesElement({
  ...
  te = Power["Overwhelming Radiance"] = new RulesElement({
  ...
  te = Power["Patron's Blessing"] = new RulesElement({
  ...
  te = Power["Peal of Thunder"] = new RulesElement({
  ...
  te = Power["Perfect Pitch"] = new RulesElement({
    name: "Perfect Pitch",
    type: "Power",
  ...
  te = Power["Pinning Arrow Rain"] = new RulesElement({
  ...
  te = Power["Pinning Shot"] = new RulesElement({
    name: "Pinning Shot",
    type: "Power",
  ...
  te = Power["Primeval Ape Attack"] = new RulesElement({
  ...
  te = Power["Primeval Bear Attack"] = new RulesElement({
  ...
  te = Power["Primeval Boar Attack"] = new RulesElement({
  ...
  te = Power["Primeval Cat Attack"] = new RulesElement({
  ...
  te = Power["Primeval Lizard Attack"] = new RulesElement({
  ...
  te = Power["Primeval Raptor Attack"] = new RulesElement({
  ...
  te = Power["Primeval Serpent Attack"] = new RulesElement({
  ...
  te = Power["Primeval Spider Attack"] = new RulesElement({
  ...
  te = Power["Primeval Wolf Attack"] = new RulesElement({
  ...
  te = Power["Progress of Erathis"] = new RulesElement({
  ...
  te = Power["Radiant Cordon"] = new RulesElement({
    name: "Radiant Cordon",
    type: "Power",
  ...
  te = Power["Raging Tempest"] = new RulesElement({
    name: "Raging Tempest",
    type: "Power",
  ...
  te = Power["Recall the Breach"] = new RulesElement({
  ...
  te = Power["Roaming Mind, Roving Spirit"] = new RulesElement({
  ...
  te = Power["Rolling Thunderstrike"] = new RulesElement({
  ...
  te = Power["Scattering Shock"] = new RulesElement({
  ...
  te = Power["Scourge of Heaven"] = new RulesElement({
  ...
  te = Power["Seething Sandstorm Attack"] = new RulesElement({
  ...
  te = Power["Skewering Spikes"] = new RulesElement({
  ...
  te = Power["Spirit of Consuming Terror"] = new RulesElement({
  ...
  te = Power["Spirit of the Brain Mole"] = new RulesElement({
  ...
  te = Power["Sprightly Rhythm"] = new RulesElement({
  ...
  te = Power["Staggering Note"] = new RulesElement({
  ...
  te = Power["Storm Father's Favor"] = new RulesElement({
  ...
  te = Power["Stormclaw"] = new RulesElement({
    name: "Stormclaw",
    type: "Power",
  ...
  te = Power["Strike Up the Dance"] = new RulesElement({
  ...
  te = Power["Summon Celestial Lion"] = new RulesElement({
  ...
  te = Power["Surprising Arrow Attack"] = new RulesElement({
  ...
  te = Power["Surprising Arrow Stance"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_11141"]);
    }
  });
  byID[te.id] = te;
  
  te = Power["Thousand Arrow Awareness"] = new RulesElement({
  ...
  te = Power["Thunderhead Strike"] = new RulesElement({
  ...
  te = Power["Tracking the Target"] = new RulesElement({
  ...
  te = Power["Transference Tune"] = new RulesElement({
  ...
  te = Power["Tremor Slam"] = new RulesElement({
    name: "Tremor Slam",
    type: "Power",
  ...
  te = Power["Turathi Assault"] = new RulesElement({
  ...
  te = Power["Vengeful Storm Attack"] = new RulesElement({
  ...
  te = Power["Venting Breach"] = new RulesElement({
    name: "Venting Breach",
    type: "Power",
  ...
  te = Power["Vestige of Baatar"] = new RulesElement({
  ...
  te = Power["Vestige of Kronata"] = new RulesElement({
  ...
  te = Power["Vestige of Kulnoghrim"] = new RulesElement({
  ...
  te = Power["Vestige of Thaxter"] = new RulesElement({
  ...
  te = Power["Vestige of the Ascendant Commander"] = new RulesElement({
  ...
  te = Power["Vestige of the Earthen Maker"] = new RulesElement({
  ...
  te = Power["Vestige of the Onyx Queen"] = new RulesElement({
  ...
  te = Power["Vestige of the Unknown Arcanist"] = new RulesElement({
  ...
  te = Power["Vestige of Vykolad"] = new RulesElement({
  ...
  te = Power["Walking Conflagration Attack"] = new RulesElement({
  ...
  te = Power["Warding Shot"] = new RulesElement({
    name: "Warding Shot",
    type: "Power",
  ...
  te = Power["Warning Shot"] = new RulesElement({
    name: "Warning Shot",
    type: "Power",
  ...
  te = Power["Wicked Flames"] = new RulesElement({
    name: "Wicked Flames",
    type: "Power",
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_11086"]);
    }
  });
  byID[te.id] = te;
  
  te = Power["Wicked Flames Attack"] = new RulesElement({
