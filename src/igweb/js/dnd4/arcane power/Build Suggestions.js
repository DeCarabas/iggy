(function(global, undefined) {
  ...
  te = Build_Suggestions["Cosmic Sorcerer"] = new RulesElement({
    ...
    source: "Arcane Power",
    categories: ["Cosmic Sorcerer", "ID_INTERNAL_BUILD_SUGGESTIONS_COSMIC_SORCERER"],
  ...
  te = Build_Suggestions["Ensnaring Swordmage"] = new RulesElement({
    ...
    source: "Arcane Power",
    categories: ["Ensnaring Swordmage", "ID_INTERNAL_BUILD_SUGGESTIONS_ENSNARING_SWORDMAGE"],
    rules: function(model) {
      // unsupported rule: cbimporter.Rules.SuggestRule
      // unsupported rule: cbimporter.Rules.SuggestRule
      // unsupported rule: cbimporter.Rules.SuggestRule
  ...
  te = Build_Suggestions["Illusionist Wizard"] = new RulesElement({
    ...
    source: "Arcane Power",
    categories: ["Illusionist Wizard", "ID_INTERNAL_BUILD_SUGGESTIONS_ILLUSIONIST_WIZARD"],
    rules: function(model) {
      // unsupported rule: cbimporter.Rules.SuggestRule
      // unsupported rule: cbimporter.Rules.SuggestRule
      // unsupported rule: cbimporter.Rules.SuggestRule
  ...
  te = Build_Suggestions["Prescient Bard"] = new RulesElement({
    ...
    source: "Arcane Power",
    categories: ["Prescient Bard", "ID_INTERNAL_BUILD_SUGGESTIONS_PRESCIENT_BARD"],
    rules: function(model) {
      // unsupported rule: cbimporter.Rules.SuggestRule
      // unsupported rule: cbimporter.Rules.SuggestRule
      // unsupported rule: cbimporter.Rules.SuggestRule
  ...
  te = Build_Suggestions["Storm Sorcerer"] = new RulesElement({
    ...
    source: "Arcane Power",
    categories: ["Storm Sorcerer", "ID_INTERNAL_BUILD_SUGGESTIONS_STORM_SORCERER"],
    rules: function(model) {
      // unsupported rule: cbimporter.Rules.SuggestRule
      // unsupported rule: cbimporter.Rules.SuggestRule
      // unsupported rule: cbimporter.Rules.SuggestRule
  ...
  te = Build_Suggestions["Summoner Wizard"] = new RulesElement({
    ...
    source: "Arcane Power",
    categories: ["Summoner Wizard", "ID_INTERNAL_BUILD_SUGGESTIONS_SUMMONER_WIZARD"],
    rules: function(model) {
      // unsupported rule: cbimporter.Rules.SuggestRule
      // unsupported rule: cbimporter.Rules.SuggestRule
      // unsupported rule: cbimporter.Rules.SuggestRule
