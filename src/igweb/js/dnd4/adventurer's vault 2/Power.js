(function(global, undefined) {
  ...
  te = Power["Ally's Opportunity"] = new RulesElement({
  ...
  te = Power["Blood of the Akarot"] = new RulesElement({
  ...
  te = Power["Hand of Salzacas"] = new RulesElement({
  ...
  te = Power["Strength of Ayrkashna"] = new RulesElement({
  ...
  te = Power["Tinkerer's Disjunction"] = new RulesElement({
  ...
  te = Power["Voice of the Akarot"] = new RulesElement({
