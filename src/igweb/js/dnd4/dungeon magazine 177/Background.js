(function(global, undefined) {
  ...
  te = Background["Bloodstone Runehammer"] = new RulesElement({
  ...
  te = Background["Order of the Golden Cup"] = new RulesElement({
  ...
  te = Background["Scion of the Granite Tower"] = new RulesElement({
  ...
  te = Background["Spirit Hunter of the White Worm"] = new RulesElement({
  ...
  te = Background["Spysong Troubadour"] = new RulesElement({
  ...
  te = Background["Telosian Scamp"] = new RulesElement({
    name: "Telosian Scamp",
    type: "Background",
  ...
  te = Background["Vault-Warden of the Lost Ways"] = new RulesElement({
  ...
  te = Background["Zhengyian Blood Mage"] = new RulesElement({
