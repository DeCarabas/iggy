(function(global, undefined) {
  ...
  te = Ritual["Animal Messenger"] = new RulesElement({
  ...
  te = Ritual["Arcane Lock"] = new RulesElement({
    name: "Arcane Lock",
    type: "Ritual",
    id: "ID_FMP_RITUAL_23",
    source: "Player's Handbook",
  ...
  te = Ritual["Brew Potion"] = new RulesElement({
    name: "Brew Potion",
    type: "Ritual",
    id: "ID_FMP_RITUAL_1",
    source: "Player's Handbook",
  ...
  te = Ritual["Commune With Nature"] = new RulesElement({
  ...
  te = Ritual["Comprehend Language"] = new RulesElement({
  ...
  te = Ritual["Consult Mystic Sages"] = new RulesElement({
  ...
  te = Ritual["Consult Oracle"] = new RulesElement({
    name: "Consult Oracle",
    type: "Ritual",
    id: "ID_FMP_RITUAL_5",
    source: "Player's Handbook",
  ...
  te = Ritual["Cure Disease"] = new RulesElement({
    name: "Cure Disease",
    type: "Ritual",
    id: "ID_FMP_RITUAL_6",
    source: "Player's Handbook",
  ...
  te = Ritual["Detect Object"] = new RulesElement({
    name: "Detect Object",
    type: "Ritual",
    id: "ID_FMP_RITUAL_43",
    source: "Player's Handbook",
  ...
  te = Ritual["Detect Secret Doors"] = new RulesElement({
  ...
  te = Ritual["Discern Lies"] = new RulesElement({
    name: "Discern Lies",
    type: "Ritual",
    id: "ID_FMP_RITUAL_44",
    source: "Player's Handbook",
  ...
  te = Ritual["Disenchant Magic Item"] = new RulesElement({
  ...
  te = Ritual["Drawmij's Instant Summons"] = new RulesElement({
  ...
  te = Ritual["Enchant Magic Item"] = new RulesElement({
  ...
  te = Ritual["Endure Elements"] = new RulesElement({
  ...
  te = Ritual["Eye of Alarm"] = new RulesElement({
    name: "Eye of Alarm",
    type: "Ritual",
    id: "ID_FMP_RITUAL_11",
    source: "Player's Handbook",
  ...
  te = Ritual["Eye of Warning"] = new RulesElement({
    name: "Eye of Warning",
    type: "Ritual",
    id: "ID_FMP_RITUAL_63",
    source: "Player's Handbook",
  ...
  te = Ritual["Forbiddance"] = new RulesElement({
    name: "Forbiddance",
    type: "Ritual",
    id: "ID_FMP_RITUAL_12",
    source: "Player's Handbook",
  ...
  te = Ritual["Gentle Repose"] = new RulesElement({
    name: "Gentle Repose",
    type: "Ritual",
    id: "ID_FMP_RITUAL_47",
    source: "Player's Handbook",
  ...
  te = Ritual["Hallucinatory Creature"] = new RulesElement({
  ...
  te = Ritual["Hallucinatory Item"] = new RulesElement({
  ...
  te = Ritual["Hand of Fate"] = new RulesElement({
    name: "Hand of Fate",
    type: "Ritual",
    id: "ID_FMP_RITUAL_16",
    source: "Player's Handbook",
  ...
  te = Ritual["Knock"] = new RulesElement({
    name: "Knock",
    type: "Ritual",
    id: "ID_FMP_RITUAL_22",
    source: "Player's Handbook",
  ...
  te = Ritual["Leomund's Secret Chest"] = new RulesElement({
  ...
  te = Ritual["Linked Portal"] = new RulesElement({
    name: "Linked Portal",
    type: "Ritual",
    id: "ID_FMP_RITUAL_2",
    source: "Player's Handbook",
  ...
  te = Ritual["Loremaster's Bargain"] = new RulesElement({
  ...
  te = Ritual["Magic Circle"] = new RulesElement({
    name: "Magic Circle",
    type: "Ritual",
    id: "ID_FMP_RITUAL_49",
    source: "Player's Handbook",
  ...
  te = Ritual["Magic Mouth"] = new RulesElement({
    name: "Magic Mouth",
    type: "Ritual",
    id: "ID_FMP_RITUAL_50",
    source: "Player's Handbook",
  ...
  te = Ritual["Make Whole"] = new RulesElement({
    name: "Make Whole",
    type: "Ritual",
    id: "ID_FMP_RITUAL_51",
    source: "Player's Handbook",
  ...
  te = Ritual["Observe Creature"] = new RulesElement({
  ...
  te = Ritual["Passwall"] = new RulesElement({
    name: "Passwall",
    type: "Ritual",
    id: "ID_FMP_RITUAL_53",
    source: "Player's Handbook",
  ...
  te = Ritual["Phantom Steed"] = new RulesElement({
    name: "Phantom Steed",
    type: "Ritual",
    id: "ID_FMP_RITUAL_26",
    source: "Player's Handbook",
  ...
  te = Ritual["Planar Portal"] = new RulesElement({
    name: "Planar Portal",
    type: "Ritual",
    id: "ID_FMP_RITUAL_14",
    source: "Player's Handbook",
  ...
  te = Ritual["Raise Dead"] = new RulesElement({
    name: "Raise Dead",
    type: "Ritual",
    id: "ID_FMP_RITUAL_27",
    source: "Player's Handbook",
  ...
  te = Ritual["Remove Affliction"] = new RulesElement({
  ...
  te = Ritual["Secret Page"] = new RulesElement({
    name: "Secret Page",
    type: "Ritual",
    id: "ID_FMP_RITUAL_54",
    source: "Player's Handbook",
  ...
  te = Ritual["Sending"] = new RulesElement({
    name: "Sending",
    type: "Ritual",
    id: "ID_FMP_RITUAL_55",
    source: "Player's Handbook",
  ...
  te = Ritual["Shadow Walk"] = new RulesElement({
    name: "Shadow Walk",
    type: "Ritual",
    id: "ID_FMP_RITUAL_56",
    source: "Player's Handbook",
  ...
  te = Ritual["Silence"] = new RulesElement({
    name: "Silence",
    type: "Ritual",
    id: "ID_FMP_RITUAL_58",
    source: "Player's Handbook",
  ...
  te = Ritual["Speak with Dead"] = new RulesElement({
  ...
  te = Ritual["Tenser's Floating Disk"] = new RulesElement({
  ...
  te = Ritual["Travelers' Feast"] = new RulesElement({
  ...
  te = Ritual["True Portal"] = new RulesElement({
    name: "True Portal",
    type: "Ritual",
    id: "ID_FMP_RITUAL_15",
    source: "Player's Handbook",
  ...
  te = Ritual["View Location"] = new RulesElement({
    name: "View Location",
    type: "Ritual",
    id: "ID_FMP_RITUAL_34",
    source: "Player's Handbook",
  ...
  te = Ritual["View Object"] = new RulesElement({
    name: "View Object",
    type: "Ritual",
    id: "ID_FMP_RITUAL_35",
    source: "Player's Handbook",
  ...
  te = Ritual["Voice of Fate"] = new RulesElement({
    name: "Voice of Fate",
    type: "Ritual",
    id: "ID_FMP_RITUAL_36",
    source: "Player's Handbook",
  ...
  te = Ritual["Water Breathing"] = new RulesElement({
  ...
  te = Ritual["Water Walk"] = new RulesElement({
    name: "Water Walk",
    type: "Ritual",
    id: "ID_FMP_RITUAL_61",
    source: "Player's Handbook",
  ...
  te = Ritual["Wizard's Sight"] = new RulesElement({
    name: "Wizard's Sight",
    type: "Ritual",
    id: "ID_FMP_RITUAL_3",
    source: "Player's Handbook",
