(function(global, undefined) {
  ...
  te = Armor["Chainmail"] = new RulesElement({
    name: "Chainmail",
    type: "Armor",
    id: "ID_FMP_ARMOR_4",
  ...
  te = Armor["Cloth Armor (Basic Clothing)"] = new RulesElement({
  ...
  te = Armor["Darkhide Armor"] = new RulesElement({
    name: "Darkhide Armor",
    type: "Armor",
    id: "ID_FMP_ARMOR_14",
    source: "Player's Handbook",
  ...
  te = Armor["Elderhide Armor"] = new RulesElement({
  ...
  te = Armor["Elderscale Armor"] = new RulesElement({
  ...
  te = Armor["Feyleather Armor"] = new RulesElement({
  ...
  te = Armor["Feyweave Armor"] = new RulesElement({
    name: "Feyweave Armor",
    type: "Armor",
    id: "ID_FMP_ARMOR_10",
    source: "Player's Handbook",
  ...
  te = Armor["Forgemail"] = new RulesElement({
    name: "Forgemail",
    type: "Armor",
    id: "ID_FMP_ARMOR_16",
    source: "Player's Handbook",
  ...
  te = Armor["Godplate Armor"] = new RulesElement({
    name: "Godplate Armor",
    type: "Armor",
    id: "ID_FMP_ARMOR_21",
    source: "Player's Handbook",
  ...
  te = Armor["Heavy Shield"] = new RulesElement({
    name: "Heavy Shield",
    type: "Armor",
    id: "ID_FMP_ARMOR_8",
    source: "Player's Handbook",
  ...
  te = Armor["Hide Armor"] = new RulesElement({
    name: "Hide Armor",
    type: "Armor",
    id: "ID_FMP_ARMOR_3",
    source: "Player's Handbook",
  ...
  te = Armor["Leather Armor"] = new RulesElement({
    name: "Leather Armor",
    type: "Armor",
    id: "ID_FMP_ARMOR_2",
    source: "Player's Handbook",
  ...
  te = Armor["Light Shield"] = new RulesElement({
    name: "Light Shield",
    type: "Armor",
    id: "ID_FMP_ARMOR_7",
    source: "Player's Handbook",
  ...
  te = Armor["Plate Armor"] = new RulesElement({
    name: "Plate Armor",
    type: "Armor",
    id: "ID_FMP_ARMOR_6",
    source: "Player's Handbook",
  ...
  te = Armor["Scale Armor"] = new RulesElement({
    name: "Scale Armor",
    type: "Armor",
    id: "ID_FMP_ARMOR_5",
    source: "Player's Handbook",
  ...
  te = Armor["Spiritmail"] = new RulesElement({
    name: "Spiritmail",
    type: "Armor",
    id: "ID_FMP_ARMOR_17",
    source: "Player's Handbook",
  ...
  te = Armor["Starleather Armor"] = new RulesElement({
  ...
  te = Armor["Starweave Armor"] = new RulesElement({
  ...
  te = Armor["Warplate Armor"] = new RulesElement({
    name: "Warplate Armor",
    type: "Armor",
    id: "ID_FMP_ARMOR_20",
    source: "Player's Handbook",
  ...
  te = Armor["Wyrmscale Armor"] = new RulesElement({
