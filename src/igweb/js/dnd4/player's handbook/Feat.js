(function(global, undefined) {
  ...
  te = Feat["Acolyte Power"] = new RulesElement({
    name: "Acolyte Power",
    type: "Feat",
    id: "ID_FMP_FEAT_340",
  ...
  te = Feat["Action Recovery"] = new RulesElement({
  ...
  te = Feat["Action Surge"] = new RulesElement({
    name: "Action Surge",
    type: "Feat",
    id: "ID_FMP_FEAT_215",
    source: "Player's Handbook",
  ...
  te = Feat["Adept Power"] = new RulesElement({
    name: "Adept Power",
    type: "Feat",
    id: "ID_FMP_FEAT_341",
    source: "Player's Handbook",
  ...
  te = Feat["Agile Athlete"] = new RulesElement({
    name: "Agile Athlete",
    type: "Feat",
    id: "ID_FMP_FEAT_50",
    source: "Player's Handbook",
  ...
  te = Feat["Agile Hunter"] = new RulesElement({
    name: "Agile Hunter",
    type: "Feat",
    id: "ID_FMP_FEAT_280",
    source: "Player's Handbook",
  ...
  te = Feat["Alertness"] = new RulesElement({
    name: "Alertness",
    type: "Feat",
    id: "ID_FMP_FEAT_109",
    source: "Player's Handbook",
  ...
  te = Feat["Arcane Initiate"] = new RulesElement({
  ...
  te = Feat["Arcane Mastery"] = new RulesElement({
    name: "Arcane Mastery",
    type: "Feat",
    id: "ID_FMP_FEAT_110",
    source: "Player's Handbook",
  ...
  te = Feat["Arcane Reach"] = new RulesElement({
    name: "Arcane Reach",
    type: "Feat",
    id: "ID_FMP_FEAT_310",
    source: "Player's Handbook",
  ...
  te = Feat["Armor of Bahamut"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_2161"]);
    }
  });
  byID[te.id] = te;
  
  te = Feat["Armor Proficiency: Chainmail"] = new RulesElement({
  ...
  te = Feat["Armor Proficiency: Cloth"] = new RulesElement({
  ...
  te = Feat["Armor Proficiency: Hide"] = new RulesElement({
  ...
  te = Feat["Armor Proficiency: Leather"] = new RulesElement({
  ...
  te = Feat["Armor Proficiency: Plate"] = new RulesElement({
  ...
  te = Feat["Armor Proficiency: Scale"] = new RulesElement({
  ...
  te = Feat["Armor Specialization (Chainmail)"] = new RulesElement({
  ...
  te = Feat["Armor Specialization (Hide)"] = new RulesElement({
  ...
  te = Feat["Armor Specialization (Plate)"] = new RulesElement({
  ...
  te = Feat["Armor Specialization (Scale)"] = new RulesElement({
  ...
  te = Feat["Astral Fire"] = new RulesElement({
    name: "Astral Fire",
    type: "Feat",
    id: "ID_FMP_FEAT_282",
    source: "Player's Handbook",
  ...
  te = Feat["Avandra's Rescue"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_2162"]);
    }
  });
  byID[te.id] = te;
  
  te = Feat["Axe Mastery"] = new RulesElement({
    name: "Axe Mastery",
    type: "Feat",
    id: "ID_FMP_FEAT_184",
    source: "Player's Handbook",
  ...
  te = Feat["Back to the Wall"] = new RulesElement({
  ...
  te = Feat["Backstabber"] = new RulesElement({
    name: "Backstabber",
    type: "Feat",
    id: "ID_FMP_FEAT_185",
    source: "Player's Handbook",
  ...
  te = Feat["Blade Opportunist"] = new RulesElement({
  ...
  te = Feat["Blind-Fight"] = new RulesElement({
    name: "Blind-Fight",
    type: "Feat",
    id: "ID_FMP_FEAT_119",
    source: "Player's Handbook",
  ...
  te = Feat["Blood Thirst"] = new RulesElement({
    name: "Blood Thirst",
    type: "Feat",
    id: "ID_FMP_FEAT_2",
    source: "Player's Handbook",
  ...
  te = Feat["Bludgeon Mastery"] = new RulesElement({
  ...
  te = Feat["Burning Blizzard"] = new RulesElement({
  ...
  te = Feat["Combat Anticipation"] = new RulesElement({
  ...
  te = Feat["Combat Commander"] = new RulesElement({
  ...
  te = Feat["Combat Reflexes"] = new RulesElement({
  ...
  te = Feat["Corellon's Grace"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_1953"]);
    }
  });
  byID[te.id] = te;
  
  te = Feat["Danger Sense"] = new RulesElement({
    name: "Danger Sense",
    type: "Feat",
    id: "ID_FMP_FEAT_16",
    source: "Player's Handbook",
  ...
  te = Feat["Dark Fury"] = new RulesElement({
    name: "Dark Fury",
    type: "Feat",
    id: "ID_FMP_FEAT_285",
    source: "Player's Handbook",
  ...
  te = Feat["Deadly Axe"] = new RulesElement({
    name: "Deadly Axe",
    type: "Feat",
    id: "ID_FMP_FEAT_243",
    source: "Player's Handbook",
  ...
  te = Feat["Defensive Advantage"] = new RulesElement({
  ...
  te = Feat["Defensive Mobility"] = new RulesElement({
  ...
  te = Feat["Devastating Critical"] = new RulesElement({
  ...
  te = Feat["Distant Shot"] = new RulesElement({
    name: "Distant Shot",
    type: "Feat",
    id: "ID_FMP_FEAT_312",
    source: "Player's Handbook",
  ...
  te = Feat["Distracting Shield"] = new RulesElement({
  ...
  te = Feat["Dodge Giants"] = new RulesElement({
    name: "Dodge Giants",
    type: "Feat",
    id: "ID_FMP_FEAT_193",
    source: "Player's Handbook",
  ...
  te = Feat["Dragonborn Frenzy"] = new RulesElement({
  ...
  te = Feat["Dragonborn Senses"] = new RulesElement({
  ...
  te = Feat["Durable"] = new RulesElement({
    name: "Durable",
    type: "Feat",
    id: "ID_FMP_FEAT_131",
    source: "Player's Handbook",
  ...
  te = Feat["Dwarven Durability"] = new RulesElement({
  ...
  te = Feat["Dwarven Weapon Training"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_PROFICIENCY_WEAPON_GROUP_(AXE)"]);
      model.grant(elements.id["ID_INTERNAL_PROFICIENCY_WEAPON_GROUP_(HAMMER)"]);
  ...
  te = Feat["Eladrin Soldier"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_PROFICIENCY_WEAPON_GROUP_(SPEAR)"]);
  ...
  te = Feat["Elven Precision"] = new RulesElement({
  ...
  te = Feat["Empowered Dragon Breath"] = new RulesElement({
  ...
  te = Feat["Enlarged Dragon Breath"] = new RulesElement({
  ...
  te = Feat["Epic Resurgence"] = new RulesElement({
  ...
  te = Feat["Escape Artist"] = new RulesElement({
    name: "Escape Artist",
    type: "Feat",
    id: "ID_FMP_FEAT_19",
    source: "Player's Handbook",
  ...
  te = Feat["Evasion"] = new RulesElement({
    name: "Evasion",
    type: "Feat",
    id: "ID_FMP_FEAT_20",
    source: "Player's Handbook",
  ...
  te = Feat["Expanded Spellbook"] = new RulesElement({
  ...
  te = Feat["Far Shot"] = new RulesElement({
    name: "Far Shot",
    type: "Feat",
    id: "ID_FMP_FEAT_139",
    source: "Player's Handbook",
  ...
  te = Feat["Far Throw"] = new RulesElement({
    name: "Far Throw",
    type: "Feat",
    id: "ID_FMP_FEAT_140",
    source: "Player's Handbook",
  ...
  te = Feat["Fast Runner"] = new RulesElement({
    name: "Fast Runner",
    type: "Feat",
    id: "ID_FMP_FEAT_6",
    source: "Player's Handbook",
  ...
  te = Feat["Ferocious Rebuke"] = new RulesElement({
  ...
  te = Feat["Feywild Protection"] = new RulesElement({
  ...
  te = Feat["Fiery Rebuke"] = new RulesElement({
    name: "Fiery Rebuke",
    type: "Feat",
    id: "ID_FMP_FEAT_211",
    source: "Player's Handbook",
  ...
  te = Feat["Flail Mastery"] = new RulesElement({
    name: "Flail Mastery",
    type: "Feat",
    id: "ID_FMP_FEAT_329",
    source: "Player's Handbook",
  ...
  te = Feat["Flanking Maneuver"] = new RulesElement({
  ...
  te = Feat["Fleet-Footed"] = new RulesElement({
    name: "Fleet-Footed",
    type: "Feat",
    id: "ID_FMP_FEAT_142",
    source: "Player's Handbook",
  ...
  te = Feat["Font of Radiance"] = new RulesElement({
  ...
  te = Feat["Great Fortitude"] = new RulesElement({
  ...
  te = Feat["Group Insight"] = new RulesElement({
    name: "Group Insight",
    type: "Feat",
    id: "ID_FMP_FEAT_288",
    source: "Player's Handbook",
  ...
  te = Feat["Halfling Agility"] = new RulesElement({
  ...
  te = Feat["Hammer Rhythm"] = new RulesElement({
    name: "Hammer Rhythm",
    type: "Feat",
    id: "ID_FMP_FEAT_246",
    source: "Player's Handbook",
  ...
  te = Feat["Harmony of Erathis"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_2165"]);
    }
  });
  byID[te.id] = te;
  
  te = Feat["Healing Hands"] = new RulesElement({
    name: "Healing Hands",
    type: "Feat",
    id: "ID_FMP_FEAT_290",
    source: "Player's Handbook",
  ...
  te = Feat["Heavy Blade Mastery"] = new RulesElement({
  ...
  te = Feat["Heavy Blade Opportunity"] = new RulesElement({
  ...
  te = Feat["Hellfire Blood"] = new RulesElement({
    name: "Hellfire Blood",
    type: "Feat",
    id: "ID_FMP_FEAT_44",
    source: "Player's Handbook",
  ...
  te = Feat["Human Perseverance"] = new RulesElement({
  ...
  te = Feat["Improved Dark One's Blessing"] = new RulesElement({
  ...
  te = Feat["Improved Fate of the Void"] = new RulesElement({
  ...
  te = Feat["Improved Initiative"] = new RulesElement({
  ...
  te = Feat["Improved Misty Step"] = new RulesElement({
  ...
  te = Feat["Improved Second Wind"] = new RulesElement({
  ...
  te = Feat["Inescapable Force"] = new RulesElement({
  ...
  te = Feat["Initiate of the Faith"] = new RulesElement({
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_INTERNAL_COUNTSASCLASS_CLERIC"]);
      model.grant(elements.id["ID_INTERNAL_MULTICLASS_MULTICLASS"]);
    }
  });
  byID[te.id] = te;
  
  te = Feat["Inspired Recovery"] = new RulesElement({
  ...
  te = Feat["Ioun's Poise"] = new RulesElement({
    name: "Ioun's Poise",
    type: "Feat",
    id: "ID_FMP_FEAT_295",
    source: "Player's Handbook",
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_2166"]);
    }
  });
  byID[te.id] = te;
  
  te = Feat["Iron Will"] = new RulesElement({
    name: "Iron Will",
    type: "Feat",
    id: "ID_FMP_FEAT_148",
    source: "Player's Handbook",
  ...
  te = Feat["Irresistible Flame"] = new RulesElement({
  ...
  te = Feat["Jack of All Trades"] = new RulesElement({
  ...
  te = Feat["Kord's Favor"] = new RulesElement({
    name: "Kord's Favor",
    type: "Feat",
    id: "ID_FMP_FEAT_296",
    source: "Player's Handbook",
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_2167"]);
    }
  });
  byID[te.id] = te;
  
  te = Feat["Lasting Frost"] = new RulesElement({
    name: "Lasting Frost",
    type: "Feat",
    id: "ID_FMP_FEAT_316",
    source: "Player's Handbook",
  ...
  te = Feat["Lethal Hunter"] = new RulesElement({
    name: "Lethal Hunter",
    type: "Feat",
    id: "ID_FMP_FEAT_273",
    source: "Player's Handbook",
  ...
  te = Feat["Light Blade Mastery"] = new RulesElement({
  ...
  te = Feat["Light Blade Precision"] = new RulesElement({
  ...
  te = Feat["Light Step"] = new RulesElement({
    name: "Light Step",
    type: "Feat",
    id: "ID_FMP_FEAT_60",
    source: "Player's Handbook",
  ...
  te = Feat["Lightning Arc"] = new RulesElement({
    name: "Lightning Arc",
    type: "Feat",
    id: "ID_FMP_FEAT_317",
    source: "Player's Handbook",
  ...
  te = Feat["Lightning Reflexes"] = new RulesElement({
  ...
  te = Feat["Linguist"] = new RulesElement({
    name: "Linguist",
    type: "Feat",
    id: "ID_FMP_FEAT_150",
    source: "Player's Handbook",
  ...
  te = Feat["Linguist II"] = new RulesElement({
    name: "Linguist II",
    type: "Feat",
  ...
  te = Feat["Linguist III"] = new RulesElement({
    name: "Linguist III",
    type: "Feat",
  ...
  te = Feat["Linguist IV"] = new RulesElement({
    name: "Linguist IV",
    type: "Feat",
  ...
  te = Feat["Linguist V"] = new RulesElement({
    name: "Linguist V",
    type: "Feat",
  ...
  te = Feat["Linguist VI"] = new RulesElement({
    name: "Linguist VI",
    type: "Feat",
  ...
  te = Feat["Long Jumper"] = new RulesElement({
    name: "Long Jumper",
    type: "Feat",
    id: "ID_FMP_FEAT_27",
    source: "Player's Handbook",
  ...
  te = Feat["Lost in the Crowd"] = new RulesElement({
  ...
  te = Feat["Melora's Tide"] = new RulesElement({
    name: "Melora's Tide",
    type: "Feat",
    id: "ID_FMP_FEAT_297",
    source: "Player's Handbook",
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_2168"]);
    }
  });
  byID[te.id] = te;
  
  te = Feat["Mettle"] = new RulesElement({
    name: "Mettle",
    type: "Feat",
    id: "ID_FMP_FEAT_29",
    source: "Player's Handbook",
  ...
  te = Feat["Moradin's Resolve"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_2170"]);
    }
  });
  byID[te.id] = te;
  
  te = Feat["Mounted Combat"] = new RulesElement({
    name: "Mounted Combat",
    type: "Feat",
    id: "ID_FMP_FEAT_30",
    source: "Player's Handbook",
  ...
  te = Feat["Nimble Blade"] = new RulesElement({
    name: "Nimble Blade",
    type: "Feat",
    id: "ID_FMP_FEAT_238",
    source: "Player's Handbook",
  ...
  te = Feat["Novice Power"] = new RulesElement({
    name: "Novice Power",
    type: "Feat",
    id: "ID_FMP_FEAT_339",
    source: "Player's Handbook",
  ...
  te = Feat["Pact Initiate"] = new RulesElement({
    name: "Pact Initiate",
    type: "Feat",
    id: "ID_FMP_FEAT_337",
    source: "Player's Handbook",
  ...
  te = Feat["Pelor's Radiance"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_2171"]);
    }
  });
  byID[te.id] = te;
  
  te = Feat["Pick Mastery"] = new RulesElement({
    name: "Pick Mastery",
    type: "Feat",
    id: "ID_FMP_FEAT_255",
    source: "Player's Handbook",
  ...
  te = Feat["Point-Blank Shot"] = new RulesElement({
  ...
  te = Feat["Polearm Gamble"] = new RulesElement({
    name: "Polearm Gamble",
    type: "Feat",
    id: "ID_FMP_FEAT_258",
    source: "Player's Handbook",
  ...
  te = Feat["Potent Challenge"] = new RulesElement({
  ...
  te = Feat["Power Attack"] = new RulesElement({
    name: "Power Attack",
    type: "Feat",
    id: "ID_FMP_FEAT_261",
    source: "Player's Handbook",
  ...
  te = Feat["Powerful Charge"] = new RulesElement({
  ...
  te = Feat["Precise Hunter"] = new RulesElement({
    name: "Precise Hunter",
    type: "Feat",
    id: "ID_FMP_FEAT_301",
    source: "Player's Handbook",
  ...
  te = Feat["Press the Advantage"] = new RulesElement({
  ...
  te = Feat["Psychic Lock"] = new RulesElement({
    name: "Psychic Lock",
    type: "Feat",
    id: "ID_FMP_FEAT_318",
    source: "Player's Handbook",
  ...
  te = Feat["Quick Draw"] = new RulesElement({
    name: "Quick Draw",
    type: "Feat",
    id: "ID_FMP_FEAT_157",
    source: "Player's Handbook",
  ...
  te = Feat["Raging Storm"] = new RulesElement({
    name: "Raging Storm",
    type: "Feat",
    id: "ID_FMP_FEAT_303",
    source: "Player's Handbook",
  ...
  te = Feat["Raven Queen's Blessing"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_2173"]);
    }
  });
  byID[te.id] = te;
  
  te = Feat["Resounding Thunder"] = new RulesElement({
  ...
  te = Feat["Ritual Caster"] = new RulesElement({
    name: "Ritual Caster",
    type: "Feat",
    id: "ID_FMP_FEAT_159",
    source: "Player's Handbook",
  ...
  te = Feat["Running Shot"] = new RulesElement({
    name: "Running Shot",
    type: "Feat",
    id: "ID_FMP_FEAT_57",
    source: "Player's Handbook",
  ...
  te = Feat["Scimitar Dance"] = new RulesElement({
    name: "Scimitar Dance",
    type: "Feat",
    id: "ID_FMP_FEAT_256",
    source: "Player's Handbook",
  ...
  te = Feat["Second Implement"] = new RulesElement({
  ...
  te = Feat["Secret Stride"] = new RulesElement({
    name: "Secret Stride",
    type: "Feat",
    id: "ID_FMP_FEAT_31",
    source: "Player's Handbook",
  ...
  te = Feat["Sehanine's Reversal"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_2174"]);
    }
  });
  byID[te.id] = te;
  
  te = Feat["Seize the Moment"] = new RulesElement({
  ...
  te = Feat["Shield Proficiency: Heavy"] = new RulesElement({
  ...
  te = Feat["Shield Proficiency: Light"] = new RulesElement({
  ...
  te = Feat["Shield Push"] = new RulesElement({
    name: "Shield Push",
    type: "Feat",
    id: "ID_FMP_FEAT_306",
    source: "Player's Handbook",
  ...
  te = Feat["Shield Specialization"] = new RulesElement({
  ...
  te = Feat["Skill Focus"] = new RulesElement({
    name: "Skill Focus",
    type: "Feat",
    id: "ID_FMP_FEAT_165",
    source: "Player's Handbook",
  ...
  te = Feat["Skill Focus (Acrobatics)"] = new RulesElement({
  ...
  te = Feat["Skill Focus (Arcana)"] = new RulesElement({
  ...
  te = Feat["Skill Focus (Athletics)"] = new RulesElement({
  ...
  te = Feat["Skill Focus (Bluff)"] = new RulesElement({
  ...
  te = Feat["Skill Focus (Diplomacy)"] = new RulesElement({
  ...
  te = Feat["Skill Focus (Dungeoneering)"] = new RulesElement({
  ...
  te = Feat["Skill Focus (Endurance)"] = new RulesElement({
  ...
  te = Feat["Skill Focus (Heal)"] = new RulesElement({
  ...
  te = Feat["Skill Focus (History)"] = new RulesElement({
  ...
  te = Feat["Skill Focus (Insight)"] = new RulesElement({
  ...
  te = Feat["Skill Focus (Intimidate)"] = new RulesElement({
  ...
  te = Feat["Skill Focus (Nature)"] = new RulesElement({
  ...
  te = Feat["Skill Focus (Perception)"] = new RulesElement({
  ...
  te = Feat["Skill Focus (Religion)"] = new RulesElement({
  ...
  te = Feat["Skill Focus (Stealth)"] = new RulesElement({
  ...
  te = Feat["Skill Focus (Streetwise)"] = new RulesElement({
  ...
  te = Feat["Skill Focus (Thievery)"] = new RulesElement({
  ...
  te = Feat["Skill Training"] = new RulesElement({
    name: "Skill Training",
    type: "Feat",
    id: "ID_FMP_FEAT_166",
    source: "Player's Handbook",
  ...
  te = Feat["Skill Training (Acrobatics)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_SKILL_TRAINING_ACROBATICS"]);
    }
  });
  byID[te.id] = te;
  
  te = Feat["Skill Training (Arcana)"] = new RulesElement({
  ...
  te = Feat["Skill Training (Athletics)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_SKILL_TRAINING_ATHLETICS"]);
    }
  });
  byID[te.id] = te;
  
  te = Feat["Skill Training (Bluff)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_SKILL_TRAINING_BLUFF"]);
    }
  });
  byID[te.id] = te;
  
  te = Feat["Skill Training (Diplomacy)"] = new RulesElement({
  ...
  te = Feat["Skill Training (Dungeoneering)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_SKILL_TRAINING_DUNGEONEERING"]);
    }
  });
  byID[te.id] = te;
  
  te = Feat["Skill Training (Endurance)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_SKILL_TRAINING_ENDURANCE"]);
    }
  });
  byID[te.id] = te;
  
  te = Feat["Skill Training (Heal)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_SKILL_TRAINING_HEAL"]);
    }
  });
  byID[te.id] = te;
  
  te = Feat["Skill Training (History)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_SKILL_TRAINING_HISTORY"]);
    }
  });
  byID[te.id] = te;
  
  te = Feat["Skill Training (Insight)"] = new RulesElement({
  ...
  te = Feat["Skill Training (Intimidate)"] = new RulesElement({
  ...
  te = Feat["Skill Training (Nature)"] = new RulesElement({
  ...
  te = Feat["Skill Training (Perception)"] = new RulesElement({
  ...
  te = Feat["Skill Training (Religion)"] = new RulesElement({
  ...
  te = Feat["Skill Training (Stealth)"] = new RulesElement({
  ...
  te = Feat["Skill Training (Streetwise)"] = new RulesElement({
  ...
  te = Feat["Skill Training (Thievery)"] = new RulesElement({
  ...
  te = Feat["Sly Hunter"] = new RulesElement({
    name: "Sly Hunter",
    type: "Feat",
    id: "ID_FMP_FEAT_321",
    source: "Player's Handbook",
  ...
  te = Feat["Sneak of Shadows"] = new RulesElement({
  ...
  te = Feat["Soldier of the Faith"] = new RulesElement({
    ...
    rules: function(model) {
      ...
      // unsupported rule: cbimporter.Rules.ModifyRule
      model.grant(elements.id["ID_INTERNAL_PROFICIENCY_IMPLEMENT_PROFICIENCY_(HOLY_SYMBOL)"]);
      model.grant(elements.id["ID_INTERNAL_COUNTSASCLASS_PALADIN"]);
      model.grant(elements.id["ID_INTERNAL_MULTICLASS_MULTICLASS"]);
    }
  });
  byID[te.id] = te;
  
  te = Feat["Solid Sound"] = new RulesElement({
    name: "Solid Sound",
    type: "Feat",
    id: "ID_FMP_FEAT_322",
    source: "Player's Handbook",
  ...
  te = Feat["Spear Mastery"] = new RulesElement({
    name: "Spear Mastery",
    type: "Feat",
    id: "ID_FMP_FEAT_253",
    source: "Player's Handbook",
  ...
  te = Feat["Spear Push"] = new RulesElement({
    name: "Spear Push",
    type: "Feat",
    id: "ID_FMP_FEAT_242",
    source: "Player's Handbook",
  ...
  te = Feat["Spell Accuracy"] = new RulesElement({
    name: "Spell Accuracy",
    type: "Feat",
    id: "ID_FMP_FEAT_212",
    source: "Player's Handbook",
  ...
  te = Feat["Spell Focus"] = new RulesElement({
    name: "Spell Focus",
    type: "Feat",
    id: "ID_FMP_FEAT_169",
    source: "Player's Handbook",
  ...
  te = Feat["Steady Shooter"] = new RulesElement({
    name: "Steady Shooter",
    type: "Feat",
    id: "ID_FMP_FEAT_324",
    source: "Player's Handbook",
  ...
  te = Feat["Student of Battle"] = new RulesElement({
  ...
  te = Feat["Student of the Sword"] = new RulesElement({
  ...
  te = Feat["Sure Climber"] = new RulesElement({
    name: "Sure Climber",
    type: "Feat",
    id: "ID_FMP_FEAT_36",
    source: "Player's Handbook",
  ...
  te = Feat["Surprise Knockdown"] = new RulesElement({
  ...
  te = Feat["Sweeping Flail"] = new RulesElement({
    name: "Sweeping Flail",
    type: "Feat",
    id: "ID_FMP_FEAT_248",
    source: "Player's Handbook",
  ...
  te = Feat["Tactical Assault"] = new RulesElement({
  ...
  te = Feat["Toughness"] = new RulesElement({
    name: "Toughness",
    type: "Feat",
    id: "ID_FMP_FEAT_171",
    source: "Player's Handbook",
  ...
  te = Feat["Triumphant Attack"] = new RulesElement({
  ...
  te = Feat["Twofold Curse"] = new RulesElement({
    name: "Twofold Curse",
    type: "Feat",
    id: "ID_FMP_FEAT_325",
    source: "Player's Handbook",
  ...
  te = Feat["Two-Weapon Defense"] = new RulesElement({
  ...
  te = Feat["Two-Weapon Fighting"] = new RulesElement({
  ...
  te = Feat["Two-Weapon Flurry"] = new RulesElement({
  ...
  te = Feat["Uncanny Dodge"] = new RulesElement({
    name: "Uncanny Dodge",
    type: "Feat",
    id: "ID_FMP_FEAT_326",
    source: "Player's Handbook",
  ...
  te = Feat["Underfoot"] = new RulesElement({
    name: "Underfoot",
    type: "Feat",
    id: "ID_FMP_FEAT_55",
    source: "Player's Handbook",
  ...
  te = Feat["Unfettered Stride"] = new RulesElement({
  ...
  te = Feat["Warrior of the Wild"] = new RulesElement({
    ...
    rules: function(model) {
      ...
      // unsupported rule: cbimporter.Rules.ModifyRule
      // unsupported rule: cbimporter.Rules.ModifyRule
      model.grant(elements.id["ID_INTERNAL_COUNTSASCLASS_RANGER"]);
      model.grant(elements.id["ID_INTERNAL_MULTICLASS_MULTICLASS"]);
    }
  });
  byID[te.id] = te;
  
  te = Feat["Weapon Focus"] = new RulesElement({
    name: "Weapon Focus",
    type: "Feat",
    id: "ID_FMP_FEAT_233",
    source: "Player's Handbook",
  ...
  te = Feat["Weapon Focus (Axe)"] = new RulesElement({
  ...
  te = Feat["Weapon Focus (Blowgun)"] = new RulesElement({
  ...
  te = Feat["Weapon Focus (Bow)"] = new RulesElement({
  ...
  te = Feat["Weapon Focus (Crossbow)"] = new RulesElement({
  ...
  te = Feat["Weapon Focus (Flail)"] = new RulesElement({
  ...
  te = Feat["Weapon Focus (Garrote)"] = new RulesElement({
  ...
  te = Feat["Weapon Focus (Hammer)"] = new RulesElement({
  ...
  te = Feat["Weapon Focus (Heavy Blade)"] = new RulesElement({
  ...
  te = Feat["Weapon Focus (Light Blade)"] = new RulesElement({
  ...
  te = Feat["Weapon Focus (Mace)"] = new RulesElement({
  ...
  te = Feat["Weapon Focus (Pick)"] = new RulesElement({
  ...
  te = Feat["Weapon Focus (Polearm)"] = new RulesElement({
  ...
  te = Feat["Weapon Focus (Sling)"] = new RulesElement({
  ...
  te = Feat["Weapon Focus (Spear)"] = new RulesElement({
  ...
  te = Feat["Weapon Focus (Staff)"] = new RulesElement({
  ...
  te = Feat["Weapon Focus (Unarmed)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Bastard sword)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Battleaxe)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Blowgun)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Bola)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Broadsword)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Club)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Craghammer)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Crossbow)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Cutting Wheel)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Dagger)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Double axe)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Double flail)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Double Scimitar)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Double sword)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Drow Long Knife)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Execution axe)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Falchion)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Flail)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Fullblade)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Garrote)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Glaive)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Greataxe)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Greatbow)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Greatclub)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Greatspear)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Greatsword)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Halberd)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Hand Crossbow)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Handaxe)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Heavy flail)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Heavy war pick)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Javelin)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Katar)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Khopesh)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Kukri)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Light war pick)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Longbow)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Longspear)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Longsword)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Mace)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Maul)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Mordenkrad)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Morningstar)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Net)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Parrying dagger)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Quarterstaff)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Rapier)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Repeating crossbow)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Scimitar)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Scourge)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Scythe)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Short sword)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Shortbow)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Shuriken)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Sickle)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Sling)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Spear)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Spiked chain)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Spiked gauntlet)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Spiked shield)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Superior crossbow)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Talenta Boomerang)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Talenta Sharrash)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Talenta Tangat)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Throwing hammer)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Tratnyr)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Trident)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Triple-headed flail)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Urgrosh)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (War Pick)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Waraxe)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Warhammer)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Whip)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Xen'drik Boomerang)"] = new RulesElement({
  ...
  te = Feat["Weapon Proficiency (Zulaat)"] = new RulesElement({
  ...
  te = Feat["Wintertouched"] = new RulesElement({
    name: "Wintertouched",
    type: "Feat",
    id: "ID_FMP_FEAT_309",
    source: "Player's Handbook",
