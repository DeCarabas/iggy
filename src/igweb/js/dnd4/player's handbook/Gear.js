(function(global, undefined) {
  ...
  te = Gear["Adventurer's Kit"] = new RulesElement({
  ...
  te = Gear["Alchemical Reagents (Arcana)"] = new RulesElement({
  ...
  te = Gear["Arrow"] = new RulesElement({
    name: "Arrow",
    type: "Gear",
    id: "ID_FMP_GEAR_58",
    source: "Player's Handbook",
  ...
  te = Gear["Arrows"] = new RulesElement({
    name: "Arrows",
    type: "Gear",
    id: "ID_FMP_GEAR_11",
    source: "Player's Handbook",
  ...
  te = Gear["Backpack (empty)"] = new RulesElement({
    name: "Backpack (empty)",
    type: "Gear",
    id: "ID_FMP_GEAR_2",
    source: "Player's Handbook",
  ...
  te = Gear["Bedroll"] = new RulesElement({
    name: "Bedroll",
    type: "Gear",
    id: "ID_FMP_GEAR_4",
    source: "Player's Handbook",
  ...
  te = Gear["Belt Pouch (empty)"] = new RulesElement({
  ...
  te = Gear["Bottle of Wine"] = new RulesElement({
    name: "Bottle of Wine",
    type: "Gear",
    id: "ID_FMP_GEAR_40",
    source: "Player's Handbook",
  ...
  te = Gear["Candle"] = new RulesElement({
    name: "Candle",
    type: "Gear",
    id: "ID_FMP_GEAR_17",
    source: "Player's Handbook",
  ...
  te = Gear["Chain (10 ft.)"] = new RulesElement({
    name: "Chain (10 ft.)",
    type: "Gear",
    id: "ID_FMP_GEAR_18",
    source: "Player's Handbook",
  ...
  te = Gear["Chest (empty)"] = new RulesElement({
    name: "Chest (empty)",
    type: "Gear",
    id: "ID_FMP_GEAR_19",
    source: "Player's Handbook",
  ...
  te = Gear["Climber's Kit"] = new RulesElement({
    name: "Climber's Kit",
    type: "Gear",
    id: "ID_FMP_GEAR_20",
    source: "Player's Handbook",
  ...
  te = Gear["Common Meal"] = new RulesElement({
    name: "Common Meal",
    type: "Gear",
    id: "ID_FMP_GEAR_38",
    source: "Player's Handbook",
  ...
  te = Gear["Crossbow Bolt"] = new RulesElement({
    name: "Crossbow Bolt",
    type: "Gear",
    id: "ID_FMP_GEAR_59",
    source: "Player's Handbook",
  ...
  te = Gear["Crossbow Bolts"] = new RulesElement({
    name: "Crossbow Bolts",
    type: "Gear",
    id: "ID_FMP_GEAR_15",
    source: "Player's Handbook",
  ...
  te = Gear["Everburning Torch"] = new RulesElement({
  ...
  te = Gear["Feast (one meal)"] = new RulesElement({
    name: "Feast (one meal)",
    type: "Gear",
    id: "ID_FMP_GEAR_39",
    source: "Player's Handbook",
  ...
  te = Gear["Fine Clothing"] = new RulesElement({
    name: "Fine Clothing",
    type: "Gear",
    id: "ID_FMP_GEAR_25",
    source: "Player's Handbook",
  ...
  te = Gear["Flask (empty)"] = new RulesElement({
    name: "Flask (empty)",
    type: "Gear",
    id: "ID_FMP_GEAR_26",
    source: "Player's Handbook",
  ...
  te = Gear["Flint and Steel"] = new RulesElement({
  ...
  te = Gear["Grappling Hook"] = new RulesElement({
    name: "Grappling Hook",
    type: "Gear",
    id: "ID_FMP_GEAR_21",
    source: "Player's Handbook",
  ...
  te = Gear["hammer"] = new RulesElement({
    name: "hammer",
    type: "Gear",
    id: "ID_FMP_GEAR_22",
    source: "Player's Handbook",
  ...
  te = Gear["Hempen Rope (50 ft.)"] = new RulesElement({
  ...
  te = Gear["Holy Symbol"] = new RulesElement({
    name: "Holy Symbol",
    type: "Gear",
    id: "ID_FMP_GEAR_27",
    source: "Player's Handbook",
  ...
  te = Gear["Journeybread"] = new RulesElement({
    name: "Journeybread",
    type: "Gear",
    id: "ID_FMP_GEAR_110",
    source: "Player's Handbook",
  ...
  te = Gear["Journeybreads"] = new RulesElement({
    name: "Journeybreads",
    type: "Gear",
    id: "ID_FMP_GEAR_28",
    source: "Player's Handbook",
  ...
  te = Gear["Lantern"] = new RulesElement({
    name: "Lantern",
    type: "Gear",
    id: "ID_FMP_GEAR_29",
    source: "Player's Handbook",
  ...
  te = Gear["Luxury Room (per day)"] = new RulesElement({
  ...
  te = Gear["Mystic Salves (Heal)"] = new RulesElement({
  ...
  te = Gear["Oil (1 pint)"] = new RulesElement({
    name: "Oil (1 pint)",
    type: "Gear",
    id: "ID_FMP_GEAR_52",
    source: "Player's Handbook",
  ...
  te = Gear["Orb Implement"] = new RulesElement({
    name: "Orb Implement",
    type: "Gear",
    id: "ID_FMP_GEAR_3",
    source: "Player's Handbook",
  ...
  te = Gear["Pitcher of Ale"] = new RulesElement({
    name: "Pitcher of Ale",
    type: "Gear",
    id: "ID_FMP_GEAR_37",
    source: "Player's Handbook",
  ...
  te = Gear["Pitons"] = new RulesElement({
    name: "Pitons",
    type: "Gear",
    id: "ID_FMP_GEAR_23",
    source: "Player's Handbook",
  ...
  te = Gear["Rare Herbs (Nature)"] = new RulesElement({
  ...
  te = Gear["Residuum (Any)"] = new RulesElement({
    name: "Residuum (Any)",
    type: "Gear",
    id: "ID_FMP_GEAR_57",
    source: "Player's Handbook",
  ...
  te = Gear["Riding Horse"] = new RulesElement({
    name: "Riding Horse",
    type: "Gear",
    id: "ID_FMP_GEAR_43",
    source: "Player's Handbook",
  ...
  te = Gear["Ritual Book"] = new RulesElement({
    name: "Ritual Book",
    type: "Gear",
    id: "ID_FMP_GEAR_31",
    source: "Player's Handbook",
  ...
  te = Gear["Rod Implement"] = new RulesElement({
    name: "Rod Implement",
    type: "Gear",
    id: "ID_FMP_GEAR_12",
    source: "Player's Handbook",
  ...
  te = Gear["Rowboat"] = new RulesElement({
    name: "Rowboat",
    type: "Gear",
    id: "ID_FMP_GEAR_48",
    source: "Player's Handbook",
  ...
  te = Gear["Sailing Ship"] = new RulesElement({
    name: "Sailing Ship",
    type: "Gear",
    id: "ID_FMP_GEAR_49",
    source: "Player's Handbook",
  ...
  te = Gear["Sanctified Incense (Religion)"] = new RulesElement({
  ...
  te = Gear["Silk Rope (50 ft.)"] = new RulesElement({
  ...
  te = Gear["Sling Bullet"] = new RulesElement({
    name: "Sling Bullet",
    type: "Gear",
    id: "ID_FMP_GEAR_61",
    source: "Player's Handbook",
  ...
  te = Gear["Sling Bullets"] = new RulesElement({
    name: "Sling Bullets",
    type: "Gear",
    id: "ID_FMP_GEAR_16",
    source: "Player's Handbook",
  ...
  te = Gear["Spellbook"] = new RulesElement({
    name: "Spellbook",
    type: "Gear",
    id: "ID_FMP_GEAR_33",
    source: "Player's Handbook",
  ...
  te = Gear["Staff Implement"] = new RulesElement({
  ...
  te = Gear["Sunrod"] = new RulesElement({
    name: "Sunrod",
    type: "Gear",
    id: "ID_FMP_GEAR_7",
    source: "Player's Handbook",
  ...
  te = Gear["Thieves' Tools"] = new RulesElement({
    name: "Thieves' Tools",
    type: "Gear",
    id: "ID_FMP_GEAR_35",
    source: "Player's Handbook",
  ...
  te = Gear["Torch"] = new RulesElement({
    name: "Torch",
    type: "Gear",
    id: "ID_FMP_GEAR_36",
    source: "Player's Handbook",
  ...
  te = Gear["Trail Rations"] = new RulesElement({
    name: "Trail Rations",
    type: "Gear",
    id: "ID_FMP_GEAR_8",
    source: "Player's Handbook",
  ...
  te = Gear["Typical Room (per day)"] = new RulesElement({
  ...
  te = Gear["Wagon"] = new RulesElement({
    name: "Wagon",
    type: "Gear",
    id: "ID_FMP_GEAR_47",
    source: "Player's Handbook",
  ...
  te = Gear["Wand Implement"] = new RulesElement({
    name: "Wand Implement",
    type: "Gear",
    id: "ID_FMP_GEAR_14",
    source: "Player's Handbook",
  ...
  te = Gear["Waterskin"] = new RulesElement({
    name: "Waterskin",
    type: "Gear",
    id: "ID_FMP_GEAR_10",
    source: "Player's Handbook",
