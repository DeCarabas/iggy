(function(global, undefined) {
  ...
  te = Race["Dragonborn"] = new RulesElement({
    name: "Dragonborn",
    type: "Race",
    id: "ID_FMP_RACE_1",
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_GRANTS_DRAGONBORN"]);
  ...
  te = Race["Dwarf"] = new RulesElement({
    name: "Dwarf",
    type: "Race",
    id: "ID_FMP_RACE_2",
    source: "Player's Handbook",
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_GRANTS_DWARF"]);
  ...
  te = Race["Eladrin"] = new RulesElement({
    name: "Eladrin",
    type: "Race",
    id: "ID_FMP_RACE_3",
    source: "Player's Handbook",
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_GRANTS_ELADRIN"]);
      model.statadd("Speed", 6);
  ...
  te = Race["Elf"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_GRANTS_ELF"]);
  ...
  te = Race["Half-Elf"] = new RulesElement({
    name: "Half-Elf",
    type: "Race",
    id: "ID_FMP_RACE_6",
    source: "Player's Handbook",
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_GRANTS_HALF-ELF"]);
      model.statadd("Speed", 6);
  ...
  te = Race["Halfling"] = new RulesElement({
    name: "Halfling",
    type: "Race",
    id: "ID_FMP_RACE_5",
    source: "Player's Handbook",
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_GRANTS_HALFLING"]);
      model.statadd("Speed", 6);
  ...
  te = Race["Human"] = new RulesElement({
    name: "Human",
    type: "Race",
    id: "ID_FMP_RACE_7",
    source: "Player's Handbook",
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_GRANTS_HUMAN"]);
      model.statadd("Speed", 6);
  ...
  te = Race["Tiefling"] = new RulesElement({
    name: "Tiefling",
    type: "Race",
    id: "ID_FMP_RACE_8",
    source: "Player's Handbook",
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_GRANTS_TIEFLING"]);
      model.statadd("Speed", 6);
      model.statadd("Average Height", "5' 6\"-6' 2\"");
