(function(global, undefined) {
  ...
  te = Racial_Trait["Bloodhunt"] = new RulesElement({
    name: "Bloodhunt",
    type: "Racial Trait",
  ...
  te = Racial_Trait["Bold"] = new RulesElement({
    name: "Bold",
    type: "Racial Trait",
  ...
  te = Racial_Trait["Bonus At-Will Power"] = new RulesElement({
  ...
  te = Racial_Trait["Bonus Feat"] = new RulesElement({
    name: "Bonus Feat",
    type: "Racial Trait",
  ...
  te = Racial_Trait["Bonus Skill"] = new RulesElement({
    name: "Bonus Skill",
    type: "Racial Trait",
  ...
  te = Racial_Trait["Cast-Iron Stomach"] = new RulesElement({
  ...
  te = Racial_Trait["Dilettante"] = new RulesElement({
    name: "Dilettante",
    type: "Racial Trait",
  ...
  te = Racial_Trait["Draconic Heritage"] = new RulesElement({
  ...
  te = Racial_Trait["Dragon Breath"] = new RulesElement({
    name: "Dragon Breath",
    type: "Racial Trait",
  ...
  te = Racial_Trait["Dragon Breath Acid"] = new RulesElement({
  ...
  te = Racial_Trait["Dragon Breath Cold"] = new RulesElement({
  ...
  te = Racial_Trait["Dragon Breath Constitution"] = new RulesElement({
  ...
  te = Racial_Trait["Dragon Breath Dexterity"] = new RulesElement({
  ...
  te = Racial_Trait["Dragon Breath Fire"] = new RulesElement({
  ...
  te = Racial_Trait["Dragon Breath Lightning"] = new RulesElement({
  ...
  te = Racial_Trait["Dragon Breath Poison"] = new RulesElement({
  ...
  te = Racial_Trait["Dragon Breath Strength"] = new RulesElement({
  ...
  te = Racial_Trait["Dragonborn Fury"] = new RulesElement({
  ...
  te = Racial_Trait["Dragonborn Racial Power"] = new RulesElement({
  ...
  te = Racial_Trait["Dual Heritage"] = new RulesElement({
    name: "Dual Heritage",
    type: "Racial Trait",
  ...
  te = Racial_Trait["Dwarven Resilience"] = new RulesElement({
  ...
  te = Racial_Trait["Dwarven Weapon Proficiency"] = new RulesElement({
  ...
  te = Racial_Trait["Eladrin Education"] = new RulesElement({
  ...
  te = Racial_Trait["Eladrin Weapon Proficiency"] = new RulesElement({
  ...
  te = Racial_Trait["Eladrin Will"] = new RulesElement({
    name: "Eladrin Will",
    type: "Racial Trait",
  ...
  te = Racial_Trait["Elven Accuracy"] = new RulesElement({
    name: "Elven Accuracy",
    type: "Racial Trait",
  ...
  te = Racial_Trait["Elven Weapon Proficiency"] = new RulesElement({
  ...
  te = Racial_Trait["Encumbered Speed"] = new RulesElement({
  ...
  te = Racial_Trait["Fey Origin"] = new RulesElement({
    name: "Fey Origin",
    type: "Racial Trait",
  ...
  te = Racial_Trait["Fey Step"] = new RulesElement({
    name: "Fey Step",
    type: "Racial Trait",
  ...
  te = Racial_Trait["Fire Resistance"] = new RulesElement({
  ...
  te = Racial_Trait["Group Awareness"] = new RulesElement({
  ...
  te = Racial_Trait["Group Diplomacy"] = new RulesElement({
  ...
  te = Racial_Trait["Human Defense Bonuses"] = new RulesElement({
  ...
  te = Racial_Trait["Infernal Wrath"] = new RulesElement({
    name: "Infernal Wrath",
    type: "Racial Trait",
  ...
  te = Racial_Trait["Nimble Reaction"] = new RulesElement({
  ...
  te = Racial_Trait["Second Chance"] = new RulesElement({
    name: "Second Chance",
    type: "Racial Trait",
  ...
  te = Racial_Trait["Stand Your Ground"] = new RulesElement({
  ...
  te = Racial_Trait["Trance"] = new RulesElement({
    name: "Trance",
    type: "Racial Trait",
  ...
  te = Racial_Trait["Wild Step"] = new RulesElement({
    name: "Wild Step",
    type: "Racial Trait",
