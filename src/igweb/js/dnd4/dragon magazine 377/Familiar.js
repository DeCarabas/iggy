define(['engine', 'dnd4model'], function(engine, dnd4model) {
  ...
  te = Familiar["Ambush Vine Shoot"] = new engine.RulesElement({
  ...
  te = Familiar["Bantam Fastieth"] = new engine.RulesElement({
  ...
  te = Familiar["Bloodthorn Vine Barb"] = new engine.RulesElement({
  ...
  te = Familiar["Clockwork Scorpion"] = new engine.RulesElement({
  ...
  te = Familiar["Crawling Clot"] = new engine.RulesElement({
    name: "Crawling Clot",
    type: "Familiar",
  ...
  te = Familiar["Dimensional Pet"] = new engine.RulesElement({
  ...
  te = Familiar["Dragonmark Reflection"] = new engine.RulesElement({
  ...
  te = Familiar["Floating Weapon"] = new engine.RulesElement({
  ...
  te = Familiar["Gadfly"] = new engine.RulesElement({
    name: "Gadfly",
    type: "Familiar",
  ...
  te = Familiar["Lingering Nightmare"] = new engine.RulesElement({
  ...
  te = Familiar["Living Infusion"] = new engine.RulesElement({
  ...
  te = Familiar["Magpie"] = new engine.RulesElement({
    name: "Magpie",
    type: "Familiar",
  ...
  te = Familiar["Marmoset"] = new engine.RulesElement({
    name: "Marmoset",
    type: "Familiar",
  ...
  te = Familiar["Minor Foulspawn"] = new engine.RulesElement({
  ...
  te = Familiar["Octopus"] = new engine.RulesElement({
    name: "Octopus",
    type: "Familiar",
  ...
  te = Familiar["Saddle Squire"] = new engine.RulesElement({
    name: "Saddle Squire",
    type: "Familiar",
  ...
  te = Familiar["Silver Lamp"] = new engine.RulesElement({
    name: "Silver Lamp",
    type: "Familiar",
  ...
  te = Familiar["Smith's Hammer"] = new engine.RulesElement({
    name: "Smith's Hammer",
    type: "Familiar",
  ...
  te = Familiar["Soarwood Wings"] = new engine.RulesElement({
    name: "Soarwood Wings",
    type: "Familiar",
  ...
  te = Familiar["Summoner Homunculus"] = new engine.RulesElement({
  ...
  te = Familiar["Tinker Feyling"] = new engine.RulesElement({
    name: "Tinker Feyling",
    type: "Familiar",
  ...
  te = Familiar["Tome Caddy"] = new engine.RulesElement({
    name: "Tome Caddy",
    type: "Familiar",
  ...
  te = Familiar["Warforged Faceplate"] = new engine.RulesElement({
