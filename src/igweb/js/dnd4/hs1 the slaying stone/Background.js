(function(global, undefined) {
  ...
  te = Background["Citizen of Kiris Dahn"] = new RulesElement({
  ...
  te = Background["Defender of the Oppressed"] = new RulesElement({
  ...
  te = Background["Goblin Foe"] = new RulesElement({
    name: "Goblin Foe",
    type: "Background",
  ...
  te = Background["Redeemer of the Desecrated"] = new RulesElement({
  ...
  te = Background["Treasure Hunter"] = new RulesElement({
