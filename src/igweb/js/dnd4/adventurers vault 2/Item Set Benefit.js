define(['engine', 'dnd4model'], function(engine, dnd4model) {
  ...
  te = Item_Set_Benefit["Aleheart Companions' Gear (2)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Aleheart Companions' Gear (4)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Armory of the Unvanquished (2)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Armory of the Unvanquished (4)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Arms of Unbreakable Honor (2)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Arms of Unbreakable Honor (5)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Arms of War (2)"] = new engine.RulesElement({
    name: "Arms of War (2)",
    type: "Item Set Benefit",
  ...
  te = Item_Set_Benefit["Arms of War (4)"] = new engine.RulesElement({
    name: "Arms of War (4)",
    type: "Item Set Benefit",
    ...
    rules: function(model) {
      model.grant(model.elements.id["ID_FMP_POWER_9272"]);
    }
  });
  byID[te.id] = te;
  
  te = Item_Set_Benefit["Aspect of the Ram (2)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Aspect of the Ram (4)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Ayrkashna Armor (2)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Ayrkashna Armor (5)"] = new engine.RulesElement({
    ...
    rules: function(model) {
      model.grant(model.elements.id["ID_FMP_POWER_9274"]);
    }
  });
  byID[te.id] = te;
  
  te = Item_Set_Benefit["Blade Dancer's Regalia (2)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Blade Dancer's Regalia (5)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Caelynnvala's Boons (3)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Caelynnvala's Boons (5)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Champion's Flame (2)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Champion's Flame (5)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Eldritch Panoply (2)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Eldritch Panoply (4)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Eldritch Panoply (6)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Fortune Stones (2)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Fortune Stones (5)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Gadgeteer's Garb (2)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Gadgeteer's Garb (4)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Gifts for the Queen (2)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Gifts for the Queen (5)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Golden Lion's Battle Regalia (3)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Golden Lion's Battle Regalia (5)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Heirlooms of Mazgorax (2)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Heirlooms of Mazgorax (4)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Kamestiri Uniform (2)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Kamestiri Uniform (3)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Kamestiri Uniform (5)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Marjam's Dream (2)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Marjam's Dream (5)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Mirror of Nessecar (2)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Mirror of Nessecar (4)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Offerings of Celestian (2)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Offerings of Celestian (4)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Panoply of the Shepherds of Ghest (2)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Panoply of the Shepherds of Ghest (4)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Points of the Constellation (2)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Points of the Constellation (5)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Radiant Temple Treasures (2)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Radiant Temple Treasures (4)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Raiment of Shadows (2)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Raiment of Shadows (5)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Raiment of the World Spirit (2)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Raiment of the World Spirit (4)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Reaper's Array (2)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Reaper's Array (5)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Regalia of the Golden General (2)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Regalia of the Golden General (5)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Relics of Creation (2)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Relics of Creation (4)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Relics of Creation (6)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Relics of the Forgotten One (2)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Relics of the Forgotten One (5)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Resplendent Finery (2)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Resplendent Finery (4)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Rings of the Akarot (2)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Rings of the Akarot (5)"] = new engine.RulesElement({
    ...
    rules: function(model) {
      model.grant(model.elements.id["ID_FMP_POWER_9276"]);
    }
  });
  byID[te.id] = te;
  
  te = Item_Set_Benefit["Rings of the Akarot (6)"] = new engine.RulesElement({
    ...
    rules: function(model) {
      model.grant(model.elements.id["ID_FMP_POWER_9277"]);
    }
  });
  byID[te.id] = te;
  
  te = Item_Set_Benefit["Shadowdancer's Garb (2)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Shadowdancer's Garb (4)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Skin of the Panther (2)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Skin of the Panther (5)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Time Wizard's Tools (2)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Time Wizard's Tools (4)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Tinkerer's Inventions (2)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Tinkerer's Inventions (4)"] = new engine.RulesElement({
    ...
    rules: function(model) {
      model.grant(model.elements.id["ID_FMP_POWER_9275"]);
    }
  });
  byID[te.id] = te;
  
  te = Item_Set_Benefit["Tools of Zane's Vengeance (2)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Tools of Zane's Vengeance (4)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Zy Tormtor's Trinkets (2)"] = new engine.RulesElement({
  ...
  te = Item_Set_Benefit["Zy Tormtor's Trinkets (4)"] = new engine.RulesElement({
    ...
    rules: function(model) {
      model.grant(model.elements.id["ID_FMP_POWER_9273"]);
    }
  });
  byID[te.id] = te;
