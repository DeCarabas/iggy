define(['engine', 'dnd4model'], function(engine, dnd4model) {
  ...
  te = Racial_Trait["Aspect of the Ancients"] = new engine.RulesElement({
  ...
  te = Racial_Trait["Aspect of the Destroyer"] = new engine.RulesElement({
  ...
  te = Racial_Trait["Aspect of the Hunter"] = new engine.RulesElement({
  ...
  te = Racial_Trait["Crystalline Mind"] = new engine.RulesElement({
  ...
  te = Racial_Trait["Danger Sense"] = new engine.RulesElement({
    name: "Danger Sense",
    type: "Racial Trait",
  ...
  te = Racial_Trait["Defended Mind"] = new engine.RulesElement({
    name: "Defended Mind",
    type: "Racial Trait",
  ...
  te = Racial_Trait["Ferocity"] = new engine.RulesElement({
    name: "Ferocity",
    type: "Racial Trait",
  ...
  te = Racial_Trait["Goring Charge"] = new engine.RulesElement({
    name: "Goring Charge",
    type: "Racial Trait",
  ...
  te = Racial_Trait["Hardy Form"] = new engine.RulesElement({
    name: "Hardy Form",
    type: "Racial Trait",
  ...
  te = Racial_Trait["Hardy Form Fortitude"] = new engine.RulesElement({
  ...
  te = Racial_Trait["Hardy Form Reflex"] = new engine.RulesElement({
  ...
  te = Racial_Trait["Hardy Form Will"] = new engine.RulesElement({
  ...
  te = Racial_Trait["Heedless Charge"] = new engine.RulesElement({
  ...
  te = Racial_Trait["Iron Mind"] = new engine.RulesElement({
    name: "Iron Mind",
    type: "Racial Trait",
  ...
  te = Racial_Trait["Nature's Aspect"] = new engine.RulesElement({
    ...
    rules: function(model) {
      model.grant(model.elements.id["ID_FMP_RACIAL_TRAIT_1540"]);
      model.grant(model.elements.id["ID_FMP_RACIAL_TRAIT_1541"]);
      model.grant(model.elements.id["ID_FMP_RACIAL_TRAIT_1542"]);
    }
  });
  byID[te.id] = te;
  
  te = Racial_Trait["Shard Swarm"] = new engine.RulesElement({
    name: "Shard Swarm",
    type: "Racial Trait",
  ...
  te = Racial_Trait["Shifting Fortunes"] = new engine.RulesElement({
  ...
  te = Racial_Trait["Telepathy"] = new engine.RulesElement({
    name: "Telepathy",
    type: "Racial Trait",
  ...
  te = Racial_Trait["Vitality"] = new engine.RulesElement({
    name: "Vitality",
    type: "Racial Trait",
