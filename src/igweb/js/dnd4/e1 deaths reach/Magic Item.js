define(['engine', 'dnd4model'], function(engine, dnd4model) {
  ...
  te = Magic_Item["Bloodcrystal Raven Skull (epic tier)"] = new engine.RulesElement({
  ...
  te = Magic_Item["Dawn Warrior Armor +4"] = new engine.RulesElement({
  ...
  te = Magic_Item["Dawn Warrior Armor +5"] = new engine.RulesElement({
  ...
  te = Magic_Item["Dawn Warrior Armor +6"] = new engine.RulesElement({
  ...
  te = Magic_Item["Dawn Warrior Weapon +4"] = new engine.RulesElement({
  ...
  te = Magic_Item["Dawn Warrior Weapon +5"] = new engine.RulesElement({
  ...
  te = Magic_Item["Dawn Warrior Weapon +6"] = new engine.RulesElement({
  ...
  te = Magic_Item["Deathburst Armor +2"] = new engine.RulesElement({
  ...
  te = Magic_Item["Deathburst Armor +3"] = new engine.RulesElement({
  ...
  te = Magic_Item["Deathburst Armor +4"] = new engine.RulesElement({
  ...
  te = Magic_Item["Deathburst Armor +5"] = new engine.RulesElement({
  ...
  te = Magic_Item["Deathburst Armor +6"] = new engine.RulesElement({
  ...
  te = Magic_Item["Eye of the Old Gods"] = new engine.RulesElement({
  ...
  te = Magic_Item["Moonstone Sphere (epic tier)"] = new engine.RulesElement({
