(function(global, undefined) {
  ...
  te = Feat["Accursed Challenge"] = new RulesElement({
  ...
  te = Feat["Armored Warrenguard"] = new RulesElement({
  ...
  te = Feat["Avandra's Boon"] = new RulesElement({
    name: "Avandra's Boon",
    type: "Feat",
    id: "ID_FMP_FEAT_2750",
    source: "Dragon Magazine 384",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=2750",
    categories: ["Avandra's Boon", "ID_FMP_FEAT_2750"]
  });
  byID[te.id] = te;
  
  te = Feat["Avandra's Covenant"] = new RulesElement({
    name: "Avandra's Covenant",
    type: "Feat",
    id: "ID_FMP_FEAT_2751",
    source: "Dragon Magazine 384",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=2751",
    categories: ["Avandra's Covenant", "ID_FMP_FEAT_2751"]
  });
  byID[te.id] = te;
  
  te = Feat["Beast Rider"] = new RulesElement({
    name: "Beast Rider",
    type: "Feat",
    id: "ID_FMP_FEAT_2726",
    source: "Dragon Magazine 384",
  ...
  te = Feat["Bestial Mobility"] = new RulesElement({
    name: "Bestial Mobility",
    type: "Feat",
    id: "ID_FMP_FEAT_2725",
    source: "Dragon Magazine 384",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=2725",
    categories: ["Bestial Mobility", "ID_FMP_FEAT_2725"]
  });
  byID[te.id] = te;
  
  te = Feat["Bloodied Boon"] = new RulesElement({
    name: "Bloodied Boon",
    type: "Feat",
    id: "ID_FMP_FEAT_2759",
    source: "Dragon Magazine 384",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=2759",
    categories: ["Bloodied Boon", "ID_FMP_FEAT_2759"]
  });
  byID[te.id] = te;
  
  te = Feat["Bountiful Fortune"] = new RulesElement({
    name: "Bountiful Fortune",
    type: "Feat",
    id: "ID_FMP_FEAT_2752",
    source: "Dragon Magazine 384",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=2752",
    categories: ["Bountiful Fortune", "ID_FMP_FEAT_2752"]
  });
  byID[te.id] = te;
  
  te = Feat["Brutal Curse"] = new RulesElement({
    name: "Brutal Curse",
    type: "Feat",
    id: "ID_FMP_FEAT_2760",
    source: "Dragon Magazine 384",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=2760",
    categories: ["Brutal Curse", "ID_FMP_FEAT_2760"]
  });
  byID[te.id] = te;
  
  te = Feat["Brutal Reach"] = new RulesElement({
    name: "Brutal Reach",
    type: "Feat",
    id: "ID_FMP_FEAT_2705",
    source: "Dragon Magazine 384",
  ...
  te = Feat["Chilling Presence"] = new RulesElement({
    name: "Chilling Presence",
    type: "Feat",
    id: "ID_FMP_FEAT_2699",
    source: "Dragon Magazine 384",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=2699",
    categories: ["Chilling Presence", "ID_FMP_FEAT_2699"]
  });
  byID[te.id] = te;
  
  te = Feat["Confounding Luck"] = new RulesElement({
    name: "Confounding Luck",
    type: "Feat",
    id: "ID_FMP_FEAT_2753",
    source: "Dragon Magazine 384",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=2753",
    categories: ["Confounding Luck", "ID_FMP_FEAT_2753"]
  });
  byID[te.id] = te;
  
  te = Feat["Contagious Curse"] = new RulesElement({
    name: "Contagious Curse",
    type: "Feat",
    id: "ID_FMP_FEAT_2777",
    source: "Dragon Magazine 384",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=2777",
    categories: ["Contagious Curse", "ID_FMP_FEAT_2777"]
  });
  byID[te.id] = te;
  
  te = Feat["Critical Curse"] = new RulesElement({
    name: "Critical Curse",
    type: "Feat",
    id: "ID_FMP_FEAT_2776",
    source: "Dragon Magazine 384",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=2776",
    categories: ["Critical Curse", "ID_FMP_FEAT_2776"]
  });
  byID[te.id] = te;
  
  te = Feat["Curse of Displacement"] = new RulesElement({
    name: "Curse of Displacement",
    type: "Feat",
    id: "ID_FMP_FEAT_2761",
    source: "Dragon Magazine 384",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=2761",
    categories: ["Curse of Displacement", "ID_FMP_FEAT_2761"]
  });
  byID[te.id] = te;
  
  te = Feat["Curse of the Blind Stars"] = new RulesElement({
    name: "Curse of the Blind Stars",
    type: "Feat",
    id: "ID_FMP_FEAT_2768",
    source: "Dragon Magazine 384",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=2768",
    categories: ["Curse of the Blind Stars", "ID_FMP_FEAT_2768"]
  });
  byID[te.id] = te;
  
  te = Feat["Cursed Shot"] = new RulesElement({
    name: "Cursed Shot",
    type: "Feat",
    id: "ID_FMP_FEAT_2762",
    source: "Dragon Magazine 384",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=2762",
    categories: ["Cursed Shot", "ID_FMP_FEAT_2762"]
  });
  byID[te.id] = te;
  
  te = Feat["Cursed Spells"] = new RulesElement({
    name: "Cursed Spells",
    type: "Feat",
    id: "ID_FMP_FEAT_2778",
    source: "Dragon Magazine 384",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=2778",
  ...
  te = Feat["Distracting Challenge"] = new RulesElement({
  ...
  te = Feat["Enshrouding Touch"] = new RulesElement({
  ...
  te = Feat["Exultant Shadow Step"] = new RulesElement({
    name: "Exultant Shadow Step",
    type: "Feat",
    id: "ID_FMP_FEAT_2763",
    source: "Dragon Magazine 384",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=2763",
    categories: ["Exultant Shadow Step", "ID_FMP_FEAT_2763"]
  });
  byID[te.id] = te;
  
  te = Feat["Fey Revel Glamor"] = new RulesElement({
    name: "Fey Revel Glamor",
    type: "Feat",
    id: "ID_FMP_FEAT_2770",
    source: "Dragon Magazine 384",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=2770",
    categories: ["Fey Revel Glamor", "ID_FMP_FEAT_2770"]
  });
  byID[te.id] = te;
  
  te = Feat["Fey Senses"] = new RulesElement({
    name: "Fey Senses",
    type: "Feat",
    id: "ID_FMP_FEAT_2727",
    source: "Dragon Magazine 384",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=2727",
  ...
  te = Feat["Fey-Minded"] = new RulesElement({
    name: "Fey-Minded",
    type: "Feat",
    id: "ID_FMP_FEAT_2728",
    source: "Dragon Magazine 384",
  ...
  te = Feat["Forest Walk"] = new RulesElement({
    name: "Forest Walk",
    type: "Feat",
    id: "ID_FMP_FEAT_2719",
    source: "Dragon Magazine 384",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=2719",
    categories: ["Forest Walk", "ID_FMP_FEAT_2719"]
  });
  byID[te.id] = te;
  
  te = Feat["Godsworn Alacrity"] = new RulesElement({
    name: "Godsworn Alacrity",
    type: "Feat",
    id: "ID_FMP_FEAT_2739",
    source: "Dragon Magazine 384",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=2739",
  ...
  te = Feat["Godsworn Assault"] = new RulesElement({
  ...
  te = Feat["Godsworn Avalanche"] = new RulesElement({
  ...
  te = Feat["Godsworn Bulwark"] = new RulesElement({
  ...
  te = Feat["Godsworn Defender"] = new RulesElement({
    name: "Godsworn Defender",
    type: "Feat",
    id: "ID_FMP_FEAT_2742",
    source: "Dragon Magazine 384",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=2742",
  ...
  te = Feat["Godsworn Fatalist"] = new RulesElement({
    name: "Godsworn Fatalist",
    type: "Feat",
    id: "ID_FMP_FEAT_2743",
    source: "Dragon Magazine 384",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=2743",
  ...
  te = Feat["Godsworn Mentalist"] = new RulesElement({
    name: "Godsworn Mentalist",
    type: "Feat",
    id: "ID_FMP_FEAT_2745",
    source: "Dragon Magazine 384",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=2745",
  ...
  te = Feat["Godsworn Mystic"] = new RulesElement({
    name: "Godsworn Mystic",
    type: "Feat",
    id: "ID_FMP_FEAT_2744",
    source: "Dragon Magazine 384",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=2744",
  ...
  te = Feat["Godsworn Radiant"] = new RulesElement({
    name: "Godsworn Radiant",
    type: "Feat",
    id: "ID_FMP_FEAT_2746",
    source: "Dragon Magazine 384",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=2746",
  ...
  te = Feat["Godsworn Sidestep"] = new RulesElement({
    name: "Godsworn Sidestep",
    type: "Feat",
    id: "ID_FMP_FEAT_2747",
    source: "Dragon Magazine 384",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=2747",
  ...
  te = Feat["Godsworn Tidedancer"] = new RulesElement({
    name: "Godsworn Tidedancer",
    type: "Feat",
    id: "ID_FMP_FEAT_2748",
    source: "Dragon Magazine 384",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=2748",
  ...
  te = Feat["Guileful Shift"] = new RulesElement({
    name: "Guileful Shift",
    type: "Feat",
    id: "ID_FMP_FEAT_2754",
    source: "Dragon Magazine 384",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=2754",
    categories: ["Guileful Shift", "ID_FMP_FEAT_2754"]
  });
  byID[te.id] = te;
  
  te = Feat["Halfling's Strength"] = new RulesElement({
    name: "Halfling's Strength",
    type: "Feat",
    id: "ID_FMP_FEAT_2756",
    source: "Dragon Magazine 384",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=2756",
  ...
  te = Feat["Hellfire Hex"] = new RulesElement({
    name: "Hellfire Hex",
    type: "Feat",
    id: "ID_FMP_FEAT_2772",
    source: "Dragon Magazine 384",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=2772",
  ...
  te = Feat["Hell's Chosen"] = new RulesElement({
    name: "Hell's Chosen",
    type: "Feat",
    id: "ID_FMP_FEAT_2771",
    source: "Dragon Magazine 384",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=2771",
    categories: ["Hell's Chosen", "ID_FMP_FEAT_2771"]
  });
  byID[te.id] = te;
  
  te = Feat["Ice Walk"] = new RulesElement({
    name: "Ice Walk",
    type: "Feat",
    id: "ID_FMP_FEAT_2700",
    source: "Dragon Magazine 384",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=2700",
    categories: ["Ice Walk", "ID_FMP_FEAT_2700"]
  });
  byID[te.id] = te;
  
  te = Feat["Inevitable Doom"] = new RulesElement({
  ...
  te = Feat["Killing Curse"] = new RulesElement({
    name: "Killing Curse",
    type: "Feat",
    id: "ID_FMP_FEAT_2764",
    source: "Dragon Magazine 384",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=2764",
  ...
  te = Feat["Lucky Retribution"] = new RulesElement({
    name: "Lucky Retribution",
    type: "Feat",
    id: "ID_FMP_FEAT_2757",
    source: "Dragon Magazine 384",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=2757",
    categories: ["Lucky Retribution", "ID_FMP_FEAT_2757"]
  });
  byID[te.id] = te;
  
  te = Feat["Mind-Numbing Curse"] = new RulesElement({
  ...
  te = Feat["Primed Curse"] = new RulesElement({
    name: "Primed Curse",
    type: "Feat",
    id: "ID_FMP_FEAT_2765",
    source: "Dragon Magazine 384",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=2765",
  ...
  te = Feat["Prolonged Curse"] = new RulesElement({
    name: "Prolonged Curse",
    type: "Feat",
    id: "ID_FMP_FEAT_2766",
    source: "Dragon Magazine 384",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=2766",
    categories: ["Prolonged Curse", "ID_FMP_FEAT_2766"]
  });
  byID[te.id] = te;
  
  te = Feat["Protective Hex"] = new RulesElement({
    name: "Protective Hex",
    type: "Feat",
    id: "ID_FMP_FEAT_2773",
    source: "Dragon Magazine 384",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=2773",
    categories: ["Protective Hex", "ID_FMP_FEAT_2773"]
  });
  byID[te.id] = te;
  
  te = Feat["Raging Reach"] = new RulesElement({
    name: "Raging Reach",
    type: "Feat",
    id: "ID_FMP_FEAT_2706",
    source: "Dragon Magazine 384",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=2706",
  ...
  te = Feat["Ruthless Rampage"] = new RulesElement({
  ...
  te = Feat["Shadow of the Wild"] = new RulesElement({
    name: "Shadow of the Wild",
    type: "Feat",
    id: "ID_FMP_FEAT_2717",
    source: "Dragon Magazine 384",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=2717",
    categories: ["Shadow of the Wild", "ID_FMP_FEAT_2717"]
  });
  byID[te.id] = te;
  
  te = Feat["Sibling to the Stars"] = new RulesElement({
    name: "Sibling to the Stars",
    type: "Feat",
    id: "ID_FMP_FEAT_2774",
    source: "Dragon Magazine 384",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=2774",
    categories: ["Sibling to the Stars", "ID_FMP_FEAT_2774"]
  });
  byID[te.id] = te;
  
  te = Feat["Swirling Snow"] = new RulesElement({
    name: "Swirling Snow",
    type: "Feat",
    id: "ID_FMP_FEAT_2701",
    source: "Dragon Magazine 384",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=2701",
    categories: ["Swirling Snow", "ID_FMP_FEAT_2701"]
  });
  byID[te.id] = te;
  
  te = Feat["Veil of Waking Dreams"] = new RulesElement({
    name: "Veil of Waking Dreams",
    type: "Feat",
    id: "ID_FMP_FEAT_2775",
    source: "Dragon Magazine 384",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=2775",
    categories: ["Veil of Waking Dreams", "ID_FMP_FEAT_2775"]
  });
  byID[te.id] = te;
  
  te = Feat["Vengeance's Reward"] = new RulesElement({
    name: "Vengeance's Reward",
    type: "Feat",
    id: "ID_FMP_FEAT_2758",
    source: "Dragon Magazine 384",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=2758",
    categories: ["Vengeance's Reward", "ID_FMP_FEAT_2758"]
  });
  byID[te.id] = te;
  
  te = Feat["Warlock's Sight"] = new RulesElement({
    name: "Warlock's Sight",
    type: "Feat",
    id: "ID_FMP_FEAT_2767",
    source: "Dragon Magazine 384",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=2767",
    categories: ["Warlock's Sight", "ID_FMP_FEAT_2767"]
  });
  byID[te.id] = te;
  
  te = Feat["Wilderness Wariness"] = new RulesElement({
  ...
  te = Feat["Winterkin Heritage"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_11559"]);
      ...
      model.grant(elements.id["ID_INTERNAL_INTERNAL_ELADRIN_BLOODLINE"]);
    }
  });
  byID[te.id] = te;
  
  te = Feat["Winter's Heart"] = new RulesElement({
    name: "Winter's Heart",
    type: "Feat",
    id: "ID_FMP_FEAT_2704",
    source: "Dragon Magazine 384",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=2704",
    categories: ["Winter's Heart", "ID_FMP_FEAT_2704"]
  });
  byID[te.id] = te;
  
  te = Feat["Winter's Reach"] = new RulesElement({
    name: "Winter's Reach",
    type: "Feat",
    id: "ID_FMP_FEAT_2703",
    source: "Dragon Magazine 384",
