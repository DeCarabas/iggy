(function(global, undefined) {
  ...
  te = Racial_Trait["Bastion of Mental Clarity"] = new RulesElement({
  ...
  te = Racial_Trait["Change Shape"] = new RulesElement({
    name: "Change Shape",
    type: "Racial Trait",
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_2472"]);
    }
  });
  byID[te.id] = te;
  
  te = Racial_Trait["Changeling Trick"] = new RulesElement({
  ...
  te = Racial_Trait["Dual Soul"] = new RulesElement({
    name: "Dual Soul",
    type: "Racial Trait",
  ...
  te = Racial_Trait["Living Construct"] = new RulesElement({
  ...
  te = Racial_Trait["Mental Defense"] = new RulesElement({
    name: "Mental Defense",
    type: "Racial Trait",
  ...
  te = Racial_Trait["Shapechanger"] = new RulesElement({
    name: "Shapechanger",
    type: "Racial Trait",
  ...
  te = Racial_Trait["Telepathy 5"] = new RulesElement({
    name: "Telepathy 5",
    type: "Racial Trait",
  ...
  te = Racial_Trait["Unsleeping Watcher"] = new RulesElement({
  ...
  te = Racial_Trait["Warforged Mind"] = new RulesElement({
    name: "Warforged Mind",
    type: "Racial Trait",
  ...
  te = Racial_Trait["Warforged Resilience"] = new RulesElement({
  ...
  te = Racial_Trait["Warforged Resolve"] = new RulesElement({
