(function(global, undefined) {
  ...
  te = Deity["Arawai"] = new RulesElement({
    name: "Arawai",
    type: "Deity",
    id: "ID_FMP_DEITY_107",
  ...
  te = Deity["Aureon"] = new RulesElement({
    name: "Aureon",
    type: "Deity",
    id: "ID_FMP_DEITY_108",
    source: "Eberron Player's Guide",
  ...
  te = Deity["Balinor"] = new RulesElement({
    name: "Balinor",
    type: "Deity",
    id: "ID_FMP_DEITY_109",
    source: "Eberron Player's Guide",
  ...
  te = Deity["Boldrei"] = new RulesElement({
    name: "Boldrei",
    type: "Deity",
    id: "ID_FMP_DEITY_110",
    source: "Eberron Player's Guide",
  ...
  te = Deity["Cults of the Dragon Below"] = new RulesElement({
  ...
  te = Deity["Dol Arrah"] = new RulesElement({
    name: "Dol Arrah",
    type: "Deity",
    id: "ID_FMP_DEITY_111",
    source: "Eberron Player's Guide",
  ...
  te = Deity["Dol Dorn"] = new RulesElement({
    name: "Dol Dorn",
    type: "Deity",
    id: "ID_FMP_DEITY_112",
    source: "Eberron Player's Guide",
  ...
  te = Deity["Elf Religion"] = new RulesElement({
    name: "Elf Religion",
    type: "Deity",
    id: "ID_FMP_DEITY_132",
    source: "Eberron Player's Guide",
  ...
  te = Deity["Kol Korran"] = new RulesElement({
    name: "Kol Korran",
    type: "Deity",
    id: "ID_FMP_DEITY_113",
    source: "Eberron Player's Guide",
  ...
  te = Deity["Olladra"] = new RulesElement({
    name: "Olladra",
    type: "Deity",
    id: "ID_FMP_DEITY_114",
    source: "Eberron Player's Guide",
  ...
  te = Deity["Onatar"] = new RulesElement({
    name: "Onatar",
    type: "Deity",
    id: "ID_FMP_DEITY_115",
    source: "Eberron Player's Guide",
  ...
  te = Deity["The Blood of Vol"] = new RulesElement({
  ...
  te = Deity["The Dark Six"] = new RulesElement({
    name: "The Dark Six",
    type: "Deity",
    id: "ID_FMP_DEITY_124",
    source: "Eberron Player's Guide",
  ...
  te = Deity["The Devourer"] = new RulesElement({
    name: "The Devourer",
    type: "Deity",
    id: "ID_FMP_DEITY_118",
    source: "Eberron Player's Guide",
  ...
  te = Deity["The Fury"] = new RulesElement({
    name: "The Fury",
    type: "Deity",
    id: "ID_FMP_DEITY_119",
    source: "Eberron Player's Guide",
  ...
  te = Deity["The Keeper"] = new RulesElement({
    name: "The Keeper",
    type: "Deity",
    id: "ID_FMP_DEITY_120",
    source: "Eberron Player's Guide",
  ...
  te = Deity["The Mockery"] = new RulesElement({
    name: "The Mockery",
    type: "Deity",
    id: "ID_FMP_DEITY_121",
    source: "Eberron Player's Guide",
  ...
  te = Deity["The Path of Light"] = new RulesElement({
  ...
  te = Deity["The Shadow"] = new RulesElement({
    name: "The Shadow",
    type: "Deity",
    id: "ID_FMP_DEITY_122",
    source: "Eberron Player's Guide",
  ...
  te = Deity["The Silver Flame"] = new RulesElement({
  ...
  te = Deity["The Sovereign Host"] = new RulesElement({
  ...
  te = Deity["The Spirits of the Past"] = new RulesElement({
  ...
  te = Deity["The Traveler"] = new RulesElement({
    name: "The Traveler",
    type: "Deity",
    id: "ID_FMP_DEITY_116",
    source: "Eberron Player's Guide",
  ...
  te = Deity["The Undying Court"] = new RulesElement({
