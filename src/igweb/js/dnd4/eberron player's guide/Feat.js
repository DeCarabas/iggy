(function(global, undefined) {
  ...
  te = Feat["Aberrant Mark of Contagion"] = new RulesElement({
  ...
  te = Feat["Aberrant Mark of Madness"] = new RulesElement({
  ...
  te = Feat["Aberrant Mark of Terror"] = new RulesElement({
  ...
  te = Feat["Accurate Magic Weapon"] = new RulesElement({
  ...
  te = Feat["Aerenal Arcanist"] = new RulesElement({
  ...
  te = Feat["Aerenal Half-Life"] = new RulesElement({
  ...
  te = Feat["Alchemist"] = new RulesElement({
    name: "Alchemist",
    type: "Feat",
    id: "ID_FMP_FEAT_652",
    source: "Eberron Player's Guide",
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_INTERNAL_ALCHEMICAL_ITEMS"]);
    }
  });
  byID[te.id] = te;
  
  te = Feat["Ancestral Guidance"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_7621"]);
    }
  });
  byID[te.id] = te;
  
  te = Feat["Arawai's Abundance"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_7622"]);
    }
  });
  byID[te.id] = te;
  
  te = Feat["Aureon's Instruction"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_7623"]);
    }
  });
  byID[te.id] = te;
  
  te = Feat["Balinor's Prey"] = new RulesElement({
    name: "Balinor's Prey",
    type: "Feat",
    id: "ID_FMP_FEAT_1377",
    source: "Eberron Player's Guide",
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_7624"]);
    }
  });
  byID[te.id] = te;
  
  te = Feat["Beacon of Dol Arrah"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_7625"]);
    }
  });
  byID[te.id] = te;
  
  te = Feat["Boldrei's Shelter"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_7626"]);
    }
  });
  byID[te.id] = te;
  
  te = Feat["Component Modification"] = new RulesElement({
  ...
  te = Feat["Defensive Minions"] = new RulesElement({
  ...
  te = Feat["Eldeen Companion"] = new RulesElement({
  ...
  te = Feat["Enhanced Resistive Formula"] = new RulesElement({
  ...
  te = Feat["Extended Telepathy"] = new RulesElement({
  ...
  te = Feat["Fluid Anatomy"] = new RulesElement({
    name: "Fluid Anatomy",
    type: "Feat",
    id: "ID_FMP_FEAT_1420",
    source: "Eberron Player's Guide",
  ...
  te = Feat["Forceful Defense"] = new RulesElement({
  ...
  te = Feat["Group Mindlink"] = new RulesElement({
    name: "Group Mindlink",
    type: "Feat",
    id: "ID_FMP_FEAT_1383",
    source: "Eberron Player's Guide",
  ...
  te = Feat["Immutability"] = new RulesElement({
    name: "Immutability",
    type: "Feat",
    id: "ID_FMP_FEAT_444",
    source: "Eberron Player's Guide",
  ...
  te = Feat["Improved Immutability"] = new RulesElement({
  ...
  te = Feat["Improved Warforged Resolve"] = new RulesElement({
  ...
  te = Feat["Kol Korran's Boon"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_7627"]);
    }
  });
  byID[te.id] = te;
  
  te = Feat["Light Within"] = new RulesElement({
    name: "Light Within",
    type: "Feat",
    id: "ID_FMP_FEAT_1386",
    source: "Eberron Player's Guide",
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_7628"]);
    }
  });
  byID[te.id] = te;
  
  te = Feat["Mark of Detection"] = new RulesElement({
  ...
  te = Feat["Mark of Finding"] = new RulesElement({
  ...
  te = Feat["Mark of Handling"] = new RulesElement({
  ...
  te = Feat["Mark of Healing"] = new RulesElement({
  ...
  te = Feat["Mark of Hospitality"] = new RulesElement({
  ...
  te = Feat["Mark of Making"] = new RulesElement({
    name: "Mark of Making",
    type: "Feat",
    id: "ID_FMP_FEAT_1392",
    source: "Eberron Player's Guide",
  ...
  te = Feat["Mark of Passage"] = new RulesElement({
  ...
  te = Feat["Mark of Scribing"] = new RulesElement({
  ...
  te = Feat["Mark of Sentinel"] = new RulesElement({
  ...
  te = Feat["Mark of Shadow"] = new RulesElement({
    name: "Mark of Shadow",
    type: "Feat",
    id: "ID_FMP_FEAT_1396",
    source: "Eberron Player's Guide",
  ...
  te = Feat["Mark of Storm"] = new RulesElement({
    name: "Mark of Storm",
    type: "Feat",
    id: "ID_FMP_FEAT_1397",
    source: "Eberron Player's Guide",
  ...
  te = Feat["Mark of Warding"] = new RulesElement({
  ...
  te = Feat["Master Crafter"] = new RulesElement({
    name: "Master Crafter",
    type: "Feat",
    id: "ID_FMP_FEAT_1399",
    source: "Eberron Player's Guide",
  ...
  te = Feat["Master Mixer"] = new RulesElement({
    name: "Master Mixer",
    type: "Feat",
    id: "ID_FMP_FEAT_1400",
    source: "Eberron Player's Guide",
  ...
  te = Feat["Might of Dol Dorn"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_7629"]);
    }
  });
  byID[te.id] = te;
  
  te = Feat["Mror Stalwart"] = new RulesElement({
    name: "Mror Stalwart",
    type: "Feat",
    id: "ID_FMP_FEAT_1402",
    source: "Eberron Player's Guide",
  ...
  te = Feat["Onatar's Gift"] = new RulesElement({
    name: "Onatar's Gift",
    type: "Feat",
    id: "ID_FMP_FEAT_1403",
    source: "Eberron Player's Guide",
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_7630"]);
    }
  });
  byID[te.id] = te;
  
  te = Feat["Potent Restorables"] = new RulesElement({
  ...
  te = Feat["Quori Backlash"] = new RulesElement({
    name: "Quori Backlash",
    type: "Feat",
    id: "ID_FMP_FEAT_1419",
    source: "Eberron Player's Guide",
  ...
  te = Feat["Quori Desperation"] = new RulesElement({
  ...
  te = Feat["Quori Shield"] = new RulesElement({
    name: "Quori Shield",
    type: "Feat",
    id: "ID_FMP_FEAT_1405",
    source: "Eberron Player's Guide",
  ...
  te = Feat["Reinforcing Healing"] = new RulesElement({
  ...
  te = Feat["Shapeshifting Contortionist"] = new RulesElement({
  ...
  te = Feat["Shield of the Silver Flame"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_7631"]);
    }
  });
  byID[te.id] = te;
  
  te = Feat["Shifter's Agility"] = new RulesElement({
  ...
  te = Feat["Sovereign Justice"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_7632"]);
    }
  });
  byID[te.id] = te;
  
  te = Feat["Student of Artifice"] = new RulesElement({
  ...
  te = Feat["Sturdy Shifter"] = new RulesElement({
    name: "Sturdy Shifter",
    type: "Feat",
    id: "ID_FMP_FEAT_1410",
    source: "Eberron Player's Guide",
  ...
  te = Feat["Talenta Weapon Training"] = new RulesElement({
  ...
  te = Feat["Telepathic Sensitivity"] = new RulesElement({
  ...
  te = Feat["Traveler's Gift"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_7633"]);
    }
  });
  byID[te.id] = te;
  
  te = Feat["Undying's Command"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_7634"]);
    }
  });
  byID[te.id] = te;
  
  te = Feat["Warforged Fortification"] = new RulesElement({
  ...
  te = Feat["Warforged Tactics"] = new RulesElement({
  ...
  te = Feat["Xen'drik Weapon Training"] = new RulesElement({
