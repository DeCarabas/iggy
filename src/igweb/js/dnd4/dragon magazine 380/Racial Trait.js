(function(global, undefined) {
  ...
  te = Racial_Trait["causticsoul"] = new RulesElement({
    name: "causticsoul",
    type: "Racial Trait",
  ...
  te = Racial_Trait["cindersoul"] = new RulesElement({
    name: "cindersoul",
    type: "Racial Trait",
  ...
  te = Racial_Trait["plaguesoul"] = new RulesElement({
    name: "plaguesoul",
    type: "Racial Trait",
  ...
  te = Racial_Trait["voidsoul"] = new RulesElement({
    name: "voidsoul",
    type: "Racial Trait",
