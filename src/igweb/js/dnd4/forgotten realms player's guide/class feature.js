(function(global, undefined) {
  ...
  te = class_feature["Aegis Insight"] = new RulesElement({
    name: "Aegis Insight",
    type: "class feature",
  ...
  te = class_feature["Aegis of Assault"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_3322"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Aegis of Shielding"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_3323"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Ambusher Action"] = new RulesElement({
  ...
  te = class_feature["Arcane Fundamentals"] = new RulesElement({
  ...
  te = class_feature["Arcane Healing"] = new RulesElement({
    name: "Arcane Healing",
    type: "class feature",
  ...
  te = class_feature["Binding Sight"] = new RulesElement({
    name: "Binding Sight",
    type: "class feature",
  ...
  te = class_feature["Blade Flurry Action"] = new RulesElement({
  ...
  te = class_feature["Blessings of Kelemvor"] = new RulesElement({
  ...
  te = class_feature["Bold Attacker"] = new RulesElement({
    name: "Bold Attacker",
    type: "class feature",
  ...
  te = class_feature["Burning Radiance"] = new RulesElement({
  ...
  te = class_feature["Control the Flames"] = new RulesElement({
  ...
  te = class_feature["Cormyrean Knight Training"] = new RulesElement({
  ...
  te = class_feature["Dark Pact"] = new RulesElement({
    name: "Dark Pact",
    type: "class feature",
  ...
  te = class_feature["Darkwalker Action"] = new RulesElement({
  ...
  te = class_feature["Deadly Absence"] = new RulesElement({
    name: "Deadly Absence",
    type: "class feature",
  ...
  te = class_feature["Demon's Misfortune"] = new RulesElement({
  ...
  te = class_feature["Demonslayer Blade"] = new RulesElement({
  ...
  te = class_feature["Demonslayer's Wrath"] = new RulesElement({
  ...
  te = class_feature["Determined Mage"] = new RulesElement({
  ...
  te = class_feature["Doomguide's Geas"] = new RulesElement({
  ...
  te = class_feature["Doomguide's Resolve"] = new RulesElement({
  ...
  te = class_feature["Draconic Enemy"] = new RulesElement({
    name: "Draconic Enemy",
    type: "class feature",
  ...
  te = class_feature["Dual Manifestation"] = new RulesElement({
  ...
  te = class_feature["Earthheart Determination"] = new RulesElement({
  ...
  te = class_feature["Elemental Attacks"] = new RulesElement({
  ...
  te = class_feature["Elemental Surge"] = new RulesElement({
  ...
  te = class_feature["Empowered Aegis"] = new RulesElement({
  ...
  te = class_feature["Expert Mariner"] = new RulesElement({
    name: "Expert Mariner",
    type: "class feature",
  ...
  te = class_feature["Extended Aegis"] = new RulesElement({
    name: "Extended Aegis",
    type: "class feature",
  ...
  te = class_feature["Feywild Wake"] = new RulesElement({
    name: "Feywild Wake",
    type: "class feature",
  ...
  te = class_feature["Fiery Surge"] = new RulesElement({
    name: "Fiery Surge",
    type: "class feature",
  ...
  te = class_feature["Firemotes"] = new RulesElement({
    name: "Firemotes",
    type: "class feature",
  ...
  te = class_feature["Firesoul Aura"] = new RulesElement({
    name: "Firesoul Aura",
    type: "class feature",
  ...
  te = class_feature["Flamespeed"] = new RulesElement({
    name: "Flamespeed",
    type: "class feature",
  ...
  te = class_feature["Forest Walk"] = new RulesElement({
    name: "Forest Walk",
    type: "class feature",
  ...
  te = class_feature["Ghostken"] = new RulesElement({
    name: "Ghostken",
    type: "class feature",
  ...
  te = class_feature["Goddess of Changes"] = new RulesElement({
  ...
  te = class_feature["Great Heart"] = new RulesElement({
    name: "Great Heart",
    type: "class feature",
  ...
  te = class_feature["Heart of Earth"] = new RulesElement({
    name: "Heart of Earth",
    type: "class feature",
  ...
  te = class_feature["Improved Silver Shield"] = new RulesElement({
  ...
  te = class_feature["Improved Swordmage Armor"] = new RulesElement({
  ...
  te = class_feature["Instinctive Remorse"] = new RulesElement({
  ...
  te = class_feature["Larger than Life"] = new RulesElement({
  ...
  te = class_feature["Learn from Experience"] = new RulesElement({
  ...
  te = class_feature["Liberator's Resolve"] = new RulesElement({
  ...
  te = class_feature["Mastery of Passage"] = new RulesElement({
  ...
  te = class_feature["Mercurial Action"] = new RulesElement({
  ...
  te = class_feature["Militant Dawn"] = new RulesElement({
    name: "Militant Dawn",
    type: "class feature",
  ...
  te = class_feature["Moon Oracle"] = new RulesElement({
    name: "Moon Oracle",
    type: "class feature",
  ...
  te = class_feature["Moonsparked"] = new RulesElement({
    name: "Moonsparked",
    type: "class feature",
  ...
  te = class_feature["Open Discipline"] = new RulesElement({
  ...
  te = class_feature["People's History"] = new RulesElement({
  ...
  te = class_feature["Plague Familiarity"] = new RulesElement({
  ...
  te = class_feature["Plague Mastery"] = new RulesElement({
    name: "Plague Mastery",
    type: "class feature",
  ...
  te = class_feature["Plagueslayer"] = new RulesElement({
    name: "Plagueslayer",
    type: "class feature",
  ...
  te = class_feature["Purple Dragon Aura"] = new RulesElement({
  ...
  te = class_feature["Purple Dragon Focus"] = new RulesElement({
  ...
  te = class_feature["Sea Legs"] = new RulesElement({
    name: "Sea Legs",
    type: "class feature",
  ...
  te = class_feature["Shadow Action"] = new RulesElement({
    name: "Shadow Action",
    type: "class feature",
  ...
  te = class_feature["Shadow Defense"] = new RulesElement({
    name: "Shadow Defense",
    type: "class feature",
  ...
  te = class_feature["Shadow Shroud"] = new RulesElement({
    name: "Shadow Shroud",
    type: "class feature",
  ...
  te = class_feature["Shadowed Action"] = new RulesElement({
  ...
  te = class_feature["Sight of the Unseen"] = new RulesElement({
  ...
  te = class_feature["Sorcerous Vitality"] = new RulesElement({
  ...
  te = class_feature["Spellfire Action"] = new RulesElement({
  ...
  te = class_feature["Spellfire Mastery"] = new RulesElement({
  ...
  te = class_feature["Spellguard Action"] = new RulesElement({
  ...
  te = class_feature["Spellguard Combat Toughness"] = new RulesElement({
  ...
  te = class_feature["Spellguard Training"] = new RulesElement({
  ...
  te = class_feature["Steelsky Heritage"] = new RulesElement({
  ...
  te = class_feature["Stone Sense"] = new RulesElement({
    name: "Stone Sense",
    type: "class feature",
  ...
  te = class_feature["Sune's Touch"] = new RulesElement({
    name: "Sune's Touch",
    type: "class feature",
  ...
  te = class_feature["Swordbond"] = new RulesElement({
    name: "Swordbond",
    type: "class feature",
  ...
  te = class_feature["Swordmage Aegis"] = new RulesElement({
  ...
  te = class_feature["Swordmage Warding"] = new RulesElement({
  ...
  te = class_feature["Swordshield Action"] = new RulesElement({
  ...
  te = class_feature["Tears of Evergold"] = new RulesElement({
  ...
  te = class_feature["Teleportation Action"] = new RulesElement({
  ...
  te = class_feature["Tempest Lord"] = new RulesElement({
    name: "Tempest Lord",
    type: "class feature",
  ...
  te = class_feature["Twilight Accuracy"] = new RulesElement({
  ...
  te = class_feature["Twilight Vision"] = new RulesElement({
  ...
  te = class_feature["Unflagging Energy"] = new RulesElement({
  ...
  te = class_feature["War Wizard's Decimation"] = new RulesElement({
  ...
  te = class_feature["War Wizard's Training"] = new RulesElement({
  ...
  te = class_feature["Whirlwind Action"] = new RulesElement({
  ...
  te = class_feature["Whirlwind Breeze"] = new RulesElement({
  ...
  te = class_feature["Whirlwind Counterforce"] = new RulesElement({
