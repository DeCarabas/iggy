define(['engine', 'dnd4model'], function(engine, dnd4model) {
  ...
  te = class_feature["Aberrant Bane"] = new engine.RulesElement({
    name: "Aberrant Bane",
    type: "class feature",
  ...
  te = class_feature["Aberrant Disruption"] = new engine.RulesElement({
  ...
  te = class_feature["Accurate Enhancement"] = new engine.RulesElement({
  ...
  te = class_feature["Added Resilience"] = new engine.RulesElement({
  ...
  te = class_feature["Aggressive Action"] = new engine.RulesElement({
  ...
  te = class_feature["Alchemical Action"] = new engine.RulesElement({
  ...
  te = class_feature["Alchemical Innovator"] = new engine.RulesElement({
  ...
  te = class_feature["Alchemy Master"] = new engine.RulesElement({
    name: "Alchemy Master",
    type: "class feature",
  ...
  te = class_feature["Arcane Empowerment"] = new engine.RulesElement({
    ...
    rules: function(model) {
      model.grant(model.elements.id["ID_FMP_CLASS_FEATURE_1574"]);
      model.grant(model.elements.id["ID_FMP_CLASS_FEATURE_1575"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Arcane Rechanneling"] = new engine.RulesElement({
  ...
  te = class_feature["Arcane Rejuvenation"] = new engine.RulesElement({
  ...
  te = class_feature["Argent Vessel"] = new engine.RulesElement({
    name: "Argent Vessel",
    type: "class feature",
  ...
  te = class_feature["Augment Energy"] = new engine.RulesElement({
    name: "Augment Energy",
    type: "class feature",
  ...
  te = class_feature["Battlefist"] = new engine.RulesElement({
    name: "Battlefist",
    type: "class feature",
  ...
  te = class_feature["Blindless Sight"] = new engine.RulesElement({
  ...
  te = class_feature["Bodyguard's Resolve"] = new engine.RulesElement({
  ...
  te = class_feature["Bolstered by Flame"] = new engine.RulesElement({
  ...
  te = class_feature["Brutal Enchantment"] = new engine.RulesElement({
  ...
  te = class_feature["Burden of Leadership"] = new engine.RulesElement({
  ...
  te = class_feature["Careful Trap-Breaker"] = new engine.RulesElement({
  ...
  te = class_feature["Charging Action"] = new engine.RulesElement({
  ...
  te = class_feature["Charging Strike"] = new engine.RulesElement({
  ...
  te = class_feature["Chosen of the Flame"] = new engine.RulesElement({
  ...
  te = class_feature["Clockwork Coordinated Action"] = new engine.RulesElement({
  ...
  te = class_feature["Construct Perfection"] = new engine.RulesElement({
  ...
  te = class_feature["Coordinated Action"] = new engine.RulesElement({
  ...
  te = class_feature["Critical Justice"] = new engine.RulesElement({
  ...
  te = class_feature["Cyran Vengeance"] = new engine.RulesElement({
  ...
  te = class_feature["Deneith Mark"] = new engine.RulesElement({
    name: "Deneith Mark",
    type: "class feature",
  ...
  te = class_feature["Driven by Duty"] = new engine.RulesElement({
    name: "Driven by Duty",
    type: "class feature",
  ...
  te = class_feature["Durable Artifice"] = new engine.RulesElement({
  ...
  te = class_feature["Feather's Touch"] = new engine.RulesElement({
    ...
    rules: function(model) {
      model.grant(model.elements.id["ID_FMP_POWER_1213"]);
      // unsupported rule: cbimporter.Rules.ModifyRule
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Fortifying Action"] = new engine.RulesElement({
  ...
  te = class_feature["Ghallanda's Sanctuary"] = new engine.RulesElement({
  ...
  te = class_feature["Ghorad'din Action"] = new engine.RulesElement({
  ...
  te = class_feature["Griffonmaster Action"] = new engine.RulesElement({
  ...
  te = class_feature["Healing Infusion"] = new engine.RulesElement({
  ...
  te = class_feature["Healing Savant"] = new engine.RulesElement({
    name: "Healing Savant",
    type: "class feature",
  ...
  te = class_feature["Hospitable Surge"] = new engine.RulesElement({
  ...
  te = class_feature["Impart Energy"] = new engine.RulesElement({
    name: "Impart Energy",
    type: "class feature",
  ...
  te = class_feature["Improved Recovery"] = new engine.RulesElement({
  ...
  te = class_feature["Item Affinity"] = new engine.RulesElement({
    name: "Item Affinity",
    type: "class feature",
  ...
  te = class_feature["Jadehand Action"] = new engine.RulesElement({
  ...
  te = class_feature["Lead to Victory"] = new engine.RulesElement({
  ...
  te = class_feature["Lightwalker Action"] = new engine.RulesElement({
  ...
  te = class_feature["Master Burglar"] = new engine.RulesElement({
    name: "Master Burglar",
    type: "class feature",
  ...
  te = class_feature["Mastermaker Action"] = new engine.RulesElement({
  ...
  te = class_feature["Medani Targeting"] = new engine.RulesElement({
  ...
  te = class_feature["Memory of Cyre"] = new engine.RulesElement({
    name: "Memory of Cyre",
    type: "class feature",
  ...
  te = class_feature["Mind Fire"] = new engine.RulesElement({
    name: "Mind Fire",
    type: "class feature",
  ...
  te = class_feature["More Metal Than Flesh"] = new engine.RulesElement({
  ...
  te = class_feature["Mournland Dedicate"] = new engine.RulesElement({
  ...
  te = class_feature["Phantasmist Action"] = new engine.RulesElement({
  ...
  te = class_feature["Phase-Mist Shroud"] = new engine.RulesElement({
  ...
  te = class_feature["Power Focus"] = new engine.RulesElement({
    name: "Power Focus",
    type: "class feature",
  ...
  te = class_feature["Prophetic Blessing"] = new engine.RulesElement({
  ...
  te = class_feature["Prophetic Blessing Charisma"] = new engine.RulesElement({
  ...
  te = class_feature["Prophetic Blessing Constitution"] = new engine.RulesElement({
  ...
  te = class_feature["Prophetic Blessing Dexterity"] = new engine.RulesElement({
  ...
  te = class_feature["Prophetic Blessing Intelligence"] = new engine.RulesElement({
  ...
  te = class_feature["Prophetic Blessing Strength"] = new engine.RulesElement({
  ...
  te = class_feature["Prophetic Blessing Wisdom"] = new engine.RulesElement({
  ...
  te = class_feature["Prophetic Renewal"] = new engine.RulesElement({
  ...
  te = class_feature["Quarry's Arrest"] = new engine.RulesElement({
  ...
  te = class_feature["Radiant Renewal"] = new engine.RulesElement({
  ...
  te = class_feature["Resolute Action"] = new engine.RulesElement({
  ...
  te = class_feature["Resourceful Alchemist"] = new engine.RulesElement({
  ...
  te = class_feature["Sentinel Action"] = new engine.RulesElement({
  ...
  te = class_feature["Shadow Wound"] = new engine.RulesElement({
    name: "Shadow Wound",
    type: "class feature",
  ...
  te = class_feature["Shadow-Fade Action"] = new engine.RulesElement({
  ...
  te = class_feature["Shifting Skill"] = new engine.RulesElement({
    name: "Shifting Skill",
    type: "class feature",
  ...
  te = class_feature["Silver Exorcism"] = new engine.RulesElement({
  ...
  te = class_feature["Silver Flame Action"] = new engine.RulesElement({
  ...
  te = class_feature["Storm Adept"] = new engine.RulesElement({
    name: "Storm Adept",
    type: "class feature",
  ...
  te = class_feature["Superior Minions"] = new engine.RulesElement({
  ...
  te = class_feature["Supernal Linguist"] = new engine.RulesElement({
  ...
  te = class_feature["Supporting Construction"] = new engine.RulesElement({
  ...
  te = class_feature["Swift Action"] = new engine.RulesElement({
    name: "Swift Action",
    type: "class feature",
  ...
  te = class_feature["Swift Foot"] = new engine.RulesElement({
    name: "Swift Foot",
    type: "class feature",
  ...
  te = class_feature["Swiftblade Action"] = new engine.RulesElement({
  ...
  te = class_feature["Thuranni Silence"] = new engine.RulesElement({
  ...
  te = class_feature["True Word Healing"] = new engine.RulesElement({
  ...
  te = class_feature["Truenamer Action"] = new engine.RulesElement({
  ...
  te = class_feature["Trueseer Action"] = new engine.RulesElement({
  ...
  te = class_feature["Unstoppable"] = new engine.RulesElement({
    name: "Unstoppable",
    type: "class feature",
  ...
  te = class_feature["Unstoppable Prophecy"] = new engine.RulesElement({
  ...
  te = class_feature["Vadalis Griffon"] = new engine.RulesElement({
  ...
  te = class_feature["Vadalis Ritual Techniques"] = new engine.RulesElement({
  ...
  te = class_feature["Vigilant Sprinter"] = new engine.RulesElement({
  ...
  te = class_feature["Walk the Bright Path"] = new engine.RulesElement({
  ...
  te = class_feature["Wayfinder Action"] = new engine.RulesElement({
  ...
  te = class_feature["Wayfinder's Quarry"] = new engine.RulesElement({
  ...
  te = class_feature["Wind-Rider Action"] = new engine.RulesElement({
  ...
  te = class_feature["Word of Life"] = new engine.RulesElement({
    name: "Word of Life",
    type: "class feature",
  ...
  te = class_feature["Wrath of Silver Flame"] = new engine.RulesElement({
