define(['engine', 'dnd4model'], function(engine, dnd4model) {
  ...
  te = class_feature["Bahamut's Warding"] = new engine.RulesElement({
  ...
  te = class_feature["Breath Expertise"] = new engine.RulesElement({
  ...
  te = class_feature["Breath Mastery"] = new engine.RulesElement({
    name: "Breath Mastery",
    type: "class feature",
  ...
  te = class_feature["Divine Discorporation"] = new engine.RulesElement({
  ...
  te = class_feature["Draconic Blade"] = new engine.RulesElement({
    name: "Draconic Blade",
    type: "class feature",
  ...
  te = class_feature["Draconic Incarnation"] = new engine.RulesElement({
  ...
  te = class_feature["Draconic Resistance"] = new engine.RulesElement({
  ...
  te = class_feature["Draconic Resistance Acid"] = new engine.RulesElement({
  ...
  te = class_feature["Draconic Resistance Cold"] = new engine.RulesElement({
  ...
  te = class_feature["Draconic Resistance Fire"] = new engine.RulesElement({
  ...
  te = class_feature["Draconic Resistance Lightning"] = new engine.RulesElement({
  ...
  te = class_feature["Draconic Resistance Poison"] = new engine.RulesElement({
  ...
  te = class_feature["Dragon Breath Action"] = new engine.RulesElement({
  ...
  te = class_feature["Dragon Breath Action (Ninefold Master)"] = new engine.RulesElement({
  ...
  te = class_feature["Focused Action"] = new engine.RulesElement({
    name: "Focused Action",
    type: "class feature",
  ...
  te = class_feature["Polar Breath"] = new engine.RulesElement({
    name: "Polar Breath",
    type: "class feature",
  ...
  te = class_feature["Soul of the Storm Dragon"] = new engine.RulesElement({
  ...
  te = class_feature["Storm Dragon Wings"] = new engine.RulesElement({
  ...
  te = class_feature["Storm Spirit"] = new engine.RulesElement({
    name: "Storm Spirit",
    type: "class feature",
  ...
  te = class_feature["Thundering Action"] = new engine.RulesElement({
  ...
  te = class_feature["Wings of Io"] = new engine.RulesElement({
    name: "Wings of Io",
    type: "class feature",
