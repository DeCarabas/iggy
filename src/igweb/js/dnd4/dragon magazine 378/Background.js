(function(global, undefined) {
  ...
  te = Background["Barrister"] = new RulesElement({
    name: "Barrister",
    type: "Background",
  ...
  te = Background["Captive"] = new RulesElement({
    name: "Captive",
    type: "Background",
  ...
  te = Background["Rebel"] = new RulesElement({
    name: "Rebel",
    type: "Background",
  ...
  te = Background["Redemption"] = new RulesElement({
    name: "Redemption",
    type: "Background",
  ...
  te = Background["Squire"] = new RulesElement({
    name: "Squire",
    type: "Background",
  ...
  te = Background["Survivor"] = new RulesElement({
    name: "Survivor",
    type: "Background",
  ...
  te = Background["Witness"] = new RulesElement({
    name: "Witness",
    type: "Background",
