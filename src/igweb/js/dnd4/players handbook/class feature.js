define(['engine', 'dnd4model'], function(engine, dnd4model) {
  ...
  te = class_feature["Acrobatic Action"] = new engine.RulesElement({
  ...
  te = class_feature["Action Shift"] = new engine.RulesElement({
    name: "Action Shift",
    type: "class feature",
  ...
  te = class_feature["Angelic Action"] = new engine.RulesElement({
    name: "Angelic Action",
    type: "class feature",
  ...
  te = class_feature["Arcane Implement Mastery"] = new engine.RulesElement({
  ...
  te = class_feature["Arcane Riposte"] = new engine.RulesElement({
    name: "Arcane Riposte",
    type: "class feature",
  ...
  te = class_feature["Arcane Spirit"] = new engine.RulesElement({
    name: "Arcane Spirit",
    type: "class feature",
  ...
  te = class_feature["Archer Fighting Style"] = new engine.RulesElement({
  ...
  te = class_feature["Archer's Action (Battlefield Archer)"] = new engine.RulesElement({
  ...
  te = class_feature["Archspell"] = new engine.RulesElement({
    name: "Archspell",
    type: "class feature",
  ...
  te = class_feature["Armor Optimization"] = new engine.RulesElement({
  ...
  te = class_feature["Artful Dodger"] = new engine.RulesElement({
    name: "Artful Dodger",
    type: "class feature",
  ...
  te = class_feature["Astral Judgment"] = new engine.RulesElement({
  ...
  te = class_feature["Astral Rejuvenation Action"] = new engine.RulesElement({
  ...
  te = class_feature["Astral Vibrance"] = new engine.RulesElement({
  ...
  te = class_feature["Athletic Master"] = new engine.RulesElement({
  ...
  te = class_feature["Battle Action"] = new engine.RulesElement({
    name: "Battle Action",
    type: "class feature",
  ...
  te = class_feature["Battle Edge"] = new engine.RulesElement({
    name: "Battle Edge",
    type: "class feature",
  ...
  te = class_feature["Battle Healer"] = new engine.RulesElement({
    name: "Battle Healer",
    type: "class feature",
  ...
  te = class_feature["Battle Inspiration"] = new engine.RulesElement({
  ...
  te = class_feature["Battle Mage Action"] = new engine.RulesElement({
  ...
  te = class_feature["Battle Surge"] = new engine.RulesElement({
    name: "Battle Surge",
    type: "class feature",
  ...
  te = class_feature["Battlefield Experience"] = new engine.RulesElement({
  ...
  te = class_feature["Battlehoned"] = new engine.RulesElement({
    name: "Battlehoned",
    type: "class feature",
  ...
  te = class_feature["Beast"] = new engine.RulesElement({
    name: "Beast",
    type: "class feature",
  ...
  te = class_feature["Beast Stalker's Action"] = new engine.RulesElement({
  ...
  te = class_feature["Blade Storm"] = new engine.RulesElement({
    name: "Blade Storm",
    type: "class feature",
  ...
  te = class_feature["Blood Action"] = new engine.RulesElement({
    name: "Blood Action",
    type: "class feature",
  ...
  te = class_feature["Blood and Radiance"] = new engine.RulesElement({
  ...
  te = class_feature["Bloody Evisceration"] = new engine.RulesElement({
  ...
  te = class_feature["Body Control"] = new engine.RulesElement({
    name: "Body Control",
    type: "class feature",
  ...
  te = class_feature["Bolstering Blood"] = new engine.RulesElement({
  ...
  te = class_feature["Brutal Scoundrel"] = new engine.RulesElement({
  ...
  te = class_feature["Burning Blood"] = new engine.RulesElement({
    name: "Burning Blood",
    type: "class feature",
  ...
  te = class_feature["Cantrips"] = new engine.RulesElement({
    name: "Cantrips",
    type: "class feature",
    ...
    rules: function(model) {
      ...
      model.grant(model.elements.id["ID_FMP_POWER_1225"]);
  ...
  te = class_feature["Champion's Action"] = new engine.RulesElement({
  ...
  te = class_feature["Champion's Hammer"] = new engine.RulesElement({
  ...
  te = class_feature["Channel Divinity"] = new engine.RulesElement({
  ...
  te = class_feature["Chosen Prey"] = new engine.RulesElement({
    name: "Chosen Prey",
    type: "class feature",
  ...
  te = class_feature["Collect Life Spark"] = new engine.RulesElement({
  ...
  te = class_feature["Combat Challenge"] = new engine.RulesElement({
  ...
  te = class_feature["Combat Leader"] = new engine.RulesElement({
    name: "Combat Leader",
    type: "class feature",
  ...
  te = class_feature["Combat Superiority"] = new engine.RulesElement({
  ...
  te = class_feature["Combat Veteran's Action"] = new engine.RulesElement({
  ...
  te = class_feature["Commanding Presence"] = new engine.RulesElement({
  ...
  te = class_feature["Corellon's Implement"] = new engine.RulesElement({
  ...
  te = class_feature["Courage from on High"] = new engine.RulesElement({
  ...
  te = class_feature["Cruel Recovery"] = new engine.RulesElement({
    name: "Cruel Recovery",
    type: "class feature",
  ...
  te = class_feature["Cry Havoc"] = new engine.RulesElement({
    name: "Cry Havoc",
    type: "class feature",
  ...
  te = class_feature["Dagger Advantage"] = new engine.RulesElement({
  ...
  te = class_feature["Dagger Precision"] = new engine.RulesElement({
  ...
  te = class_feature["Daggermaster's Action"] = new engine.RulesElement({
  ...
  te = class_feature["Dirty Fighting"] = new engine.RulesElement({
    name: "Dirty Fighting",
    type: "class feature",
  ...
  te = class_feature["Disciplined Blade"] = new engine.RulesElement({
  ...
  te = class_feature["Divine Challenge"] = new engine.RulesElement({
  ...
  te = class_feature["Divine Miracle"] = new engine.RulesElement({
    name: "Divine Miracle",
    type: "class feature",
  ...
  te = class_feature["Divine Recovery"] = new engine.RulesElement({
  ...
  te = class_feature["Divine Spark"] = new engine.RulesElement({
    name: "Divine Spark",
    type: "class feature",
  ...
  te = class_feature["Divine Spark Charisma"] = new engine.RulesElement({
  ...
  te = class_feature["Divine Spark Constitution"] = new engine.RulesElement({
  ...
  te = class_feature["Divine Spark Dexterity"] = new engine.RulesElement({
  ...
  te = class_feature["Divine Spark Intelligence"] = new engine.RulesElement({
  ...
  te = class_feature["Divine Spark Strength"] = new engine.RulesElement({
  ...
  te = class_feature["Divine Spark Wisdom"] = new engine.RulesElement({
  ...
  te = class_feature["Doomsayer's Action"] = new engine.RulesElement({
  ...
  te = class_feature["Doomsayer's Oath"] = new engine.RulesElement({
  ...
  te = class_feature["Doomsayer's Proclamation"] = new engine.RulesElement({
  ...
  te = class_feature["Eldritch Blast"] = new engine.RulesElement({
    name: "Eldritch Blast",
    type: "class feature",
  ...
  te = class_feature["Eldritch Blast Charisma"] = new engine.RulesElement({
  ...
  te = class_feature["Eldritch Blast Constitution"] = new engine.RulesElement({
  ...
  te = class_feature["Eldritch Pact"] = new engine.RulesElement({
    name: "Eldritch Pact",
    type: "class feature",
  ...
  te = class_feature["Enduring Warrior"] = new engine.RulesElement({
  ...
  te = class_feature["Eternal Action"] = new engine.RulesElement({
    name: "Eternal Action",
    type: "class feature",
  ...
  te = class_feature["Extra Damage Action"] = new engine.RulesElement({
  ...
  te = class_feature["Ferocious Reaction"] = new engine.RulesElement({
  ...
  te = class_feature["Fey Pact"] = new engine.RulesElement({
    name: "Fey Pact",
    type: "class feature",
  ...
  te = class_feature["Feytouched Action"] = new engine.RulesElement({
  ...
  te = class_feature["Fighter Talents"] = new engine.RulesElement({
  ...
  te = class_feature["Fighting Style"] = new engine.RulesElement({
    name: "Fighting Style",
    type: "class feature",
  ...
  te = class_feature["First Strike"] = new engine.RulesElement({
    name: "First Strike",
    type: "class feature",
  ...
  te = class_feature["Foresight"] = new engine.RulesElement({
    name: "Foresight",
    type: "class feature",
  ...
  te = class_feature["Guardian Mindfulness Charisma"] = new engine.RulesElement({
  ...
  te = class_feature["Guardian Mindfulness Constitution"] = new engine.RulesElement({
  ...
  te = class_feature["Guardian Mindfulness Dexterity"] = new engine.RulesElement({
  ...
  te = class_feature["Guardian Mindfulness Intelligence"] = new engine.RulesElement({
  ...
  te = class_feature["Guardian Mindfulness Strength"] = new engine.RulesElement({
  ...
  te = class_feature["Guardian Mindfulness Wisdom"] = new engine.RulesElement({
  ...
  te = class_feature["Healer's Lore"] = new engine.RulesElement({
    name: "Healer's Lore",
    type: "class feature",
  ...
  te = class_feature["Healing Word"] = new engine.RulesElement({
    name: "Healing Word",
    type: "class feature",
  ...
  te = class_feature["Honor and Glory"] = new engine.RulesElement({
  ...
  te = class_feature["Hospitaler's Action"] = new engine.RulesElement({
  ...
  te = class_feature["Hospitaler's Blessing"] = new engine.RulesElement({
  ...
  te = class_feature["Hospitalers' Care"] = new engine.RulesElement({
  ...
  te = class_feature["Hunter's Quarry"] = new engine.RulesElement({
  ...
  te = class_feature["Illuminating Attacks"] = new engine.RulesElement({
  ...
  te = class_feature["In Defense of Order"] = new engine.RulesElement({
  ...
  te = class_feature["Infernal Action"] = new engine.RulesElement({
  ...
  te = class_feature["Infernal Pact"] = new engine.RulesElement({
    name: "Infernal Pact",
    type: "class feature",
  ...
  te = class_feature["Infiltrator's Action"] = new engine.RulesElement({
  ...
  te = class_feature["Inspiring Presence"] = new engine.RulesElement({
  ...
  te = class_feature["Inspiring Word"] = new engine.RulesElement({
    name: "Inspiring Word",
    type: "class feature",
  ...
  te = class_feature["Invisible Infiltrator"] = new engine.RulesElement({
  ...
  te = class_feature["Just Action"] = new engine.RulesElement({
    name: "Just Action",
    type: "class feature",
  ...
  te = class_feature["Just Shelter"] = new engine.RulesElement({
    name: "Just Shelter",
    type: "class feature",
  ...
  te = class_feature["Just Spirit"] = new engine.RulesElement({
    name: "Just Spirit",
    type: "class feature",
  ...
  te = class_feature["Kensei Control Action"] = new engine.RulesElement({
  ...
  te = class_feature["Kensei Focus"] = new engine.RulesElement({
    name: "Kensei Focus",
    type: "class feature",
  ...
  te = class_feature["Kensei Focus Bastard sword"] = new engine.RulesElement({
  ...
  te = class_feature["Kensei Focus Battleaxe"] = new engine.RulesElement({
  ...
  te = class_feature["Kensei Focus Battlefist"] = new engine.RulesElement({
  ...
  te = class_feature["Kensei Focus Broadsword"] = new engine.RulesElement({
  ...
  te = class_feature["Kensei Focus Claw Fighter Claw"] = new engine.RulesElement({
  ...
  te = class_feature["Kensei Focus Club"] = new engine.RulesElement({
  ...
  te = class_feature["Kensei Focus Craghammer"] = new engine.RulesElement({
  ...
  te = class_feature["Kensei Focus Cutting Wheel"] = new engine.RulesElement({
  ...
  te = class_feature["Kensei Focus Dagger"] = new engine.RulesElement({
  ...
  te = class_feature["Kensei Focus Double axe"] = new engine.RulesElement({
  ...
  te = class_feature["Kensei Focus Double flail"] = new engine.RulesElement({
  ...
  te = class_feature["Kensei Focus Double Scimitar"] = new engine.RulesElement({
  ...
  te = class_feature["Kensei Focus Double sword"] = new engine.RulesElement({
  ...
  te = class_feature["Kensei Focus Drow Long Knife"] = new engine.RulesElement({
  ...
  te = class_feature["Kensei Focus Execution axe"] = new engine.RulesElement({
  ...
  te = class_feature["Kensei Focus Falchion"] = new engine.RulesElement({
  ...
  te = class_feature["Kensei Focus Flail"] = new engine.RulesElement({
  ...
  te = class_feature["Kensei Focus Fullblade"] = new engine.RulesElement({
  ...
  te = class_feature["Kensei Focus Garrote"] = new engine.RulesElement({
  ...
  te = class_feature["Kensei Focus Glaive"] = new engine.RulesElement({
  ...
  te = class_feature["Kensei Focus Greataxe"] = new engine.RulesElement({
  ...
  te = class_feature["Kensei Focus Greatclub"] = new engine.RulesElement({
  ...
  te = class_feature["Kensei Focus Greatspear"] = new engine.RulesElement({
  ...
  te = class_feature["Kensei Focus Greatsword"] = new engine.RulesElement({
  ...
  te = class_feature["Kensei Focus Halberd"] = new engine.RulesElement({
  ...
  te = class_feature["Kensei Focus Handaxe"] = new engine.RulesElement({
  ...
  te = class_feature["Kensei Focus Heavy flail"] = new engine.RulesElement({
  ...
  te = class_feature["Kensei Focus Heavy war pick"] = new engine.RulesElement({
  ...
  te = class_feature["Kensei Focus Javelin"] = new engine.RulesElement({
  ...
  te = class_feature["Kensei Focus Katar"] = new engine.RulesElement({
  ...
  te = class_feature["Kensei Focus Khopesh"] = new engine.RulesElement({
  ...
  te = class_feature["Kensei Focus Kukri"] = new engine.RulesElement({
  ...
  te = class_feature["Kensei Focus Light war pick"] = new engine.RulesElement({
  ...
  te = class_feature["Kensei Focus Longspear"] = new engine.RulesElement({
  ...
  te = class_feature["Kensei Focus Longsword"] = new engine.RulesElement({
  ...
  te = class_feature["Kensei Focus Mace"] = new engine.RulesElement({
  ...
  te = class_feature["Kensei Focus Maul"] = new engine.RulesElement({
  ...
  te = class_feature["Kensei Focus Mordenkrad"] = new engine.RulesElement({
  ...
  te = class_feature["Kensei Focus Morningstar"] = new engine.RulesElement({
  ...
  te = class_feature["Kensei Focus Net"] = new engine.RulesElement({
  ...
  te = class_feature["Kensei Focus Parrying dagger"] = new engine.RulesElement({
  ...
  te = class_feature["Kensei Focus Quarterstaff"] = new engine.RulesElement({
  ...
  te = class_feature["Kensei Focus Rapier"] = new engine.RulesElement({
  ...
  te = class_feature["Kensei Focus Scimitar"] = new engine.RulesElement({
  ...
  te = class_feature["Kensei Focus Scourge"] = new engine.RulesElement({
  ...
  te = class_feature["Kensei Focus Scythe"] = new engine.RulesElement({
  ...
  te = class_feature["Kensei Focus Short sword"] = new engine.RulesElement({
  ...
  te = class_feature["Kensei Focus Sickle"] = new engine.RulesElement({
  ...
  te = class_feature["Kensei Focus Spear"] = new engine.RulesElement({
  ...
  te = class_feature["Kensei Focus Spiked chain"] = new engine.RulesElement({
  ...
  te = class_feature["Kensei Focus Spiked gauntlet"] = new engine.RulesElement({
  ...
  te = class_feature["Kensei Focus Spiked shield"] = new engine.RulesElement({
  ...
  te = class_feature["Kensei Focus Talenta Sharrash"] = new engine.RulesElement({
  ...
  te = class_feature["Kensei Focus Talenta Tangat"] = new engine.RulesElement({
  ...
  te = class_feature["Kensei Focus Throwing hammer"] = new engine.RulesElement({
  ...
  te = class_feature["Kensei Focus Tratnyr"] = new engine.RulesElement({
  ...
  te = class_feature["Kensei Focus Trident"] = new engine.RulesElement({
  ...
  te = class_feature["Kensei Focus Triple-headed flail"] = new engine.RulesElement({
  ...
  te = class_feature["Kensei Focus Unarmed attack"] = new engine.RulesElement({
  ...
  te = class_feature["Kensei Focus Urgrosh"] = new engine.RulesElement({
  ...
  te = class_feature["Kensei Focus War Pick"] = new engine.RulesElement({
  ...
  te = class_feature["Kensei Focus Waraxe"] = new engine.RulesElement({
  ...
  te = class_feature["Kensei Focus Warhammer"] = new engine.RulesElement({
  ...
  te = class_feature["Kensei Focus Whip"] = new engine.RulesElement({
  ...
  te = class_feature["Kensei Focus Zulaat"] = new engine.RulesElement({
  ...
  te = class_feature["Kensei Mastery"] = new engine.RulesElement({
    name: "Kensei Mastery",
    type: "class feature",
  ...
  te = class_feature["Knight Commander's Action"] = new engine.RulesElement({
  ...
  te = class_feature["Lasting Light"] = new engine.RulesElement({
    name: "Lasting Light",
    type: "class feature",
  ...
  te = class_feature["Lay on Hands"] = new engine.RulesElement({
    name: "Lay on Hands",
    type: "class feature",
  ...
  te = class_feature["Lightning"] = new engine.RulesElement({
    name: "Lightning",
    type: "class feature",
  ...
  te = class_feature["Magical Beast"] = new engine.RulesElement({
    name: "Magical Beast",
    type: "class feature",
  ...
  te = class_feature["One-handed Weapon Talent"] = new engine.RulesElement({
  ...
  te = class_feature["Orb"] = new engine.RulesElement({
    name: "Orb",
    type: "class feature",
  ...
  te = class_feature["Orb of Imposition"] = new engine.RulesElement({
  ...
  te = class_feature["Pact Initiate (dark pact)"] = new engine.RulesElement({
  ...
  te = class_feature["Pact Initiate (fey pact)"] = new engine.RulesElement({
  ...
  te = class_feature["Pact Initiate (infernal pact)"] = new engine.RulesElement({
    ...
    rules: function(model) {
      model.grant(model.elements.id["ID_FMP_POWER_1458"]);
      // unsupported rule: cbimporter.Rules.ModifyRule
  ...
  te = class_feature["Pact Initiate (star pact)"] = new engine.RulesElement({
    ...
    rules: function(model) {
      model.grant(model.elements.id["ID_FMP_POWER_1457"]);
      // unsupported rule: cbimporter.Rules.ModifyRule
  ...
  te = class_feature["Pact Initiate (vestige pact)"] = new engine.RulesElement({
  ...
  te = class_feature["Pathfinder's Action"] = new engine.RulesElement({
  ...
  te = class_feature["Patron's Favor"] = new engine.RulesElement({
    name: "Patron's Favor",
    type: "class feature",
  ...
  te = class_feature["Press of Arms"] = new engine.RulesElement({
    name: "Press of Arms",
    type: "class feature",
  ...
  te = class_feature["Prime Shot"] = new engine.RulesElement({
    name: "Prime Shot",
    type: "class feature",
  ...
  te = class_feature["Prophetic Action"] = new engine.RulesElement({
  ...
  te = class_feature["Radiant"] = new engine.RulesElement({
    name: "Radiant",
    type: "class feature",
  ...
  te = class_feature["Radiant Action"] = new engine.RulesElement({
    name: "Radiant Action",
    type: "class feature",
  ...
  te = class_feature["Radiant Censure"] = new engine.RulesElement({
  ...
  te = class_feature["Ritual Casting"] = new engine.RulesElement({
    name: "Ritual Casting",
    type: "class feature",
  ...
  te = class_feature["Rogue Tactics"] = new engine.RulesElement({
    name: "Rogue Tactics",
    type: "class feature",
  ...
  te = class_feature["Rogue Weapon Talent"] = new engine.RulesElement({
  ...
  te = class_feature["Seeker of the Many Paths"] = new engine.RulesElement({
  ...
  te = class_feature["Seeker's Lore"] = new engine.RulesElement({
    name: "Seeker's Lore",
    type: "class feature",
  ...
  te = class_feature["Seeking Destiny"] = new engine.RulesElement({
  ...
  te = class_feature["Shadow Assassin's Action"] = new engine.RulesElement({
  ...
  te = class_feature["Shadow Assassin's Riposte"] = new engine.RulesElement({
  ...
  te = class_feature["Shadow Walk"] = new engine.RulesElement({
    name: "Shadow Walk",
    type: "class feature",
  ...
  te = class_feature["Skewer the Weak"] = new engine.RulesElement({
  ...
  te = class_feature["Skillful Infiltrator"] = new engine.RulesElement({
  ...
  te = class_feature["Slashing Wake"] = new engine.RulesElement({
    name: "Slashing Wake",
    type: "class feature",
  ...
  te = class_feature["Sly Fortune's Favor"] = new engine.RulesElement({
  ...
  te = class_feature["Sneak Attack"] = new engine.RulesElement({
    name: "Sneak Attack",
    type: "class feature",
  ...
  te = class_feature["Spell Recall"] = new engine.RulesElement({
    name: "Spell Recall",
    type: "class feature",
  ...
  te = class_feature["Spellbook"] = new engine.RulesElement({
    name: "Spellbook",
    type: "class feature",
  ...
  te = class_feature["Spiral Tower Action"] = new engine.RulesElement({
  ...
  te = class_feature["staff"] = new engine.RulesElement({
    name: "staff",
    type: "class feature",
  ...
  te = class_feature["Staff of Defense"] = new engine.RulesElement({
    ...
    rules: function(model) {
      ...
      model.grant(model.elements.id["ID_FMP_POWER_5595"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Star Pact"] = new engine.RulesElement({
    name: "Star Pact",
    type: "class feature",
  ...
  te = class_feature["Steel Blitz"] = new engine.RulesElement({
    name: "Steel Blitz",
    type: "class feature",
  ...
  te = class_feature["Steel Defense Action"] = new engine.RulesElement({
  ...
  te = class_feature["Steel Grace"] = new engine.RulesElement({
    name: "Steel Grace",
    type: "class feature",
  ...
  te = class_feature["Storm Fury"] = new engine.RulesElement({
    name: "Storm Fury",
    type: "class feature",
  ...
  te = class_feature["Storm Spell"] = new engine.RulesElement({
    name: "Storm Spell",
    type: "class feature",
  ...
  te = class_feature["Stormstep Action"] = new engine.RulesElement({
  ...
  te = class_feature["Student of One-Handed Weapons"] = new engine.RulesElement({
  ...
  te = class_feature["Student of Two-Handed Weapons"] = new engine.RulesElement({
  ...
  te = class_feature["Sustain Life Spark"] = new engine.RulesElement({
  ...
  te = class_feature["Sword Marshal's Action"] = new engine.RulesElement({
  ...
  te = class_feature["Tactical Presence"] = new engine.RulesElement({
  ...
  te = class_feature["Terrifying Insight"] = new engine.RulesElement({
  ...
  te = class_feature["Thunder"] = new engine.RulesElement({
    name: "Thunder",
    type: "class feature",
  ...
  te = class_feature["Tough as Nails"] = new engine.RulesElement({
    name: "Tough as Nails",
    type: "class feature",
  ...
  te = class_feature["Trample the Fallen"] = new engine.RulesElement({
  ...
  te = class_feature["Trickster's Control"] = new engine.RulesElement({
  ...
  te = class_feature["Trickster's Disposition"] = new engine.RulesElement({
  ...
  te = class_feature["Twin-Blade Storm"] = new engine.RulesElement({
  ...
  te = class_feature["Two-Blade Fighting Style"] = new engine.RulesElement({
  ...
  te = class_feature["Two-handed Weapon Talent"] = new engine.RulesElement({
  ...
  te = class_feature["Wand"] = new engine.RulesElement({
    name: "Wand",
    type: "class feature",
  ...
  te = class_feature["Wand of Accuracy"] = new engine.RulesElement({
    ...
    rules: function(model) {
      model.grant(model.elements.id["ID_FMP_POWER_5596"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Warlock's Curse"] = new engine.RulesElement({
  ...
  te = class_feature["Warpriest's Challenge"] = new engine.RulesElement({
  ...
  te = class_feature["Warpriest's Strategy"] = new engine.RulesElement({
  ...
  te = class_feature["Warpriest's Training"] = new engine.RulesElement({
  ...
  te = class_feature["Weapon Training"] = new engine.RulesElement({
