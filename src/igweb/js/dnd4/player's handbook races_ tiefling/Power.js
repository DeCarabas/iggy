(function(global, undefined) {
  ...
  te = Power["Firesoul Salvation"] = new RulesElement({
    name: "Firesoul Salvation",
    type: "Power",
    id: "ID_FMP_POWER_10873",
    source: "Player's Handbook Races: Tiefling",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=10873",
  ...
  te = Power["Flame Blade"] = new RulesElement({
    name: "Flame Blade",
    type: "Power",
    id: "ID_FMP_POWER_10870",
    source: "Player's Handbook Races: Tiefling",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=10870",
  ...
  te = Power["Hellfire Gaze"] = new RulesElement({
    name: "Hellfire Gaze",
    type: "Power",
    id: "ID_FMP_POWER_10879",
    source: "Player's Handbook Races: Tiefling",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=10879",
  ...
  te = Power["Hellish Escape"] = new RulesElement({
    name: "Hellish Escape",
    type: "Power",
    id: "ID_FMP_POWER_10862",
    source: "Player's Handbook Races: Tiefling",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=10862",
  ...
  te = Power["Hell's Ram"] = new RulesElement({
    name: "Hell's Ram",
    type: "Power",
    id: "ID_FMP_POWER_10868",
    source: "Player's Handbook Races: Tiefling",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=10868",
  ...
  te = Power["Hell's Shackles"] = new RulesElement({
    name: "Hell's Shackles",
    type: "Power",
    id: "ID_FMP_POWER_10866",
    source: "Player's Handbook Races: Tiefling",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=10866",
  ...
  te = Power["Infernal Respite"] = new RulesElement({
    name: "Infernal Respite",
    type: "Power",
    id: "ID_FMP_POWER_10863",
    source: "Player's Handbook Races: Tiefling",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=10863",
  ...
  te = Power["Iron Wall of Dis"] = new RulesElement({
    name: "Iron Wall of Dis",
    type: "Power",
    id: "ID_FMP_POWER_10864",
    source: "Player's Handbook Races: Tiefling",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=10864",
  ...
  te = Power["Prescient Thought"] = new RulesElement({
    name: "Prescient Thought",
    type: "Power",
    id: "ID_FMP_POWER_10878",
    source: "Player's Handbook Races: Tiefling",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=10878",
  ...
  te = Power["Ride the Devil's Tail"] = new RulesElement({
    name: "Ride the Devil's Tail",
    type: "Power",
    id: "ID_FMP_POWER_10869",
    source: "Player's Handbook Races: Tiefling",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=10869",
  ...
  te = Power["Ruler of Life and Death"] = new RulesElement({
    name: "Ruler of Life and Death",
    type: "Power",
    id: "ID_FMP_POWER_10880",
    source: "Player's Handbook Races: Tiefling",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=10880",
  ...
  te = Power["Spirit of Sacrifice"] = new RulesElement({
    name: "Spirit of Sacrifice",
    type: "Power",
    id: "ID_FMP_POWER_10872",
    source: "Player's Handbook Races: Tiefling",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=10872",
  ...
  te = Power["To Hell with You"] = new RulesElement({
    name: "To Hell with You",
    type: "Power",
    id: "ID_FMP_POWER_10867",
    source: "Player's Handbook Races: Tiefling",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=10867",
  ...
  te = Power["Vision of Death"] = new RulesElement({
    name: "Vision of Death",
    type: "Power",
    id: "ID_FMP_POWER_10874",
    source: "Player's Handbook Races: Tiefling",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=10874",
  ...
  te = Power["Vision of Death (Augment 0)"] = new RulesElement({
    name: "Vision of Death (Augment 0)",
    type: "Power",
    id: "ID_INTERNAL_POWER_VISION_OF_DEATH_(AUGMENT_0)",
    source: "Player's Handbook Races: Tiefling",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=OWER_VISION_OF_DEATH_(AUGMENT_0)",
    categories: ["Vision of Death (Augment 0)", "ID_INTERNAL_POWER_VISION_OF_DEATH_(AUGMENT_0)"]
  });
  byID[te.id] = te;
  
  te = Power["Vision of Death (Augment 2)"] = new RulesElement({
    name: "Vision of Death (Augment 2)",
    type: "Power",
    id: "ID_INTERNAL_POWER_VISION_OF_DEATH_(AUGMENT_2)",
    source: "Player's Handbook Races: Tiefling",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=OWER_VISION_OF_DEATH_(AUGMENT_2)",
    categories: ["Vision of Death (Augment 2)", "ID_INTERNAL_POWER_VISION_OF_DEATH_(AUGMENT_2)"]
  });
  byID[te.id] = te;
  
  te = Power["Yoke of Heaven"] = new RulesElement({
    name: "Yoke of Heaven",
    type: "Power",
    id: "ID_FMP_POWER_10865",
    source: "Player's Handbook Races: Tiefling",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=10865",
  ...
  te = Power["Your Doom Awaits"] = new RulesElement({
    name: "Your Doom Awaits",
    type: "Power",
    id: "ID_FMP_POWER_10871",
    source: "Player's Handbook Races: Tiefling",
    compendiumUrl: "http://www.wizards.com/dndinsider/compendium/item.aspx?id=10871",
