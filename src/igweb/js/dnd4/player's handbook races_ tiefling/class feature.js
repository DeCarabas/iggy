(function(global, undefined) {
  ...
  te = class_feature["Born to Rule"] = new RulesElement({
    name: "Born to Rule",
    type: "class feature",
  ...
  te = class_feature["Calling Souls to Battle"] = new RulesElement({
  ...
  te = class_feature["Chains of Their Sins"] = new RulesElement({
  ...
  te = class_feature["Heaven's Keys"] = new RulesElement({
    name: "Heaven's Keys",
    type: "class feature",
  ...
  te = class_feature["Imperial Wrath"] = new RulesElement({
    name: "Imperial Wrath",
    type: "class feature",
  ...
  te = class_feature["Infernal Retribution"] = new RulesElement({
  ...
  te = class_feature["Infernal Visions"] = new RulesElement({
  ...
  te = class_feature["Irresistible Will of the Empire"] = new RulesElement({
  ...
  te = class_feature["Jailor's Strength"] = new RulesElement({
  ...
  te = class_feature["Mantic Eye"] = new RulesElement({
    name: "Mantic Eye",
    type: "class feature",
  ...
  te = class_feature["Redeemer's Reward"] = new RulesElement({
  ...
  te = class_feature["Rewards of Arcane Mystery"] = new RulesElement({
  ...
  te = class_feature["Secrets of Arcane Might"] = new RulesElement({
  ...
  te = class_feature["Shared Prescience"] = new RulesElement({
  ...
  te = class_feature["Spirit Shielding"] = new RulesElement({
  ...
  te = class_feature["Tail Sweep Action"] = new RulesElement({
  ...
  te = class_feature["Turathi Tenacity"] = new RulesElement({
  ...
  te = class_feature["Turathi Vigor"] = new RulesElement({
    name: "Turathi Vigor",
    type: "class feature",
