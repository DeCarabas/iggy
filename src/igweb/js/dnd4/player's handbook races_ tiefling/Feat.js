(function(global, undefined) {
  ...
  te = Feat["Ancient Covenant of Nessus"] = new RulesElement({
  ...
  te = Feat["Baalzebul's Desperate Gambit"] = new RulesElement({
  ...
  te = Feat["Bel's Impending Victory"] = new RulesElement({
  ...
  te = Feat["Blood of Levistus"] = new RulesElement({
  ...
  te = Feat["Blood Pact of Cania"] = new RulesElement({
  ...
  te = Feat["Bloodhunter's Dread"] = new RulesElement({
  ...
  te = Feat["Bloodhunter's Flank"] = new RulesElement({
  ...
  te = Feat["Burning Wrath of Phlegethos"] = new RulesElement({
  ...
  te = Feat["Clever Tail"] = new RulesElement({
    name: "Clever Tail",
    type: "Feat",
    id: "ID_FMP_FEAT_2290",
    source: "Player's Handbook Races: Tiefling",
  ...
  te = Feat["Cloying Shadow of Maladomini"] = new RulesElement({
  ...
  te = Feat["Dispater's Iron Discipline"] = new RulesElement({
  ...
  te = Feat["Glasya's Charming Words"] = new RulesElement({
  ...
  te = Feat["Hellbook"] = new RulesElement({
    name: "Hellbook",
    type: "Feat",
    id: "ID_FMP_FEAT_2292",
    source: "Player's Handbook Races: Tiefling",
  ...
  te = Feat["Hellfire of Mephistopheles"] = new RulesElement({
  ...
  te = Feat["Hellfire Teleport"] = new RulesElement({
  ...
  te = Feat["Hellish Blast"] = new RulesElement({
    name: "Hellish Blast",
    type: "Feat",
    id: "ID_FMP_FEAT_2293",
    source: "Player's Handbook Races: Tiefling",
  ...
  te = Feat["Hell's Burning Mark"] = new RulesElement({
  ...
  te = Feat["Icy Clutch of Stygia"] = new RulesElement({
  ...
  te = Feat["Infernal Touch of Warding"] = new RulesElement({
  ...
  te = Feat["Insatiable Rage of Minauros"] = new RulesElement({
  ...
  te = Feat["Mammon's Theft of Health"] = new RulesElement({
  ...
  te = Feat["Psychic Corruption of Malbolge"] = new RulesElement({
  ...
  te = Feat["Renewed Wrath"] = new RulesElement({
    name: "Renewed Wrath",
    type: "Feat",
    id: "ID_FMP_FEAT_2315",
    source: "Player's Handbook Races: Tiefling",
  ...
  te = Feat["Royal Command of Asmodeus"] = new RulesElement({
  ...
  te = Feat["Secrets of Belial"] = new RulesElement({
  ...
  te = Feat["Stirring Song of Baator"] = new RulesElement({
  ...
  te = Feat["Tail Slide"] = new RulesElement({
    name: "Tail Slide",
    type: "Feat",
    id: "ID_FMP_FEAT_2299",
    source: "Player's Handbook Races: Tiefling",
  ...
  te = Feat["Tail Trip"] = new RulesElement({
    name: "Tail Trip",
    type: "Feat",
    id: "ID_FMP_FEAT_2312",
    source: "Player's Handbook Races: Tiefling",
  ...
  te = Feat["Turathi Spirit Companion"] = new RulesElement({
  ...
  te = Feat["Turathi Weapon Training"] = new RulesElement({
  ...
  te = Feat["War Captain of Avernus"] = new RulesElement({
