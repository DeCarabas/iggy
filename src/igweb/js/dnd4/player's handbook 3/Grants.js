(function(global, undefined) {
  ...
  te = Grants["Ardent"] = new RulesElement({
    name: "Ardent",
    type: "Grants",
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_INTERNAL_PSIONIC_FIRST_CLASS"]);
      model.grant(elements.id["ID_FMP_ROLE_2"]);
      model.grant(elements.id["ID_FMP_POWER_SOURCE_5"]);
      ...
      model.grant(elements.id["ID_FMP_CLASS_FEATURE_2136"]);
      model.grant(elements.id["ID_FMP_CLASS_FEATURE_2138"]);
      model.grant(elements.id["ID_FMP_CLASS_FEATURE_1812"]);
      model.grant(elements.id["ID_INTERNAL_GRANTS_ARDENT_IMPLEMENTS"]);
    }
  });
  byID[te.id] = te;
  
  te = Grants["Ardent Implements"] = new RulesElement({
  ...
  te = Grants["Battlemind"] = new RulesElement({
    name: "Battlemind",
    type: "Grants",
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_INTERNAL_PROFICIENCY_SIMPLE_RANGED"]);
      model.grant(elements.id["ID_FMP_CLASS_FEATURE_1812"]);
      model.grant(elements.id["ID_FMP_CLASS_FEATURE_764"]);
      model.grant(elements.id["ID_FMP_CLASS_FEATURE_2175"]);
      model.grant(elements.id["ID_INTERNAL_GRANTS_BATTLEMIND_IMPLEMENTS"]);
    }
  });
  byID[te.id] = te;
  
  te = Grants["Battlemind Implements"] = new RulesElement({
  ...
  te = Grants["Githzerai"] = new RulesElement({
    name: "Githzerai",
    type: "Grants",
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_FMP_RACIAL_TRAIT_420"]);
      model.grant(elements.id["ID_FMP_RACIAL_TRAIT_466"]);
      model.grant(elements.id["ID_FMP_RACIAL_TRAIT_1861"]);
      model.grant(elements.id["ID_FMP_RACIAL_TRAIT_1862"]);
  ...
  te = Grants["Hybrid Ardent"] = new RulesElement({
    name: "Hybrid Ardent",
    type: "Grants",
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_INTERNAL_PROFICIENCY_MILITARY_MELEE"]);
      model.grant(elements.id["ID_INTERNAL_PROFICIENCY_SIMPLE_RANGED"]);
      model.grant(elements.id["ID_FMP_CLASS_FEATURE_2341"]);
      model.grant(elements.id["ID_FMP_CLASS_FEATURE_2346"]);
      model.grant(elements.id["ID_FMP_CLASS_FEATURE_2340"]);
      model.grant(elements.id["ID_INTERNAL_GRANTS_HYBRID_ARDENT_IMPLEMENTS"]);
    }
  });
  byID[te.id] = te;
  
  te = Grants["Hybrid Ardent Implements"] = new RulesElement({
  ...
  te = Grants["Hybrid Artificer"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_COUNTSASCLASS_ARTIFICER"]);
      // unsupported rule: cbimporter.Rules.SuggestRule
      // unsupported rule: cbimporter.Rules.SuggestRule
      // unsupported rule: cbimporter.Rules.SuggestRule
      model.grant(elements.id["ID_FMP_ROLE_2"]);
      ...
      model.grant(elements.id["ID_INTERNAL_PROFICIENCY_SIMPLE_MELEE"]);
      model.grant(elements.id["ID_INTERNAL_PROFICIENCY_SIMPLE_RANGED"]);
      model.grant(elements.id["ID_FMP_CLASS_FEATURE_2159"]);
      model.grant(elements.id["ID_INTERNAL_GRANTS_HYBRID_ARTIFICER_IMPLEMENTS"]);
    }
  });
  byID[te.id] = te;
  
  te = Grants["Hybrid Artificer Implements"] = new RulesElement({
  ...
  te = Grants["Hybrid Avenger"] = new RulesElement({
    name: "Hybrid Avenger",
    type: "Grants",
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_INTERNAL_PROFICIENCY_MILITARY_MELEE"]);
      model.grant(elements.id["ID_INTERNAL_PROFICIENCY_SIMPLE_RANGED"]);
      model.grant(elements.id["ID_FMP_CLASS_FEATURE_1820"]);
      model.grant(elements.id["ID_INTERNAL_GRANTS_HYBRID_AVENGER_IMPLEMENTS"]);
    }
  });
  byID[te.id] = te;
  
  te = Grants["Hybrid Avenger Implements"] = new RulesElement({
  ...
  te = Grants["Hybrid Barbarian"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_COUNTSASCLASS_BARBARIAN"]);
      // unsupported rule: cbimporter.Rules.SuggestRule
      // unsupported rule: cbimporter.Rules.SuggestRule
      // unsupported rule: cbimporter.Rules.SuggestRule
      model.grant(elements.id["ID_FMP_ROLE_3"]);
      ...
      model.grant(elements.id["ID_INTERNAL_GRANTS_HYBRID_BARBARIAN_IMPLEMENTS"]);
    }
  });
  byID[te.id] = te;
  
  te = Grants["Hybrid Barbarian Implements"] = new RulesElement({
  ...
  te = Grants["Hybrid Bard"] = new RulesElement({
    name: "Hybrid Bard",
    type: "Grants",
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_FMP_CLASS_FEATURE_1824"]);
      model.grant(elements.id["ID_FMP_CLASS_FEATURE_698"]);
      model.grant(elements.id["ID_INTERNAL_GRANTS_HYBRID_BARD_IMPLEMENTS"]);
    }
  });
  byID[te.id] = te;
  
  te = Grants["Hybrid Bard Implements"] = new RulesElement({
  ...
  te = Grants["Hybrid Battlemind"] = new RulesElement({
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_INTERNAL_PROFICIENCY_SIMPLE_RANGED"]);
      model.grant(elements.id["ID_FMP_CLASS_FEATURE_2340"]);
      model.grant(elements.id["ID_FMP_CLASS_FEATURE_2411"]);
      model.grant(elements.id["ID_INTERNAL_GRANTS_HYBRID_BATTLEMIND_IMPLEMENTS"]);
    }
  });
  byID[te.id] = te;
  
  te = Grants["Hybrid Battlemind Implements"] = new RulesElement({
  ...
  te = Grants["Hybrid Cleric"] = new RulesElement({
    name: "Hybrid Cleric",
    type: "Grants",
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_FMP_CLASS_FEATURE_1527"]);
      model.grant(elements.id["ID_INTERNAL_GRANTS_HYBRID_CLERIC_IMPLEMENTS"]);
    }
  });
  byID[te.id] = te;
  
  te = Grants["Hybrid Cleric Implements"] = new RulesElement({
  ...
  te = Grants["Hybrid Druid"] = new RulesElement({
    name: "Hybrid Druid",
    type: "Grants",
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_COUNTSASCLASS_DRUID"]);
      // unsupported rule: cbimporter.Rules.SuggestRule
      // unsupported rule: cbimporter.Rules.SuggestRule
      // unsupported rule: cbimporter.Rules.SuggestRule
      ...
      model.grant(elements.id["ID_INTERNAL_GRANTS_HYBRID_DRUID_IMPLEMENTS"]);
    }
  });
  byID[te.id] = te;
  
  te = Grants["Hybrid Druid Implements"] = new RulesElement({
  ...
  te = Grants["Hybrid Fighter"] = new RulesElement({
    name: "Hybrid Fighter",
    type: "Grants",
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_INTERNAL_PROFICIENCY_SIMPLE_RANGED"]);
      model.grant(elements.id["ID_INTERNAL_PROFICIENCY_MILITARY_RANGED"]);
      model.grant(elements.id["ID_FMP_CLASS_FEATURE_1528"]);
      model.grant(elements.id["ID_INTERNAL_GRANTS_HYBRID_FIGHTER_IMPLEMENTS"]);
    }
  });
  byID[te.id] = te;
  
  te = Grants["Hybrid Fighter Implements"] = new RulesElement({
  ...
  te = Grants["Hybrid Invoker"] = new RulesElement({
    name: "Hybrid Invoker",
    type: "Grants",
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_INTERNAL_PROFICIENCY_SIMPLE_MELEE"]);
      model.grant(elements.id["ID_INTERNAL_PROFICIENCY_SIMPLE_RANGED"]);
      model.grant(elements.id["ID_FMP_CLASS_FEATURE_1512"]);
      model.grant(elements.id["ID_INTERNAL_GRANTS_HYBRID_INVOKER_IMPLEMENTS"]);
    }
  });
  byID[te.id] = te;
  
  te = Grants["Hybrid Invoker Implements"] = new RulesElement({
  ...
  te = Grants["Hybrid Monk"] = new RulesElement({
    name: "Hybrid Monk",
    type: "Grants",
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_FMP_CLASS_FEATURE_2413"]);
      model.grant(elements.id["ID_INTERNAL_INTERNAL_KI_FOCUS_USER"]);
      model.grant(elements.id["ID_INTERNAL_GRANTS_HYBRID_MONK_IMPLEMENTS"]);
    }
  });
  byID[te.id] = te;
  
  te = Grants["Hybrid Monk Implements"] = new RulesElement({
  ...
  te = Grants["Hybrid Paladin"] = new RulesElement({
    name: "Hybrid Paladin",
    type: "Grants",
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_INTERNAL_PROFICIENCY_MILITARY_MELEE"]);
      model.grant(elements.id["ID_INTERNAL_PROFICIENCY_SIMPLE_RANGED"]);
      model.grant(elements.id["ID_FMP_CLASS_FEATURE_1529"]);
      model.grant(elements.id["ID_INTERNAL_GRANTS_HYBRID_PALADIN_IMPLEMENTS"]);
    }
  });
  byID[te.id] = te;
  
  te = Grants["Hybrid Paladin Implements"] = new RulesElement({
  ...
  te = Grants["Hybrid Psion"] = new RulesElement({
    name: "Hybrid Psion",
    type: "Grants",
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_INTERNAL_PROFICIENCY_SIMPLE_MELEE"]);
      model.grant(elements.id["ID_INTERNAL_PROFICIENCY_SIMPLE_RANGED"]);
      model.grant(elements.id["ID_FMP_CLASS_FEATURE_2415"]);
      model.grant(elements.id["ID_FMP_CLASS_FEATURE_2340"]);
      model.grant(elements.id["ID_INTERNAL_GRANTS_HYBRID_PSION_IMPLEMENTS"]);
    }
  });
  byID[te.id] = te;
  
  te = Grants["Hybrid Psion Implements"] = new RulesElement({
  ...
  te = Grants["Hybrid Ranger"] = new RulesElement({
    name: "Hybrid Ranger",
    type: "Grants",
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_INTERNAL_PROFICIENCY_SIMPLE_RANGED"]);
      model.grant(elements.id["ID_INTERNAL_PROFICIENCY_MILITARY_RANGED"]);
      model.grant(elements.id["ID_FMP_CLASS_FEATURE_1530"]);
      model.grant(elements.id["ID_INTERNAL_GRANTS_HYBRID_RANGER_IMPLEMENTS"]);
    }
  });
  byID[te.id] = te;
  
  te = Grants["Hybrid Ranger Implements"] = new RulesElement({
  ...
  te = Grants["Hybrid Rogue"] = new RulesElement({
    name: "Hybrid Rogue",
    type: "Grants",
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_INTERNAL_PROFICIENCY_WEAPON_PROFICIENCY_(SHURIKEN)"]);
      model.grant(elements.id["ID_INTERNAL_PROFICIENCY_WEAPON_PROFICIENCY_(SLING)"]);
      model.grant(elements.id["ID_FMP_CLASS_FEATURE_1531"]);
      model.grant(elements.id["ID_INTERNAL_GRANTS_HYBRID_ROGUE_IMPLEMENTS"]);
    }
  });
  byID[te.id] = te;
  
  te = Grants["Hybrid Rogue Implements"] = new RulesElement({
  ...
  te = Grants["Hybrid Runepriest"] = new RulesElement({
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_INTERNAL_PROFICIENCY_SIMPLE_MELEE"]);
      model.grant(elements.id["ID_INTERNAL_PROFICIENCY_SIMPLE_RANGED"]);
      model.grant(elements.id["ID_FMP_CLASS_FEATURE_2417"]);
      model.grant(elements.id["ID_FMP_CLASS_FEATURE_2388"]);
      model.grant(elements.id["ID_INTERNAL_GRANTS_HYBRID_RUNEPRIEST_IMPLEMENTS"]);
    }
  });
  byID[te.id] = te;
  
  te = Grants["Hybrid Runepriest Implements"] = new RulesElement({
  ...
  te = Grants["Hybrid Seeker"] = new RulesElement({
    name: "Hybrid Seeker",
    type: "Grants",
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_INTERNAL_PROFICIENCY_SIMPLE_RANGED"]);
      model.grant(elements.id["ID_INTERNAL_PROFICIENCY_MILITARY_RANGED"]);
      model.grant(elements.id["ID_FMP_CLASS_FEATURE_2419"]);
      model.grant(elements.id["ID_FMP_CLASS_FEATURE_2420"]);
      model.grant(elements.id["ID_INTERNAL_GRANTS_HYBRID_SEEKER_IMPLEMENTS"]);
    }
  });
  byID[te.id] = te;
  
  te = Grants["Hybrid Seeker Implements"] = new RulesElement({
  ...
  te = Grants["Hybrid Shaman"] = new RulesElement({
    name: "Hybrid Shaman",
    type: "Grants",
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_COUNTSASCLASS_SHAMAN"]);
      // unsupported rule: cbimporter.Rules.SuggestRule
      // unsupported rule: cbimporter.Rules.SuggestRule
      // unsupported rule: cbimporter.Rules.SuggestRule
      model.grant(elements.id["ID_FMP_ROLE_2"]);
      ...
      model.grant(elements.id["ID_FMP_CLASS_FEATURE_1837"]);
      model.grant(elements.id["ID_FMP_CLASS_FEATURE_1838"]);
      model.grant(elements.id["ID_FMP_CLASS_FEATURE_857"]);
      model.grant(elements.id["ID_INTERNAL_GRANTS_HYBRID_SHAMAN_IMPLEMENTS"]);
    }
  });
  byID[te.id] = te;
  
  te = Grants["Hybrid Shaman Implements"] = new RulesElement({
  ...
  te = Grants["Hybrid Sorcerer"] = new RulesElement({
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_INTERNAL_PROFICIENCY_SIMPLE_MELEE"]);
      model.grant(elements.id["ID_INTERNAL_PROFICIENCY_SIMPLE_RANGED"]);
      model.grant(elements.id["ID_FMP_CLASS_FEATURE_1840"]);
      model.grant(elements.id["ID_INTERNAL_GRANTS_HYBRID_SORCERER_IMPLEMENTS"]);
    }
  });
  byID[te.id] = te;
  
  te = Grants["Hybrid Sorcerer Implements"] = new RulesElement({
  ...
  te = Grants["Hybrid Swordmage"] = new RulesElement({
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_FMP_CLASS_FEATURE_1532"]);
      model.grant(elements.id["ID_INTERNAL_GRANTS_HYBRID_SWORDMAGE_IMPLEMENTS"]);
    }
  });
  byID[te.id] = te;
  
  te = Grants["Hybrid Swordmage Implements"] = new RulesElement({
  ...
  te = Grants["Hybrid Warden"] = new RulesElement({
    name: "Hybrid Warden",
    type: "Grants",
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_COUNTSASCLASS_WARDEN"]);
      // unsupported rule: cbimporter.Rules.SuggestRule
      // unsupported rule: cbimporter.Rules.SuggestRule
      // unsupported rule: cbimporter.Rules.SuggestRule
      model.grant(elements.id["ID_FMP_ROLE_4"]);
      ...
      model.grant(elements.id["ID_INTERNAL_PROFICIENCY_MILITARY_MELEE"]);
      model.grant(elements.id["ID_INTERNAL_PROFICIENCY_SIMPLE_RANGED"]);
      model.grant(elements.id["ID_FMP_CLASS_FEATURE_1842"]);
      model.grant(elements.id["ID_INTERNAL_GRANTS_HYBRID_WARDEN_IMPLEMENTS"]);
    }
  });
  byID[te.id] = te;
  
  te = Grants["Hybrid Warden Implements"] = new RulesElement({
  ...
  te = Grants["Hybrid Warlock"] = new RulesElement({
    name: "Hybrid Warlock",
    type: "Grants",
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_INTERNAL_PROFICIENCY_SIMPLE_MELEE"]);
      model.grant(elements.id["ID_INTERNAL_PROFICIENCY_SIMPLE_RANGED"]);
      model.grant(elements.id["ID_FMP_CLASS_FEATURE_1844"]);
      model.grant(elements.id["ID_FMP_CLASS_FEATURE_1533"]);
      model.grant(elements.id["ID_INTERNAL_GRANTS_HYBRID_WARLOCK_IMPLEMENTS"]);
    }
  });
  byID[te.id] = te;
  
  te = Grants["Hybrid Warlock Implements"] = new RulesElement({
  ...
  te = Grants["Hybrid Warlord"] = new RulesElement({
    name: "Hybrid Warlord",
    type: "Grants",
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_INTERNAL_PROFICIENCY_MILITARY_MELEE"]);
      model.grant(elements.id["ID_INTERNAL_PROFICIENCY_SIMPLE_RANGED"]);
      model.grant(elements.id["ID_FMP_CLASS_FEATURE_1534"]);
      model.grant(elements.id["ID_FMP_CLASS_FEATURE_2427"]);
      model.grant(elements.id["ID_INTERNAL_GRANTS_HYBRID_WARLORD_IMPLEMENTS"]);
    }
  });
  byID[te.id] = te;
  
  te = Grants["Hybrid Warlord Implements"] = new RulesElement({
  ...
  te = Grants["Hybrid Wizard"] = new RulesElement({
    name: "Hybrid Wizard",
    type: "Grants",
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_INTERNAL_GRANTS_HYBRID_WIZARD_IMPLEMENTS"]);
    }
  });
  byID[te.id] = te;
  
  te = Grants["Hybrid Wizard Implements"] = new RulesElement({
  ...
  te = Grants["Minotaur"] = new RulesElement({
    name: "Minotaur",
    type: "Grants",
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_SIZE_MEDIUM"]);
      model.grant(elements.id["ID_INTERNAL_VISION_NORMAL"]);
      model.grant(elements.id["ID_FMP_RACIAL_TRAIT_411"]);
      model.grant(elements.id["ID_FMP_RACIAL_TRAIT_412"]);
      model.grant(elements.id["ID_FMP_RACIAL_TRAIT_1092"]);
      model.grant(elements.id["ID_FMP_RACIAL_TRAIT_2525"]);
  ...
  te = Grants["Monk"] = new RulesElement({
    name: "Monk",
    type: "Grants",
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_INTERNAL_PROFICIENCY_WEAPON_PROFICIENCY_(SLING)"]);
      model.grant(elements.id["ID_INTERNAL_PROFICIENCY_WEAPON_PROFICIENCY_(SPEAR)"]);
      model.grant(elements.id["ID_FMP_CLASS_FEATURE_1543"]);
      model.grant(elements.id["ID_FMP_CLASS_FEATURE_1547"]);
      model.grant(elements.id["ID_FMP_CLASS_FEATURE_1548"]);
      model.grant(elements.id["ID_INTERNAL_INTERNAL_KI_FOCUS_USER"]);
  ...
  te = Grants["Monk Implements"] = new RulesElement({
  ...
  te = Grants["Psion"] = new RulesElement({
    name: "Psion",
    type: "Grants",
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_INTERNAL_PROFICIENCY_SIMPLE_MELEE"]);
      model.grant(elements.id["ID_INTERNAL_PROFICIENCY_SIMPLE_RANGED"]);
      model.grant(elements.id["ID_FMP_CLASS_FEATURE_1810"]);
      model.grant(elements.id["ID_FMP_CLASS_FEATURE_1812"]);
  ...
  te = Grants["Psion Implements"] = new RulesElement({
  ...
  te = Grants["Runepriest"] = new RulesElement({
    name: "Runepriest",
    type: "Grants",
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_INTERNAL_PROFICIENCY_SIMPLE_MELEE"]);
      model.grant(elements.id["ID_INTERNAL_PROFICIENCY_SIMPLE_RANGED"]);
      model.grant(elements.id["ID_FMP_CLASS_FEATURE_2384"]);
      model.grant(elements.id["ID_FMP_CLASS_FEATURE_2387"]);
      model.grant(elements.id["ID_FMP_CLASS_FEATURE_2388"]);
      model.grant(elements.id["ID_INTERNAL_SKILL_TRAINING_RELIGION"]);
      model.grant(elements.id["ID_INTERNAL_GRANTS_RUNEPRIEST_IMPLEMENTS"]);
    }
  });
  byID[te.id] = te;
  
  te = Grants["Runepriest Implements"] = new RulesElement({
  ...
  te = Grants["Seeker"] = new RulesElement({
    name: "Seeker",
    type: "Grants",
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_INTERNAL_PROFICIENCY_SIMPLE_RANGED"]);
      model.grant(elements.id["ID_INTERNAL_PROFICIENCY_MILITARY_RANGED"]);
      model.grant(elements.id["ID_FMP_CLASS_FEATURE_1943"]);
      model.grant(elements.id["ID_FMP_CLASS_FEATURE_1944"]);
      model.grant(elements.id["ID_INTERNAL_SKILL_TRAINING_NATURE"]);
      model.grant(elements.id["ID_INTERNAL_GRANTS_SEEKER_IMPLEMENTS"]);
    }
  });
  byID[te.id] = te;
  
  te = Grants["Seeker Implements"] = new RulesElement({
  ...
  te = Grants["Shardmind"] = new RulesElement({
    name: "Shardmind",
    type: "Grants",
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_SIZE_MEDIUM"]);
      model.grant(elements.id["ID_INTERNAL_VISION_NORMAL"]);
      model.grant(elements.id["ID_FMP_RACIAL_TRAIT_2326"]);
      model.grant(elements.id["ID_FMP_RACIAL_TRAIT_2327"]);
      model.grant(elements.id["ID_FMP_RACIAL_TRAIT_406"]);
      model.grant(elements.id["ID_FMP_RACIAL_TRAIT_1139"]);
      model.grant(elements.id["ID_FMP_RACIAL_TRAIT_2328"]);
  ...
  te = Grants["Wilden"] = new RulesElement({
    name: "Wilden",
    type: "Grants",
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_FMP_RACIAL_TRAIT_1538"]);
      model.grant(elements.id["ID_FMP_RACIAL_TRAIT_1539"]);
      model.grant(elements.id["ID_INTERNAL_RACE_ABILITY_BONUS_WISDOM"]);
      model.grant(elements.id["ID_FMP_LANGUAGE_1"]);
