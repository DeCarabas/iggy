(function(global, undefined) {
  ...
  te = class_feature["Accurate Arrow"] = new RulesElement({
    name: "Accurate Arrow",
    type: "class feature",
  ...
  te = class_feature["Adaptive Action"] = new RulesElement({
  ...
  te = class_feature["Aggressive Resurgence"] = new RulesElement({
  ...
  te = class_feature["All-Seeing Eye"] = new RulesElement({
    name: "All-Seeing Eye",
    type: "class feature",
  ...
  te = class_feature["Anticipatory Action"] = new RulesElement({
  ...
  te = class_feature["Archer Fighting Style (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_ARCHER_FIGHTING_STYLE"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Ardent Armor Proficiency"] = new RulesElement({
  ...
  te = class_feature["Ardent Mantle"] = new RulesElement({
    name: "Ardent Mantle",
    type: "class feature",
  ...
  te = class_feature["Ardent Mantle (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_ARDENT_MANTLE"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Ardent Surge"] = new RulesElement({
    name: "Ardent Surge",
    type: "class feature",
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_10273"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Ardent Surge (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_ARDENT_SURGE"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Argent Devastation"] = new RulesElement({
  ...
  te = class_feature["Artful Dodger (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_ARTFUL_DODGER"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Avalanche Flurry"] = new RulesElement({
  ...
  te = class_feature["Avenger's Censure (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_AVENGER'S_CENSURE"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Avenging Action"] = new RulesElement({
  ...
  te = class_feature["Barbarian Armored Agility"] = new RulesElement({
  ...
  te = class_feature["Bard Armor Proficiency"] = new RulesElement({
  ...
  te = class_feature["Battle Instinct"] = new RulesElement({
  ...
  te = class_feature["Battle Resilience"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_11155"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Battle Resilience (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_11155"]);
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_BATTLE_RESILIENCE"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Battle Sovereignty"] = new RulesElement({
  ...
  te = class_feature["Battlefront Leader (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_FMP_POWER_10887"]);
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_BATTLEFRONT_LEADER"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Battlemind Armor Proficiency"] = new RulesElement({
  ...
  te = class_feature["Battlerager Vigor (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_BATTLERAGER_VIGOR"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Beast Mastery (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_CLASS_FEATURE_1030"]);
      ...
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_BEAST_MASTERY"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Beguiling Advantage"] = new RulesElement({
  ...
  te = class_feature["Blade Guide"] = new RulesElement({
    name: "Blade Guide",
    type: "class feature",
  ...
  te = class_feature["Bloodbond"] = new RulesElement({
    name: "Bloodbond",
    type: "class feature",
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_9500"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Bloodbond (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_9500"]);
      // unsupported rule: cbimporter.Rules.ModifyRule
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_BLOODBOND"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Bloodied Aspect"] = new RulesElement({
  ...
  te = class_feature["Bloodied Vigor"] = new RulesElement({
    name: "Bloodied Vigor",
    type: "class feature",
  ...
  te = class_feature["Bloody Vengeance"] = new RulesElement({
  ...
  te = class_feature["Borrow from the Future"] = new RulesElement({
  ...
  te = class_feature["Boundless Morale"] = new RulesElement({
  ...
  te = class_feature["Bravura Presence (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_BRAVURA_PRESENCE"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Brawler Style (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_BRAWLER_STYLE"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Brutal Arrows"] = new RulesElement({
    name: "Brutal Arrows",
    type: "class feature",
  ...
  te = class_feature["Brutal Scoundrel (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_BRUTAL_SCOUNDREL"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Canny Leader (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_CANNY_LEADER"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Centered Breath"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_7448"]);
      // unsupported rule: cbimporter.Rules.ModifyRule
  ...
  te = class_feature["Centered Breath (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_7448"]);
      // unsupported rule: cbimporter.Rules.ModifyRule
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_CENTERED_BREATH"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Cerulean Action"] = new RulesElement({
  ...
  te = class_feature["Cerulean Sign Focus"] = new RulesElement({
  ...
  te = class_feature["Channel Divinity - Radiant Fist"] = new RulesElement({
  ...
  te = class_feature["Channel Divinity (Hybrid Avenger)"] = new RulesElement({
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_CHANNEL_DIVINITY"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Channel Divinity (Hybrid Cleric)"] = new RulesElement({
  ...
  te = class_feature["Channel Divinity (Hybrid Invoker)"] = new RulesElement({
  ...
  te = class_feature["Channel Divinity (Hybrid Paladin)"] = new RulesElement({
  ...
  te = class_feature["Claws of the Dragon"] = new RulesElement({
  ...
  te = class_feature["Cleric Armor Proficiency"] = new RulesElement({
  ...
  te = class_feature["Combat Agility (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_10469"]);
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_COMBAT_AGILITY"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Combat Challenge (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_COMBAT_CHALLENGE"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Combat Leader (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_COMBAT_LEADER"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Combat Specialty"] = new RulesElement({
  ...
  te = class_feature["Combat Superiority (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_COMBAT_SUPERIORITY"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Commanding Presence (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_COMMANDING_PRESENCE"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Companion Spirit (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_COMPANION_SPIRIT"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Constant Jailer"] = new RulesElement({
  ...
  te = class_feature["Constant Swarm"] = new RulesElement({
    name: "Constant Swarm",
    type: "class feature",
  ...
  te = class_feature["Covenant Manifestation"] = new RulesElement({
  ...
  te = class_feature["Crimson Hunter's Action"] = new RulesElement({
  ...
  te = class_feature["Crushing Walls"] = new RulesElement({
    name: "Crushing Walls",
    type: "class feature",
  ...
  te = class_feature["Cunning Sneak (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_CUNNING_SNEAK"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Dark Pact (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_DARK_PACT"]);
      model.grant(elements.id["ID_INTERNAL_INTERNAL_MATCHED_WARLOCK_PACT"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Death Arrows"] = new RulesElement({
    name: "Death Arrows",
    type: "class feature",
  ...
  te = class_feature["Deathless Hunter"] = new RulesElement({
  ...
  te = class_feature["Defensive Shift"] = new RulesElement({
  ...
  te = class_feature["Defiant Word"] = new RulesElement({
    name: "Defiant Word",
    type: "class feature",
  ...
  te = class_feature["Demanding Action"] = new RulesElement({
  ...
  te = class_feature["Diamond Body"] = new RulesElement({
    name: "Diamond Body",
    type: "class feature",
  ...
  te = class_feature["Diamond Perfection"] = new RulesElement({
  ...
  te = class_feature["Discarnate Form"] = new RulesElement({
  ...
  te = class_feature["Discipline Focus"] = new RulesElement({
  ...
  te = class_feature["Discipline Focus (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_DISCIPLINE_FOCUS"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Divine Challenge (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      ...
      // unsupported rule: cbimporter.Rules.ModifyRule
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_DIVINE_CHALLENGE"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Dragon's Action"] = new RulesElement({
  ...
  te = class_feature["Dreaming Advantage"] = new RulesElement({
  ...
  te = class_feature["Dreaming Manifestation"] = new RulesElement({
  ...
  te = class_feature["Druid Armor Proficiency"] = new RulesElement({
  ...
  te = class_feature["Eldritch Pact (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_ELDRITCH_PACT"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Escaping Action"] = new RulesElement({
  ...
  te = class_feature["Eternal Warrior"] = new RulesElement({
  ...
  te = class_feature["Expanded Discipline Focus"] = new RulesElement({
  ...
  te = class_feature["Expanded Tradition"] = new RulesElement({
  ...
  te = class_feature["Faultless Tracker"] = new RulesElement({
  ...
  te = class_feature["Fearsome Zone"] = new RulesElement({
    name: "Fearsome Zone",
    type: "class feature",
  ...
  te = class_feature["Fey Pact (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_FEY_PACT"]);
      model.grant(elements.id["ID_INTERNAL_INTERNAL_MATCHED_WARLOCK_PACT"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Fighter Armor Proficiency"] = new RulesElement({
  ...
  te = class_feature["Fighter Combat Talent"] = new RulesElement({
  ...
  te = class_feature["Fleeing Fear"] = new RulesElement({
    name: "Fleeing Fear",
    type: "class feature",
  ...
  te = class_feature["Flicker into Nothing"] = new RulesElement({
  ...
  te = class_feature["Forge Rune Action"] = new RulesElement({
  ...
  te = class_feature["Ghostwalker's Action"] = new RulesElement({
  ...
  te = class_feature["Guardian Shield"] = new RulesElement({
  ...
  te = class_feature["Guarding Shot"] = new RulesElement({
    name: "Guarding Shot",
    type: "class feature",
  ...
  te = class_feature["Guided Action"] = new RulesElement({
    name: "Guided Action",
    type: "class feature",
  ...
  te = class_feature["Healing Infusion (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_FMP_POWER_7635"]);
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_HEALING_INFUSION"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Healing Spirit (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      ...
      // unsupported rule: cbimporter.Rules.ModifyRule
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_HEALING_SPIRIT"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Healing Word (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      ...
      // unsupported rule: cbimporter.Rules.ModifyRule
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_HEALING_WORD"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Holy Radiance"] = new RulesElement({
    name: "Holy Radiance",
    type: "class feature",
  ...
  te = class_feature["Hunter Fighting Style (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_FEAT_157"]);
      model.statadd("AC", function() { /* against opportunity attacks you provoke by making a ranged attack */ return 4; });
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_HUNTER_FIGHTING_STYLE"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Hunter's Quarry (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      ...
      model.statadd("Hunter's Quarry Dice", 1);
      model.statadd("Hunter's Quarry Dice", 1);
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_HUNTER'S_QUARRY"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Hybrid Encounter Power"] = new RulesElement({
  ...
  te = class_feature["Hybrid Power Point Option"] = new RulesElement({
  ...
  te = class_feature["Impenetrable Iron"] = new RulesElement({
  ...
  te = class_feature["Imprisoning Action"] = new RulesElement({
  ...
  te = class_feature["Indomitable Iron"] = new RulesElement({
  ...
  te = class_feature["Indomitable Steel"] = new RulesElement({
  ...
  te = class_feature["Inescapable Vengeance"] = new RulesElement({
  ...
  te = class_feature["Inevitable Shot"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_9501"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Inevitable Shot (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_FMP_POWER_9501"]);
      // unsupported rule: cbimporter.Rules.ModifyRule
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_INEVITABLE_SHOT"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Inexorable Mountain's Action"] = new RulesElement({
  ...
  te = class_feature["Infernal Pact (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_INFERNAL_PACT"]);
      model.grant(elements.id["ID_INTERNAL_INTERNAL_MATCHED_WARLOCK_PACT"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Insightful Presence (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_INSIGHTFUL_PRESENCE"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Inspiring Presence (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_INSPIRING_PRESENCE"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Inspiring Word (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      ...
      // unsupported rule: cbimporter.Rules.ModifyRule
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_INSPIRING_WORD"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Invigorating Light"] = new RulesElement({
  ...
  te = class_feature["Invincible"] = new RulesElement({
    name: "Invincible",
    type: "class feature",
  ...
  te = class_feature["Invoker Armor proficiency"] = new RulesElement({
  ...
  te = class_feature["Iron Control"] = new RulesElement({
    name: "Iron Control",
    type: "class feature",
  ...
  te = class_feature["Keen Missile"] = new RulesElement({
    name: "Keen Missile",
    type: "class feature",
  ...
  te = class_feature["Lay Bare the Mind"] = new RulesElement({
  ...
  te = class_feature["Loan from the Past"] = new RulesElement({
  ...
  te = class_feature["Lord of All Runes"] = new RulesElement({
  ...
  te = class_feature["Majestic Word (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      ...
      // unsupported rule: cbimporter.Rules.ModifyRule
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_MAJESTIC_WORD"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Manifest Dream Form"] = new RulesElement({
  ...
  te = class_feature["Manifestation of Malediction"] = new RulesElement({
  ...
  te = class_feature["Manifestation of Preservation"] = new RulesElement({
  ...
  te = class_feature["Manifestation of Wrath"] = new RulesElement({
  ...
  te = class_feature["Mantle of Clarity"] = new RulesElement({
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_FMP_POWER_10272"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Mantle of Clarity (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_MANTLE_OF_CLARITY"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Mantle of Elation"] = new RulesElement({
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_FMP_POWER_11060"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Mantle of Elation (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      model.statadd("damage rolls", function() { /* on opportunity attacks */ return model.stat("Constitution modifier"); });
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_MANTLE_OF_ELATION"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Mantle Power"] = new RulesElement({
    name: "Mantle Power",
    type: "class feature",
  ...
  te = class_feature["Marauder Fighting Style (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_FEAT_172"]);
      ...
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_MARAUDER_FIGHTING_STYLE"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Mighty Guardian"] = new RulesElement({
  ...
  te = class_feature["Mind Smash"] = new RulesElement({
    name: "Mind Smash",
    type: "class feature",
  ...
  te = class_feature["Misty Step"] = new RulesElement({
    name: "Misty Step",
    type: "class feature",
  ...
  te = class_feature["Monastic Perfection"] = new RulesElement({
  ...
  te = class_feature["Monastic Tradition"] = new RulesElement({
  ...
  te = class_feature["Monastic Tradition (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_MONASTIC_TRADITION"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Moving Perfection"] = new RulesElement({
  ...
  te = class_feature["Nature's Wrath (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_NATURE'S_WRATH"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Never Say Die"] = new RulesElement({
    name: "Never Say Die",
    type: "class feature",
  ...
  te = class_feature["Oath of Enmity (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_FMP_POWER_3069"]);
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_OATH_OF_ENMITY"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Of Two Worlds"] = new RulesElement({
    name: "Of Two Worlds",
    type: "class feature",
  ...
  te = class_feature["One-handed Weapon Talent (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_ONE-HANDED_WEAPON_TALENT"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Opportunity Shot"] = new RulesElement({
  ...
  te = class_feature["Paladin Armor Proficiency"] = new RulesElement({
  ...
  te = class_feature["Paragon Power Points"] = new RulesElement({
  ...
  te = class_feature["Perfect Shard Swarm"] = new RulesElement({
  ...
  te = class_feature["Pinning Action"] = new RulesElement({
    name: "Pinning Action",
    type: "class feature",
  ...
  te = class_feature["Preternatural Instinct"] = new RulesElement({
  ...
  te = class_feature["Prime Shot (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_PRIME_SHOT"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Protective Action"] = new RulesElement({
  ...
  te = class_feature["Protector Spirit (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_PROTECTOR_SPIRIT"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Psionic Augmentation"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_INTERNAL_AUGMENT_POWERS"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Psionic Augmentation (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_INTERNAL_PSIONIC_AUGMENTATION_DECIDER"]);
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_PSIONIC_AUGMENTATION"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Psionic Cascade"] = new RulesElement({
  ...
  te = class_feature["Psionic Defense"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_10438"]);
      model.grant(elements.id["ID_FMP_POWER_10439"]);
      model.grant(elements.id["ID_FMP_POWER_10440"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Psionic Defense (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_PSIONIC_DEFENSE"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Psionic Study"] = new RulesElement({
    name: "Psionic Study",
    type: "class feature",
  ...
  te = class_feature["Psionic Study (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_PSIONIC_STUDY"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Psychic Resistance"] = new RulesElement({
  ...
  te = class_feature["Radiant Fist's Action"] = new RulesElement({
  ...
  te = class_feature["Radiant Hammer Fists"] = new RulesElement({
  ...
  te = class_feature["Ranger Armor Proficiency"] = new RulesElement({
  ...
  te = class_feature["Ranger Combat Talent"] = new RulesElement({
  ...
  te = class_feature["Ranger Fighting Style"] = new RulesElement({
  ...
  te = class_feature["Rattling Arrows"] = new RulesElement({
  ...
  te = class_feature["Reinvigorating Attack"] = new RulesElement({
  ...
  te = class_feature["Relentless Hunter"] = new RulesElement({
  ...
  te = class_feature["Resourceful Presence (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_RESOURCEFUL_PRESENCE"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Restoring Critical"] = new RulesElement({
  ...
  te = class_feature["Ride the Spirit"] = new RulesElement({
  ...
  te = class_feature["Rogue Combat Talent"] = new RulesElement({
  ...
  te = class_feature["Rogue Tactics (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_ROGUE_TACTICS"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Rogue Weapon Talent (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_ROGUE_WEAPON_TALENT"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Rune Master"] = new RulesElement({
    name: "Rune Master",
    type: "class feature",
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_CLASS_FEATURE_2385"]);
      model.grant(elements.id["ID_FMP_CLASS_FEATURE_2386"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Rune of Destruction"] = new RulesElement({
  ...
  te = class_feature["Rune of Immortality"] = new RulesElement({
  ...
  te = class_feature["Rune of Mending"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_11353"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Rune of Mending (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_11353"]);
      // unsupported rule: cbimporter.Rules.ModifyRule
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_RUNE_OF_MENDING"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Rune of Might"] = new RulesElement({
    name: "Rune of Might",
    type: "class feature",
  ...
  te = class_feature["Rune of Protection"] = new RulesElement({
  ...
  te = class_feature["Runepriest Armor Proficiency"] = new RulesElement({
  ...
  te = class_feature["Runes of the Blade Smith"] = new RulesElement({
  ...
  te = class_feature["Runic Artistry"] = new RulesElement({
    name: "Runic Artistry",
    type: "class feature",
  ...
  te = class_feature["Running Attack (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_RUNNING_ATTACK"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Ruthless Ruffian (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_RUTHLESS_RUFFIAN"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Seeker's Bond"] = new RulesElement({
    name: "Seeker's Bond",
    type: "class feature",
  ...
  te = class_feature["Seeker's Bond (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_SEEKER'S_BOND"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Sharpshooter Talent (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_FMP_FEAT_139"]);
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_SHARPSHOOTER_TALENT"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Shattering Fists"] = new RulesElement({
  ...
  te = class_feature["Skirmishing Presence (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_SKIRMISHING_PRESENCE"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Sneak Attack (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      ...
      model.statadd("Sneak Attack Dice", 2);
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_SNEAK_ATTACK"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Sorcerous Power"] = new RulesElement({
  ...
  te = class_feature["Sorcerous Power Dexterity"] = new RulesElement({
  ...
  te = class_feature["Sorcerous Power Strength"] = new RulesElement({
  ...
  te = class_feature["Soul of the Sorcerer"] = new RulesElement({
  ...
  te = class_feature["Speed of the Wind"] = new RulesElement({
  ...
  te = class_feature["Speed of Thought"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_10441"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Speed of Thought (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_10441"]);
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_SPEED_OF_THOUGHT"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Spirit Boon (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_SPIRIT_BOON"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Spiritbond"] = new RulesElement({
    name: "Spiritbond",
    type: "class feature",
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_11462"]);
  ...
  te = class_feature["Spiritbond (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_11462"]);
      // unsupported rule: cbimporter.Rules.ModifyRule
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_SPIRITBOND"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Spirit's Power"] = new RulesElement({
    name: "Spirit's Power",
    type: "class feature",
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_FMP_POWER_9732"]);
      model.grant(elements.id["ID_FMP_POWER_9733"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Stalker Spirit (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_STALKER_SPIRIT"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Star Pact (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_STAR_PACT"]);
      model.grant(elements.id["ID_INTERNAL_INTERNAL_MATCHED_WARLOCK_PACT"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Startling Insight"] = new RulesElement({
  ...
  te = class_feature["Stone Fist"] = new RulesElement({
    name: "Stone Fist",
    type: "class feature",
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_11207"]);
      // unsupported rule: cbimporter.Rules.ModifyRule
  ...
  te = class_feature["Stone Fist (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_11207"]);
      // unsupported rule: cbimporter.Rules.ModifyRule
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_STONE_FIST"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Strength of the Dragon"] = new RulesElement({
  ...
  te = class_feature["Swarm Action"] = new RulesElement({
    name: "Swarm Action",
    type: "class feature",
  ...
  te = class_feature["Swift Stride Assault"] = new RulesElement({
  ...
  te = class_feature["Swordmage Aegis (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      ...
      // unsupported rule: cbimporter.Rules.ModifyRule
      // unsupported rule: cbimporter.Rules.ModifyRule
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_SWORDMAGE_AEGIS"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Tactical Presence (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_TACTICAL_PRESENCE"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Tactician's Surge"] = new RulesElement({
  ...
  te = class_feature["Telekinesis Focus"] = new RulesElement({
  ...
  te = class_feature["Telekinesis Focus (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_11267"]);
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_TELEKINESIS_FOCUS"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Telepathy Focus"] = new RulesElement({
  ...
  te = class_feature["Telepathy Focus (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_FMP_POWER_8225"]);
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_TELEPATHY_FOCUS"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Tempest Technique (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_TEMPEST_TECHNIQUE"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Time-Lapse"] = new RulesElement({
    name: "Time-Lapse",
    type: "class feature",
  ...
  te = class_feature["True Seeker's Bond"] = new RulesElement({
  ...
  te = class_feature["Twelve Runes of the Sun"] = new RulesElement({
  ...
  te = class_feature["Two-Blade Fighting Style (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_TWO-BLADE_FIGHTING_STYLE"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Two-handed Weapon Talent (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_TWO-HANDED_WEAPON_TALENT"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Unarmed Combatant"] = new RulesElement({
  ...
  te = class_feature["Unarmored Defense"] = new RulesElement({
  ...
  te = class_feature["Undeniable Light"] = new RulesElement({
  ...
  te = class_feature["Unfettered Action"] = new RulesElement({
  ...
  te = class_feature["Unmatched Tactician"] = new RulesElement({
  ...
  te = class_feature["Unraveling Action"] = new RulesElement({
  ...
  te = class_feature["Unyielding Inspiration"] = new RulesElement({
  ...
  te = class_feature["Versatile Expertise (Axe)"] = new RulesElement({
  ...
  te = class_feature["Versatile Expertise (Blowgun)"] = new RulesElement({
  ...
  te = class_feature["Versatile Expertise (Bow)"] = new RulesElement({
  ...
  te = class_feature["Versatile Expertise (Crossbow)"] = new RulesElement({
  ...
  te = class_feature["Versatile Expertise (Flail)"] = new RulesElement({
  ...
  te = class_feature["Versatile Expertise (Garrote)"] = new RulesElement({
  ...
  te = class_feature["Versatile Expertise (Hammer)"] = new RulesElement({
  ...
  te = class_feature["Versatile Expertise (Heavy Blade)"] = new RulesElement({
  ...
  te = class_feature["Versatile Expertise (Holy Symbol)"] = new RulesElement({
  ...
  te = class_feature["Versatile Expertise (Instrument)"] = new RulesElement({
  ...
  te = class_feature["Versatile Expertise (Ki Focuses)"] = new RulesElement({
  ...
  te = class_feature["Versatile Expertise (Light Blade)"] = new RulesElement({
  ...
  te = class_feature["Versatile Expertise (Mace)"] = new RulesElement({
  ...
  te = class_feature["Versatile Expertise (Orb)"] = new RulesElement({
  ...
  te = class_feature["Versatile Expertise (Pick)"] = new RulesElement({
  ...
  te = class_feature["Versatile Expertise (Polearm)"] = new RulesElement({
  ...
  te = class_feature["Versatile Expertise (Rod)"] = new RulesElement({
  ...
  te = class_feature["Versatile Expertise (Sling)"] = new RulesElement({
  ...
  te = class_feature["Versatile Expertise (Spear)"] = new RulesElement({
  ...
  te = class_feature["Versatile Expertise (Staff)"] = new RulesElement({
  ...
  te = class_feature["Versatile Expertise (Tome)"] = new RulesElement({
  ...
  te = class_feature["Versatile Expertise (Totem)"] = new RulesElement({
  ...
  te = class_feature["Versatile Expertise (Unarmed)"] = new RulesElement({
  ...
  te = class_feature["Versatile Expertise (Wand)"] = new RulesElement({
  ...
  te = class_feature["Vestige Pact (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_VESTIGE_PACT"]);
      model.grant(elements.id["ID_INTERNAL_INTERNAL_MATCHED_WARLOCK_PACT"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Vigorous Action"] = new RulesElement({
  ...
  te = class_feature["Vitalizing Action"] = new RulesElement({
  ...
  te = class_feature["Warden's Armored Might"] = new RulesElement({
  ...
  te = class_feature["Warlock Pact Boon"] = new RulesElement({
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_FMP_POWER_4311"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Warlock's Curse (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      ...
      model.statadd("Warlock's Curse Dice", 1);
      model.statadd("Warlock's Curse Dice", 1);
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_WARLOCK'S_CURSE"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Warlord Armor Proficiency"] = new RulesElement({
  ...
  te = class_feature["Warlord Leadership"] = new RulesElement({
  ...
  te = class_feature["Watcher Spirit (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_WATCHER_SPIRIT"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Wellspring of Mental Power"] = new RulesElement({
  ...
  te = class_feature["World Speaker Spirit (Hybrid)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_COUNTSASFEATURE_WORLD_SPEAKER_SPIRIT"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Wrathful Hammer"] = new RulesElement({
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_INTERNAL_PROFICIENCY_MILITARY_MACE"]);
    }
  });
  byID[te.id] = te;
  
  te = class_feature["Zephyr Action"] = new RulesElement({
    name: "Zephyr Action",
    type: "class feature",
