(function(global, undefined) {
  ...
  te = Race["Githzerai"] = new RulesElement({
    name: "Githzerai",
    type: "Race",
    id: "ID_FMP_RACE_18",
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_GRANTS_GITHZERAI"]);
  ...
  te = Race["Minotaur"] = new RulesElement({
    name: "Minotaur",
    type: "Race",
    id: "ID_FMP_RACE_24",
    source: "Player's Handbook 3",
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_GRANTS_MINOTAUR"]);
      model.statadd("Speed", 6);
  ...
  te = Race["Shardmind"] = new RulesElement({
    name: "Shardmind",
    type: "Race",
    id: "ID_FMP_RACE_49",
    source: "Player's Handbook 3",
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_GRANTS_SHARDMIND"]);
      model.statadd("Speed", 6);
  ...
  te = Race["Wilden"] = new RulesElement({
    name: "Wilden",
    type: "Race",
    id: "ID_FMP_RACE_44",
    source: "Player's Handbook 3",
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_GRANTS_WILDEN"]);
      model.statadd("Speed", 6);
