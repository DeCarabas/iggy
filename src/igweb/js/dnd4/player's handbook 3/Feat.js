(function(global, undefined) {
  ...
  te = Feat["Adamantine Mind"] = new RulesElement({
  ...
  te = Feat["Alacrity of Fortune"] = new RulesElement({
  ...
  te = Feat["Alhahn's Mindful Relocation"] = new RulesElement({
  ...
  te = Feat["Aspect of the Cultivator"] = new RulesElement({
    ...
    rules: function(model) {
      ...
      model.grant(elements.id["ID_FMP_POWER_11572"]);
    }
  });
  byID[te.id] = te;
  
  te = Feat["Awaken Aspect"] = new RulesElement({
    name: "Awaken Aspect",
    type: "Feat",
    id: "ID_FMP_FEAT_2634",
    source: "Player's Handbook 3",
  ...
  te = Feat["Battering Shield"] = new RulesElement({
  ...
  te = Feat["Battle Caster Defense"] = new RulesElement({
  ...
  te = Feat["Battle Hardened"] = new RulesElement({
  ...
  te = Feat["Beast Within"] = new RulesElement({
    name: "Beast Within",
    type: "Feat",
    id: "ID_FMP_FEAT_1064",
    source: "Player's Handbook 3",
  ...
  te = Feat["Beguiling Enchantment"] = new RulesElement({
  ...
  te = Feat["Bloodbond Wrath"] = new RulesElement({
  ...
  te = Feat["Bloodborn Recovery"] = new RulesElement({
  ...
  te = Feat["Bloodied Elusion"] = new RulesElement({
  ...
  te = Feat["Bloodied Ferocity"] = new RulesElement({
  ...
  te = Feat["Bloody Gore"] = new RulesElement({
    name: "Bloody Gore",
    type: "Feat",
    id: "ID_FMP_FEAT_1065",
    source: "Player's Handbook 3",
  ...
  te = Feat["Bolstering Mantle"] = new RulesElement({
  ...
  te = Feat["Brutal Ferocity"] = new RulesElement({
  ...
  te = Feat["Brutal Flurry"] = new RulesElement({
    name: "Brutal Flurry",
    type: "Feat",
    id: "ID_FMP_FEAT_2636",
    source: "Player's Handbook 3",
  ...
  te = Feat["Burden of Guardianship"] = new RulesElement({
  ...
  te = Feat["Burden of Liberty"] = new RulesElement({
  ...
  te = Feat["Burden of Rejuvenation"] = new RulesElement({
  ...
  te = Feat["Burden of Vision"] = new RulesElement({
  ...
  te = Feat["Cascading Rush"] = new RulesElement({
    name: "Cascading Rush",
    type: "Feat",
    id: "ID_FMP_FEAT_2585",
    source: "Player's Handbook 3",
  ...
  te = Feat["Centered Master"] = new RulesElement({
  ...
  te = Feat["Champion of Nature"] = new RulesElement({
  ...
  te = Feat["Clarified Instincts"] = new RulesElement({
  ...
  te = Feat["Clarifying Presence"] = new RulesElement({
  ...
  te = Feat["Cleanse the Madness"] = new RulesElement({
  ...
  te = Feat["Cleaving Axe"] = new RulesElement({
    name: "Cleaving Axe",
    type: "Feat",
    id: "ID_FMP_FEAT_2674",
    source: "Player's Handbook 3",
  ...
  te = Feat["Combat Intuition"] = new RulesElement({
  ...
  te = Feat["Controlling Advantage"] = new RulesElement({
  ...
  te = Feat["Crashing Tempest Style"] = new RulesElement({
  ...
  te = Feat["Critical Reserve"] = new RulesElement({
  ...
  te = Feat["Dakshai's Body-Mind Union"] = new RulesElement({
  ...
  te = Feat["Deadly Draw"] = new RulesElement({
    name: "Deadly Draw",
    type: "Feat",
    id: "ID_FMP_FEAT_2590",
    source: "Player's Handbook 3",
  ...
  te = Feat["Deceptive Mind"] = new RulesElement({
    name: "Deceptive Mind",
    type: "Feat",
    id: "ID_FMP_FEAT_2591",
    source: "Player's Handbook 3",
  ...
  te = Feat["Defiant Fire"] = new RulesElement({
    name: "Defiant Fire",
    type: "Feat",
    id: "ID_FMP_FEAT_2639",
    source: "Player's Handbook 3",
  ...
  te = Feat["Defiant Light"] = new RulesElement({
    name: "Defiant Light",
    type: "Feat",
    id: "ID_FMP_FEAT_2640",
    source: "Player's Handbook 3",
  ...
  te = Feat["Deft Aim"] = new RulesElement({
    name: "Deft Aim",
    type: "Feat",
    id: "ID_FMP_FEAT_2675",
    source: "Player's Handbook 3",
  ...
  te = Feat["Demanding Talent"] = new RulesElement({
  ...
  te = Feat["Demand's Reach"] = new RulesElement({
    name: "Demand's Reach",
    type: "Feat",
    id: "ID_FMP_FEAT_2272",
    source: "Player's Handbook 3",
  ...
  te = Feat["Desperate Renewal"] = new RulesElement({
  ...
  te = Feat["Devouring Demand"] = new RulesElement({
  ...
  te = Feat["Directed Bull Rush"] = new RulesElement({
  ...
  te = Feat["Discipline Adept"] = new RulesElement({
  ...
  te = Feat["Disciplined Talent"] = new RulesElement({
    ...
    rules: function(model) {
      ...
      // unsupported rule: cbimporter.Rules.ModifyRule
      // unsupported rule: cbimporter.Rules.ModifyRule
      model.grant(elements.id["ID_INTERNAL_GRANTS_PSION_IMPLEMENTS"]);
      model.grant(elements.id["ID_INTERNAL_INTERNAL_PSIONIC_SECOND_CLASS"]);
      model.grant(elements.id["ID_INTERNAL_COUNTSASCLASS_PSION"]);
      model.grant(elements.id["ID_INTERNAL_MULTICLASS_MULTICLASS"]);
    }
  });
  byID[te.id] = te;
  
  te = Feat["Dominating Mind"] = new RulesElement({
  ...
  te = Feat["Effortless Motion"] = new RulesElement({
  ...
  te = Feat["Elated Emotions"] = new RulesElement({
  ...
  te = Feat["Elation of Fortune"] = new RulesElement({
  ...
  te = Feat["Endangering Outrage"] = new RulesElement({
  ...
  te = Feat["Epic Alacrity"] = new RulesElement({
    name: "Epic Alacrity",
    type: "Feat",
    id: "ID_FMP_FEAT_2148",
    source: "Player's Handbook 3",
  ...
  te = Feat["Exchange Power"] = new RulesElement({
    name: "Exchange Power",
    type: "Feat",
    id: "ID_FMP_FEAT_1633",
    source: "Player's Handbook 3",
  ...
  te = Feat["Expanded Fragments"] = new RulesElement({
  ...
  te = Feat["Expansive Burst"] = new RulesElement({
  ...
  te = Feat["Eyes in the Back of Your Head"] = new RulesElement({
  ...
  te = Feat["Fervent Talent"] = new RulesElement({
    name: "Fervent Talent",
    type: "Feat",
    id: "ID_FMP_FEAT_2693",
    source: "Player's Handbook 3",
  ...
  te = Feat["Focused Mind"] = new RulesElement({
    name: "Focused Mind",
    type: "Feat",
    id: "ID_FMP_FEAT_2594",
    source: "Player's Handbook 3",
  ...
  te = Feat["Githzerai Planewalker"] = new RulesElement({
  ...
  te = Feat["Goring Shove"] = new RulesElement({
    name: "Goring Shove",
    type: "Feat",
    id: "ID_FMP_FEAT_1060",
    source: "Player's Handbook 3",
  ...
  te = Feat["Grazing Shot"] = new RulesElement({
    name: "Grazing Shot",
    type: "Feat",
    id: "ID_FMP_FEAT_2647",
    source: "Player's Handbook 3",
  ...
  te = Feat["Gritty Determination"] = new RulesElement({
  ...
  te = Feat["Grounding Shot"] = new RulesElement({
    name: "Grounding Shot",
    type: "Feat",
    id: "ID_FMP_FEAT_2595",
    source: "Player's Handbook 3",
  ...
  te = Feat["Guarded Mind"] = new RulesElement({
    name: "Guarded Mind",
    type: "Feat",
    id: "ID_FMP_FEAT_2649",
    source: "Player's Handbook 3",
  ...
  te = Feat["Hafted Defense"] = new RulesElement({
    name: "Hafted Defense",
    type: "Feat",
    id: "ID_FMP_FEAT_2596",
    source: "Player's Handbook 3",
  ...
  te = Feat["Hammering Iron"] = new RulesElement({
    name: "Hammering Iron",
    type: "Feat",
    id: "ID_FMP_FEAT_2597",
    source: "Player's Handbook 3",
  ...
  te = Feat["Headsman's Chop"] = new RulesElement({
  ...
  te = Feat["Healing Fragments"] = new RulesElement({
  ...
  te = Feat["Heartening Surge"] = new RulesElement({
  ...
  te = Feat["Hybrid Talent"] = new RulesElement({
    name: "Hybrid Talent",
    type: "Feat",
    id: "ID_FMP_FEAT_1366",
    source: "Player's Handbook 3",
  ...
  te = Feat["Impending Victory"] = new RulesElement({
  ...
  te = Feat["Improved Ardent Surge"] = new RulesElement({
  ...
  te = Feat["Improved Aspect of Nature"] = new RulesElement({
  ...
  te = Feat["Improved Inevitable Shot"] = new RulesElement({
  ...
  te = Feat["Improved Monk Unarmed Strike"] = new RulesElement({
  ...
  te = Feat["Improved Speed of Thought"] = new RulesElement({
  ...
  te = Feat["Inescapable Shot"] = new RulesElement({
  ...
  te = Feat["Inevitable Accuracy"] = new RulesElement({
  ...
  te = Feat["Inevitable Volley"] = new RulesElement({
  ...
  te = Feat["Iron Body"] = new RulesElement({
    name: "Iron Body",
    type: "Feat",
    id: "ID_FMP_FEAT_1684",
    source: "Player's Handbook 3",
  ...
  te = Feat["Iron Hands"] = new RulesElement({
    name: "Iron Hands",
    type: "Feat",
    id: "ID_FMP_FEAT_1680",
    source: "Player's Handbook 3",
  ...
  te = Feat["Iron Resolve of Zerthadlun"] = new RulesElement({
  ...
  te = Feat["Liberating Shard Swarm"] = new RulesElement({
  ...
  te = Feat["Liberating Teleport"] = new RulesElement({
  ...
  te = Feat["Linebreaker"] = new RulesElement({
    name: "Linebreaker",
    type: "Feat",
    id: "ID_FMP_FEAT_2273",
    source: "Player's Handbook 3",
  ...
  te = Feat["Long Step"] = new RulesElement({
    name: "Long Step",
    type: "Feat",
    id: "ID_FMP_FEAT_2678",
    source: "Player's Handbook 3",
  ...
  te = Feat["Low Crawl"] = new RulesElement({
    name: "Low Crawl",
    type: "Feat",
    id: "ID_FMP_FEAT_2604",
    source: "Player's Handbook 3",
  ...
  te = Feat["Lucky Start"] = new RulesElement({
    name: "Lucky Start",
    type: "Feat",
    id: "ID_FMP_FEAT_2720",
    source: "Player's Handbook 3",
  ...
  te = Feat["Lure of Iron"] = new RulesElement({
    name: "Lure of Iron",
    type: "Feat",
    id: "ID_FMP_FEAT_2605",
    source: "Player's Handbook 3",
  ...
  te = Feat["Mantle of Readiness"] = new RulesElement({
  ...
  te = Feat["Miryath's First Strike"] = new RulesElement({
  ...
  te = Feat["Monastic Disciple"] = new RulesElement({
    ...
    rules: function(model) {
      ...
      // unsupported rule: cbimporter.Rules.ModifyRule
      // unsupported rule: cbimporter.Rules.ModifyRule
      model.grant(elements.id["ID_INTERNAL_GRANTS_MONK_IMPLEMENTS"]);
      model.grant(elements.id["ID_INTERNAL_COUNTSASCLASS_MONK"]);
      model.grant(elements.id["ID_INTERNAL_MULTICLASS_MULTICLASS"]);
    }
  });
  byID[te.id] = te;
  
  te = Feat["Mythic Senses"] = new RulesElement({
    name: "Mythic Senses",
    type: "Feat",
    id: "ID_FMP_FEAT_2679",
    source: "Player's Handbook 3",
  ...
  te = Feat["Nimble Runner"] = new RulesElement({
    name: "Nimble Runner",
    type: "Feat",
    id: "ID_FMP_FEAT_2606",
    source: "Player's Handbook 3",
  ...
  te = Feat["Opportunistic Shove"] = new RulesElement({
  ...
  te = Feat["Opportunistic Withdrawal"] = new RulesElement({
  ...
  te = Feat["Opportunity Sidestep"] = new RulesElement({
  ...
  te = Feat["Orbiting Object"] = new RulesElement({
  ...
  te = Feat["Overwhelming Critical"] = new RulesElement({
  ...
  te = Feat["Peerless Reaction"] = new RulesElement({
  ...
  te = Feat["Pointed Step Style"] = new RulesElement({
  ...
  te = Feat["Polearm Flanker"] = new RulesElement({
  ...
  te = Feat["Power Throw"] = new RulesElement({
    name: "Power Throw",
    type: "Feat",
    id: "ID_FMP_FEAT_2610",
    source: "Player's Handbook 3",
  ...
  te = Feat["Precise Mind"] = new RulesElement({
    name: "Precise Mind",
    type: "Feat",
    id: "ID_FMP_FEAT_1634",
    source: "Player's Handbook 3",
  ...
  te = Feat["Predictive Defense"] = new RulesElement({
  ...
  te = Feat["Primal Eye"] = new RulesElement({
    name: "Primal Eye",
    type: "Feat",
    id: "ID_FMP_FEAT_2655",
    source: "Player's Handbook 3",
  ...
  te = Feat["Primal Sharpshooter"] = new RulesElement({
    ...
    rules: function(model) {
      ...
      // unsupported rule: cbimporter.Rules.ModifyRule
      model.grant(elements.id["ID_INTERNAL_COUNTSASCLASS_SEEKER"]);
      model.grant(elements.id["ID_INTERNAL_MULTICLASS_MULTICLASS"]);
    }
  });
  byID[te.id] = te;
  
  te = Feat["Prime Burst"] = new RulesElement({
    name: "Prime Burst",
    type: "Feat",
    id: "ID_FMP_FEAT_2611",
    source: "Player's Handbook 3",
  ...
  te = Feat["Psionic Complement"] = new RulesElement({
  ...
  te = Feat["Psionic Conventionalist"] = new RulesElement({
  ...
  te = Feat["Psionic Dabbler"] = new RulesElement({
  ...
  te = Feat["Psionic Rejuvenation"] = new RulesElement({
  ...
  te = Feat["Psychic Bastion"] = new RulesElement({
  ...
  te = Feat["Psychic Focus"] = new RulesElement({
    name: "Psychic Focus",
    type: "Feat",
    id: "ID_FMP_FEAT_2721",
    source: "Player's Handbook 3",
  ...
  te = Feat["Punishing Rebuke"] = new RulesElement({
  ...
  te = Feat["Punishing Spike"] = new RulesElement({
  ...
  te = Feat["Pursuing Step"] = new RulesElement({
    name: "Pursuing Step",
    type: "Feat",
    id: "ID_FMP_FEAT_2271",
    source: "Player's Handbook 3",
  ...
  te = Feat["Rapid Assault"] = new RulesElement({
    name: "Rapid Assault",
    type: "Feat",
    id: "ID_FMP_FEAT_2612",
    source: "Player's Handbook 3",
  ...
  te = Feat["Rapid Regeneration"] = new RulesElement({
  ...
  te = Feat["Rejuvenating Shard Swarm"] = new RulesElement({
  ...
  te = Feat["Repel Charge"] = new RulesElement({
    name: "Repel Charge",
    type: "Feat",
    id: "ID_FMP_FEAT_2658",
    source: "Player's Handbook 3",
  ...
  te = Feat["Resilient Shield"] = new RulesElement({
  ...
  te = Feat["Roll with It"] = new RulesElement({
    name: "Roll with It",
    type: "Feat",
    id: "ID_FMP_FEAT_2659",
    source: "Player's Handbook 3",
  ...
  te = Feat["Rune of Battle"] = new RulesElement({
    name: "Rune of Battle",
    type: "Feat",
    id: "ID_FMP_FEAT_2684",
    source: "Player's Handbook 3",
  ...
  te = Feat["Rune of Eloquence"] = new RulesElement({
  ...
  te = Feat["Rune of Escape"] = new RulesElement({
    name: "Rune of Escape",
    type: "Feat",
    id: "ID_FMP_FEAT_2660",
    source: "Player's Handbook 3",
  ...
  te = Feat["Rune of Health"] = new RulesElement({
    name: "Rune of Health",
    type: "Feat",
    id: "ID_FMP_FEAT_2685",
    source: "Player's Handbook 3",
  ...
  te = Feat["Rune of Hope"] = new RulesElement({
    name: "Rune of Hope",
    type: "Feat",
    id: "ID_FMP_FEAT_2614",
    source: "Player's Handbook 3",
  ...
  te = Feat["Rune of Torment"] = new RulesElement({
  ...
  te = Feat["Rune of Vengeance"] = new RulesElement({
  ...
  te = Feat["Rune of Zeal"] = new RulesElement({
    name: "Rune of Zeal",
    type: "Feat",
    id: "ID_FMP_FEAT_2616",
    source: "Player's Handbook 3",
  ...
  te = Feat["Ruthless Price"] = new RulesElement({
    name: "Ruthless Price",
    type: "Feat",
    id: "ID_FMP_FEAT_2686",
    source: "Player's Handbook 3",
  ...
  te = Feat["Secret of Enduring Vigor"] = new RulesElement({
  ...
  te = Feat["Secret of Escape"] = new RulesElement({
  ...
  te = Feat["Secret of Reawakening"] = new RulesElement({
  ...
  te = Feat["Shared Danger Sense"] = new RulesElement({
  ...
  te = Feat["Shield Mastery"] = new RulesElement({
    name: "Shield Mastery",
    type: "Feat",
    id: "ID_FMP_FEAT_2663",
    source: "Player's Handbook 3",
  ...
  te = Feat["Shifting Defense"] = new RulesElement({
  ...
  te = Feat["Simple Precision"] = new RulesElement({
  ...
  te = Feat["Skill Power"] = new RulesElement({
    name: "Skill Power",
    type: "Feat",
    id: "ID_FMP_FEAT_2618",
    source: "Player's Handbook 3",
  ...
  te = Feat["Spiritbond Defense"] = new RulesElement({
  ...
  te = Feat["Spiritbond Outrage"] = new RulesElement({
  ...
  te = Feat["Spring Step"] = new RulesElement({
    name: "Spring Step",
    type: "Feat",
    id: "ID_FMP_FEAT_2620",
    source: "Player's Handbook 3",
  ...
  te = Feat["Springing Charge"] = new RulesElement({
  ...
  te = Feat["Starblade Flurry"] = new RulesElement({
  ...
  te = Feat["Steady Feet"] = new RulesElement({
    name: "Steady Feet",
    type: "Feat",
    id: "ID_FMP_FEAT_2622",
    source: "Player's Handbook 3",
  ...
  te = Feat["Steel Rebuke"] = new RulesElement({
    name: "Steel Rebuke",
    type: "Feat",
    id: "ID_FMP_FEAT_2666",
    source: "Player's Handbook 3",
  ...
  te = Feat["Stone Fist Master"] = new RulesElement({
  ...
  te = Feat["Strengthened Bond"] = new RulesElement({
  ...
  te = Feat["Strike and Shove"] = new RulesElement({
  ...
  te = Feat["Student of Divine Runes"] = new RulesElement({
    ...
    rules: function(model) {
      ...
      // unsupported rule: cbimporter.Rules.ModifyRule
      // unsupported rule: cbimporter.Rules.ModifyRule
      model.grant(elements.id["ID_INTERNAL_COUNTSASCLASS_RUNEPRIEST"]);
      model.grant(elements.id["ID_INTERNAL_MULTICLASS_MULTICLASS"]);
    }
  });
  byID[te.id] = te;
  
  te = Feat["Superior Implement Training"] = new RulesElement({
  ...
  te = Feat["Superior Implement Training (Accurate dagger)"] = new RulesElement({
  ...
  te = Feat["Superior Implement Training (Accurate Ki Focus)"] = new RulesElement({
  ...
  te = Feat["Superior Implement Training (Accurate orb)"] = new RulesElement({
  ...
  te = Feat["Superior Implement Training (Accurate rod)"] = new RulesElement({
  ...
  te = Feat["Superior Implement Training (Accurate staff)"] = new RulesElement({
  ...
  te = Feat["Superior Implement Training (Accurate symbol)"] = new RulesElement({
  ...
  te = Feat["Superior Implement Training (Accurate totem)"] = new RulesElement({
  ...
  te = Feat["Superior Implement Training (Accurate wand)"] = new RulesElement({
  ...
  te = Feat["Superior Implement Training (Ashen rod)"] = new RulesElement({
  ...
  te = Feat["Superior Implement Training (Astral symbol)"] = new RulesElement({
  ...
  te = Feat["Superior Implement Training (Cinder wand)"] = new RulesElement({
  ...
  te = Feat["Superior Implement Training (Crystal orb)"] = new RulesElement({
  ...
  te = Feat["Superior Implement Training (Deathbone rod)"] = new RulesElement({
  ...
  te = Feat["Superior Implement Training (Defiant rod)"] = new RulesElement({
  ...
  te = Feat["Superior Implement Training (Dragontooth wand)"] = new RulesElement({
  ...
  te = Feat["Superior Implement Training (Echo tome)"] = new RulesElement({
  ...
  te = Feat["Superior Implement Training (Farseeing totem)"] = new RulesElement({
  ...
  te = Feat["Superior Implement Training (Fluid Ki Focus)"] = new RulesElement({
  ...
  te = Feat["Superior Implement Training (Forbidden tome)"] = new RulesElement({
  ...
  te = Feat["Superior Implement Training (Greenstone orb)"] = new RulesElement({
  ...
  te = Feat["Superior Implement Training (Guardian staff)"] = new RulesElement({
  ...
  te = Feat["Superior Implement Training (Icicle totem)"] = new RulesElement({
  ...
  te = Feat["Superior Implement Training (Incendiary dagger)"] = new RulesElement({
  ...
  te = Feat["Superior Implement Training (Inexorable Ki Focus)"] = new RulesElement({
  ...
  te = Feat["Superior Implement Training (Iron Ki Focus)"] = new RulesElement({
  ...
  te = Feat["Superior Implement Training (Lancing dagger)"] = new RulesElement({
  ...
  te = Feat["Superior Implement Training (Mighty Ki Focus)"] = new RulesElement({
  ...
  te = Feat["Superior Implement Training (Mindwarp staff)"] = new RulesElement({
  ...
  te = Feat["Superior Implement Training (Mountain Ki Focus)"] = new RulesElement({
  ...
  te = Feat["Superior Implement Training (Petrified orb)"] = new RulesElement({
  ...
  te = Feat["Superior Implement Training (Quickbeam staff)"] = new RulesElement({
  ...
  te = Feat["Superior Implement Training (Resonating dagger)"] = new RulesElement({
  ...
  te = Feat["Superior Implement Training (Rowan wand)"] = new RulesElement({
  ...
  te = Feat["Superior Implement Training (Serene Ki Focus)"] = new RulesElement({
  ...
  te = Feat["Superior Implement Training (Storm totem)"] = new RulesElement({
  ...
  te = Feat["Superior Implement Training (Transcendent Ki Focus)"] = new RulesElement({
  ...
  te = Feat["Superior Implement Training (Unspeakable tome)"] = new RulesElement({
  ...
  te = Feat["Superior Implement Training (Warding symbol)"] = new RulesElement({
  ...
  te = Feat["Superior Implement Training (Wrathful symbol)"] = new RulesElement({
  ...
  te = Feat["Superior Initiative"] = new RulesElement({
  ...
  te = Feat["Targeting Force"] = new RulesElement({
  ...
  te = Feat["Teamwork Defense"] = new RulesElement({
  ...
  te = Feat["Telepathic Sustenance"] = new RulesElement({
  ...
  te = Feat["Unarmed Mastery"] = new RulesElement({
  ...
  te = Feat["Unarmored Agility"] = new RulesElement({
  ...
  te = Feat["Uncanny Scent"] = new RulesElement({
    name: "Uncanny Scent",
    type: "Feat",
    id: "ID_FMP_FEAT_1067",
    source: "Player's Handbook 3",
  ...
  te = Feat["Unfailing Vigor"] = new RulesElement({
  ...
  te = Feat["Vengeance Spike"] = new RulesElement({
  ...
  te = Feat["Versatile Expertise"] = new RulesElement({
  ...
  te = Feat["Versatile Expertise II"] = new RulesElement({
  ...
  te = Feat["Versatile Expertise III"] = new RulesElement({
  ...
  te = Feat["Versatile Expertise IV"] = new RulesElement({
  ...
  te = Feat["Versatile Expertise V"] = new RulesElement({
  ...
  te = Feat["Versatile Expertise VI"] = new RulesElement({
  ...
  te = Feat["Vicious Advantage"] = new RulesElement({
  ...
  te = Feat["Vicious Ferocity"] = new RulesElement({
  ...
  te = Feat["Vicious Stomp"] = new RulesElement({
    name: "Vicious Stomp",
    type: "Feat",
    id: "ID_FMP_FEAT_2730",
    source: "Player's Handbook 3",
  ...
  te = Feat["Warding Defense"] = new RulesElement({
  ...
  te = Feat["Warding Shard Swarm"] = new RulesElement({
  ...
  te = Feat["Watchful Redoubt"] = new RulesElement({
  ...
  te = Feat["Widened Mantle"] = new RulesElement({
    name: "Widened Mantle",
    type: "Feat",
    id: "ID_FMP_FEAT_2147",
    source: "Player's Handbook 3",
  ...
  te = Feat["Wind's Fortunes"] = new RulesElement({
  ...
  te = Feat["Wrath of Defeat"] = new RulesElement({
  ...
  te = Feat["Zuwoth's Enlightened Step"] = new RulesElement({
