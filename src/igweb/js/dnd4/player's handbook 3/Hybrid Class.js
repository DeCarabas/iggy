(function(global, undefined) {
  ...
  te = Hybrid_Class["Hybrid Ardent"] = new RulesElement({
    name: "Hybrid Ardent",
    type: "Hybrid Class",
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_GRANTS_HYBRID_ARDENT"]);
  ...
  te = Hybrid_Class["Hybrid Artificer"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_GRANTS_HYBRID_ARTIFICER"]);
      model.select('Power', 1, {
        filter: function(model, element) { return (element.hasCategory(model['class'].id) && element.hasCategory("at-will") && element.hasCategory("1")); }
      });
  ...
  te = Hybrid_Class["Hybrid Avenger"] = new RulesElement({
    name: "Hybrid Avenger",
    type: "Hybrid Class",
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_GRANTS_HYBRID_AVENGER"]);
      model.select('Power', 1, {
        filter: function(model, element) { return (element.hasCategory(model['class'].id) && element.hasCategory("at-will") && element.hasCategory("1")); }
      });
  ...
  te = Hybrid_Class["Hybrid Barbarian"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_GRANTS_HYBRID_BARBARIAN"]);
      model.select('Power', 1, {
        filter: function(model, element) { return (element.hasCategory(model['class'].id) && element.hasCategory("at-will") && element.hasCategory("1")); }
      });
  ...
  te = Hybrid_Class["Hybrid Bard"] = new RulesElement({
    name: "Hybrid Bard",
    type: "Hybrid Class",
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_GRANTS_HYBRID_BARD"]);
      model.select('Power', 1, {
        filter: function(model, element) { return (element.hasCategory(model['class'].id) && element.hasCategory("at-will") && element.hasCategory("1")); }
      });
  ...
  te = Hybrid_Class["Hybrid Battlemind"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_GRANTS_HYBRID_BATTLEMIND"]);
      model.select('Power', 1, {
        filter: function(model, element) { return (element.hasCategory(model['class'].id) && element.hasCategory("at-will") && element.hasCategory("1")); }
      });
  ...
  te = Hybrid_Class["Hybrid Cleric"] = new RulesElement({
    name: "Hybrid Cleric",
    type: "Hybrid Class",
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_GRANTS_HYBRID_CLERIC"]);
      model.select('Power', 1, {
        filter: function(model, element) { return (element.hasCategory(model['class'].id) && element.hasCategory("at-will") && element.hasCategory("1")); }
      });
  ...
  te = Hybrid_Class["Hybrid Druid"] = new RulesElement({
    name: "Hybrid Druid",
    type: "Hybrid Class",
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_GRANTS_HYBRID_DRUID"]);
      model.select('Power', 1, {
        filter: function(model, element) { return (element.hasCategory(model['class'].id) && element.hasCategory("at-will") && element.hasCategory("1")); }
      });
  ...
  te = Hybrid_Class["Hybrid Fighter"] = new RulesElement({
    name: "Hybrid Fighter",
    type: "Hybrid Class",
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_GRANTS_HYBRID_FIGHTER"]);
      model.select('Power', 1, {
        filter: function(model, element) { return (element.hasCategory(model['class'].id) && element.hasCategory("at-will") && element.hasCategory("1")); }
      });
  ...
  te = Hybrid_Class["Hybrid Invoker"] = new RulesElement({
    name: "Hybrid Invoker",
    type: "Hybrid Class",
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_GRANTS_HYBRID_INVOKER"]);
      model.select('Power', 1, {
        filter: function(model, element) { return (element.hasCategory(model['class'].id) && element.hasCategory("at-will") && element.hasCategory("1")); }
      });
  ...
  te = Hybrid_Class["Hybrid Monk"] = new RulesElement({
    name: "Hybrid Monk",
    type: "Hybrid Class",
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_GRANTS_HYBRID_MONK"]);
      model.select('Power', 1, {
        filter: function(model, element) { return (element.hasCategory(model['class'].id) && element.hasCategory("at-will") && element.hasCategory("1")); }
      });
  ...
  te = Hybrid_Class["Hybrid Paladin"] = new RulesElement({
    name: "Hybrid Paladin",
    type: "Hybrid Class",
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_GRANTS_HYBRID_PALADIN"]);
      model.select('Power', 1, {
        filter: function(model, element) { return (element.hasCategory(model['class'].id) && element.hasCategory("at-will") && element.hasCategory("1")); }
      });
  ...
  te = Hybrid_Class["Hybrid Psion"] = new RulesElement({
    name: "Hybrid Psion",
    type: "Hybrid Class",
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_GRANTS_HYBRID_PSION"]);
      model.select('Power', 1, {
        filter: function(model, element) { return (element.hasCategory(model['class'].id) && element.hasCategory("at-will") && element.hasCategory("1")); }
      });
  ...
  te = Hybrid_Class["Hybrid Ranger"] = new RulesElement({
    name: "Hybrid Ranger",
    type: "Hybrid Class",
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_GRANTS_HYBRID_RANGER"]);
      model.select('Power', 1, {
        filter: function(model, element) { return (element.hasCategory(model['class'].id) && element.hasCategory("at-will") && element.hasCategory("1")); }
      });
  ...
  te = Hybrid_Class["Hybrid Rogue"] = new RulesElement({
    name: "Hybrid Rogue",
    type: "Hybrid Class",
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_GRANTS_HYBRID_ROGUE"]);
      model.select('Power', 1, {
        filter: function(model, element) { return (element.hasCategory(model['class'].id) && element.hasCategory("at-will") && element.hasCategory("1")); }
      });
  ...
  te = Hybrid_Class["Hybrid Runepriest"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_GRANTS_HYBRID_RUNEPRIEST"]);
      model.select('Power', 1, {
        filter: function(model, element) { return (element.hasCategory(model['class'].id) && element.hasCategory("at-will") && element.hasCategory("1")); }
      });
  ...
  te = Hybrid_Class["Hybrid Seeker"] = new RulesElement({
    name: "Hybrid Seeker",
    type: "Hybrid Class",
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_GRANTS_HYBRID_SEEKER"]);
      model.select('Power', 1, {
        filter: function(model, element) { return (element.hasCategory(model['class'].id) && element.hasCategory("at-will") && element.hasCategory("1")); }
      });
  ...
  te = Hybrid_Class["Hybrid Shaman"] = new RulesElement({
    name: "Hybrid Shaman",
    type: "Hybrid Class",
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_GRANTS_HYBRID_SHAMAN"]);
      model.select('Power', 1, {
        filter: function(model, element) { return (element.hasCategory(model['class'].id) && element.hasCategory("at-will") && element.hasCategory("1")); }
      });
  ...
  te = Hybrid_Class["Hybrid Sorcerer"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_GRANTS_HYBRID_SORCERER"]);
      model.select('Power', 1, {
        filter: function(model, element) { return (element.hasCategory(model['class'].id) && element.hasCategory("at-will") && element.hasCategory("1")); }
      });
  ...
  te = Hybrid_Class["Hybrid Swordmage"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_GRANTS_HYBRID_SWORDMAGE"]);
      model.select('Power', 1, {
        filter: function(model, element) { return (element.hasCategory(model['class'].id) && element.hasCategory("at-will") && element.hasCategory("1")); }
      });
  ...
  te = Hybrid_Class["Hybrid Warden"] = new RulesElement({
    name: "Hybrid Warden",
    type: "Hybrid Class",
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_GRANTS_HYBRID_WARDEN"]);
      model.select('Power', 1, {
        filter: function(model, element) { return (element.hasCategory(model['class'].id) && element.hasCategory("at-will") && element.hasCategory("1")); }
      });
  ...
  te = Hybrid_Class["Hybrid Warlock"] = new RulesElement({
    name: "Hybrid Warlock",
    type: "Hybrid Class",
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_GRANTS_HYBRID_WARLOCK"]);
      model.select('Power', 1, {
        filter: function(model, element) { return (element.hasCategory(model['class'].id) && element.hasCategory("at-will") && element.hasCategory("1")); }
      });
  ...
  te = Hybrid_Class["Hybrid Warlord"] = new RulesElement({
    name: "Hybrid Warlord",
    type: "Hybrid Class",
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_GRANTS_HYBRID_WARLORD"]);
      model.select('Power', 1, {
        filter: function(model, element) { return (element.hasCategory(model['class'].id) && element.hasCategory("at-will") && element.hasCategory("1")); }
      });
  ...
  te = Hybrid_Class["Hybrid Wizard"] = new RulesElement({
    name: "Hybrid Wizard",
    type: "Hybrid Class",
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_GRANTS_HYBRID_WIZARD"]);
      model.select('Power', 1, {
        filter: function(model, element) { return (element.hasCategory(model['class'].id) && element.hasCategory("at-will") && element.hasCategory("1")); }
      });
