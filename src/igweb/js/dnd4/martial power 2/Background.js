(function(global, undefined) {
  ...
  te = Background["Athlete"] = new RulesElement({
    name: "Athlete",
    type: "Background",
  ...
  te = Background["Beggar"] = new RulesElement({
    name: "Beggar",
    type: "Background",
  ...
  te = Background["Borderland Nobility"] = new RulesElement({
  ...
  te = Background["Camp Follower"] = new RulesElement({
    name: "Camp Follower",
    type: "Background",
  ...
  te = Background["Circus Performer"] = new RulesElement({
  ...
  te = Background["Hellion"] = new RulesElement({
    name: "Hellion",
    type: "Background",
  ...
  te = Background["Martial - Bearer of the Heirloom"] = new RulesElement({
  ...
  te = Background["Martial - Disenchanted"] = new RulesElement({
  ...
  te = Background["Martial - Garrison Child"] = new RulesElement({
  ...
  te = Background["Martial - Guild Orphan"] = new RulesElement({
  ...
  te = Background["Martial - Local Hero"] = new RulesElement({
  ...
  te = Background["Martial - Scion of a Legend"] = new RulesElement({
  ...
  te = Background["Sentry"] = new RulesElement({
    name: "Sentry",
    type: "Background",
