define(['engine', 'dnd4model'], function(engine, dnd4model) {
  ...
  te = Build_Suggestions["Brawling Fighter"] = new engine.RulesElement({
    ...
    categories: ["Brawling Fighter", "ID_INTERNAL_BUILD_SUGGESTIONS_BRAWLING_FIGHTER"],
  ...
  te = Build_Suggestions["Hunter Ranger"] = new engine.RulesElement({
    ...
    source: "Martial Power 2",
    categories: ["Hunter Ranger", "ID_INTERNAL_BUILD_SUGGESTIONS_HUNTER_RANGER"],
    rules: function(model) {
      // unsupported rule: cbimporter.Rules.SuggestRule
      // unsupported rule: cbimporter.Rules.SuggestRule
      // unsupported rule: cbimporter.Rules.SuggestRule
  ...
  te = Build_Suggestions["Insightful Warlord"] = new engine.RulesElement({
    ...
    source: "Martial Power 2",
    categories: ["Insightful Warlord", "ID_INTERNAL_BUILD_SUGGESTIONS_INSIGHTFUL_WARLORD"],
    rules: function(model) {
      // unsupported rule: cbimporter.Rules.SuggestRule
      // unsupported rule: cbimporter.Rules.SuggestRule
      // unsupported rule: cbimporter.Rules.SuggestRule
  ...
  te = Build_Suggestions["Marauder Ranger"] = new engine.RulesElement({
    ...
    source: "Martial Power 2",
    categories: ["Marauder Ranger", "ID_INTERNAL_BUILD_SUGGESTIONS_MARAUDER_RANGER"],
    rules: function(model) {
      // unsupported rule: cbimporter.Rules.SuggestRule
      // unsupported rule: cbimporter.Rules.SuggestRule
      // unsupported rule: cbimporter.Rules.SuggestRule
  ...
  te = Build_Suggestions["Shadowy Rogue"] = new engine.RulesElement({
    ...
    source: "Martial Power 2",
    categories: ["Shadowy Rogue", "ID_INTERNAL_BUILD_SUGGESTIONS_SHADOWY_ROGUE"],
    rules: function(model) {
      // unsupported rule: cbimporter.Rules.SuggestRule
      // unsupported rule: cbimporter.Rules.SuggestRule
      // unsupported rule: cbimporter.Rules.SuggestRule
  ...
  te = Build_Suggestions["Skirmishing Warlord"] = new engine.RulesElement({
    ...
    source: "Martial Power 2",
    categories: ["Skirmishing Warlord", "ID_INTERNAL_BUILD_SUGGESTIONS_SKIRMISHING_WARLORD"],
    rules: function(model) {
      // unsupported rule: cbimporter.Rules.SuggestRule
      // unsupported rule: cbimporter.Rules.SuggestRule
      // unsupported rule: cbimporter.Rules.SuggestRule
