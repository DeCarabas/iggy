(function(global, undefined) {
  ...
  te = Ability_Increase_Level_24["Charisma"] = new RulesElement({
    name: "Charisma",
  ...
  te = Ability_Increase_Level_24["Constitution"] = new RulesElement({
    name: "Constitution",
    type: "Ability Increase (Level 24)",
  ...
  te = Ability_Increase_Level_24["Dexterity"] = new RulesElement({
    name: "Dexterity",
    type: "Ability Increase (Level 24)",
  ...
  te = Ability_Increase_Level_24["Intelligence"] = new RulesElement({
    name: "Intelligence",
    type: "Ability Increase (Level 24)",
  ...
  te = Ability_Increase_Level_24["Strength"] = new RulesElement({
    name: "Strength",
    type: "Ability Increase (Level 24)",
  ...
  te = Ability_Increase_Level_24["Wisdom"] = new RulesElement({
    name: "Wisdom",
    type: "Ability Increase (Level 24)",
