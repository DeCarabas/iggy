(function(global, undefined) {
  ...
  te = Companion_Ability_Increase_Level_18["Charisma"] = new RulesElement({
    name: "Charisma",
  ...
  te = Companion_Ability_Increase_Level_18["Constitution"] = new RulesElement({
    name: "Constitution",
    type: "Companion Ability Increase (Level 18)",
  ...
  te = Companion_Ability_Increase_Level_18["Dexterity"] = new RulesElement({
    name: "Dexterity",
    type: "Companion Ability Increase (Level 18)",
  ...
  te = Companion_Ability_Increase_Level_18["Intelligence"] = new RulesElement({
    name: "Intelligence",
    type: "Companion Ability Increase (Level 18)",
  ...
  te = Companion_Ability_Increase_Level_18["Strength"] = new RulesElement({
    name: "Strength",
    type: "Companion Ability Increase (Level 18)",
  ...
  te = Companion_Ability_Increase_Level_18["Wisdom"] = new RulesElement({
    name: "Wisdom",
    type: "Companion Ability Increase (Level 18)",
