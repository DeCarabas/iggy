define(['engine', 'dnd4model'], function(engine, dnd4model) {
  ...
  te = Level1Rules["DetailsRules"] = new engine.RulesElement({
    name: "DetailsRules",
    type: "Level1Rules",
  ...
  te = Level1Rules["Expansion1"] = new engine.RulesElement({
    name: "Expansion1",
    type: "Level1Rules",
  ...
  te = Level1Rules["Expansion2"] = new engine.RulesElement({
    name: "Expansion2",
    type: "Level1Rules",
  ...
  te = Level1Rules["Expansion3"] = new engine.RulesElement({
    name: "Expansion3",
    type: "Level1Rules",
  ...
  te = Level1Rules["Expansion4"] = new engine.RulesElement({
    name: "Expansion4",
    type: "Level1Rules",
  ...
  te = Level1Rules["Expansion5"] = new engine.RulesElement({
    name: "Expansion5",
    type: "Level1Rules",
  ...
  te = Level1Rules["Level1Rules"] = new engine.RulesElement({
    name: "Level1Rules",
    type: "Level1Rules",
    ...
    rules: function(model) {
      model.grant(model.elements.id["ID_INTERNAL_LEVEL1RULES_SKILLRULES"]);
      model.grant(model.elements.id["ID_INTERNAL_TIER_HEROIC"]);
      model.grant(model.elements.id["ID_INTERNAL_POWER_MELEE_BASIC_ATTACK"]);
      model.grant(model.elements.id["ID_INTERNAL_POWER_RANGED_BASIC_ATTACK"]);
    }
  });
  byID[te.id] = te;
  
  te = Level1Rules["SkillRules"] = new engine.RulesElement({
    name: "SkillRules",
    type: "Level1Rules",
    ...
    rules: function(model) {
      model.grant(model.elements.id["ID_FMP_SKILL_1"]);
      ...
      model.grant(model.elements.id["ID_FMP_SKILL_2"]);
      ...
      model.grant(model.elements.id["ID_FMP_SKILL_3"]);
      ...
      model.grant(model.elements.id["ID_FMP_SKILL_6"]);
      ...
      model.grant(model.elements.id["ID_FMP_SKILL_7"]);
      ...
      model.grant(model.elements.id["ID_FMP_SKILL_8"]);
      ...
      model.grant(model.elements.id["ID_FMP_SKILL_9"]);
      ...
      model.grant(model.elements.id["ID_FMP_SKILL_11"]);
      ...
      model.grant(model.elements.id["ID_FMP_SKILL_13"]);
      ...
      model.grant(model.elements.id["ID_FMP_SKILL_14"]);
      ...
      model.grant(model.elements.id["ID_FMP_SKILL_16"]);
      ...
      model.grant(model.elements.id["ID_FMP_SKILL_17"]);
      ...
      model.grant(model.elements.id["ID_FMP_SKILL_18"]);
      ...
      model.grant(model.elements.id["ID_FMP_SKILL_20"]);
      ...
      model.grant(model.elements.id["ID_FMP_SKILL_21"]);
      ...
      model.grant(model.elements.id["ID_FMP_SKILL_23"]);
      ...
      model.grant(model.elements.id["ID_FMP_SKILL_27"]);
