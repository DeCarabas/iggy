(function(global, undefined) {
  ...
  te = Companion_Ability_Increase_Level_28["Charisma"] = new RulesElement({
    name: "Charisma",
  ...
  te = Companion_Ability_Increase_Level_28["Constitution"] = new RulesElement({
    name: "Constitution",
    type: "Companion Ability Increase (Level 28)",
  ...
  te = Companion_Ability_Increase_Level_28["Dexterity"] = new RulesElement({
    name: "Dexterity",
    type: "Companion Ability Increase (Level 28)",
  ...
  te = Companion_Ability_Increase_Level_28["Intelligence"] = new RulesElement({
    name: "Intelligence",
    type: "Companion Ability Increase (Level 28)",
  ...
  te = Companion_Ability_Increase_Level_28["Strength"] = new RulesElement({
    name: "Strength",
    type: "Companion Ability Increase (Level 28)",
  ...
  te = Companion_Ability_Increase_Level_28["Wisdom"] = new RulesElement({
    name: "Wisdom",
    type: "Companion Ability Increase (Level 28)",
