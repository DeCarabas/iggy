(function(global, undefined) {
  ...
  te = Race["Deva"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_GRANTS_DEVA"]);
  ...
  te = Race["Gnome"] = new RulesElement({
    name: "Gnome",
    type: "Race",
    id: "ID_FMP_RACE_20",
    source: "Player's Handbook 2",
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_GRANTS_GNOME"]);
  ...
  te = Race["Goliath"] = new RulesElement({
    name: "Goliath",
    type: "Race",
    id: "ID_FMP_RACE_37",
    source: "Player's Handbook 2",
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_GRANTS_GOLIATH"]);
      model.statadd("Speed", 6);
  ...
  te = Race["Half-Orc"] = new RulesElement({
    name: "Half-Orc",
    type: "Race",
    id: "ID_FMP_RACE_36",
    source: "Player's Handbook 2",
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_GRANTS_HALF-ORC"]);
      model.statadd("Speed", 6);
  ...
  te = Race["Longtooth Shifter"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_GRANTS_LONGTOOTH_SHIFTER"]);
      model.statadd("Speed", 6);
  ...
  te = Race["Razorclaw Shifter"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_GRANTS_RAZORCLAW_SHIFTER"]);
      model.statadd("Speed", 6);
      model.statadd("Average Height", "5'7\"-6'0\"");
      model.statadd("Average Weight", "130-180 lb.");
      model.statadd("Size", "Medium");
