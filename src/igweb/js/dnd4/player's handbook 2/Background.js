(function(global, undefined) {
  ...
  te = Background["Birth - Among Another Race"] = new RulesElement({
  ...
  te = Background["Birth - Blessed"] = new RulesElement({
    name: "Birth - Blessed",
    type: "Background",
  ...
  te = Background["Birth - Cursed"] = new RulesElement({
    name: "Birth - Cursed",
    type: "Background",
  ...
  te = Background["Birth - Omen"] = new RulesElement({
    name: "Birth - Omen",
    type: "Background",
  ...
  te = Background["Birth - On Another Plane"] = new RulesElement({
  ...
  te = Background["Birth - Prophecy"] = new RulesElement({
    name: "Birth - Prophecy",
    type: "Background",
  ...
  te = Background["Deva - Brink of Corruption"] = new RulesElement({
  ...
  te = Background["Deva - Brink of Enlightenment"] = new RulesElement({
  ...
  te = Background["Deva - Forgotten Lifetime"] = new RulesElement({
  ...
  te = Background["Dragonborn - Brush with the Past"] = new RulesElement({
  ...
  te = Background["Dragonborn - Dishonored"] = new RulesElement({
  ...
  te = Background["Dragonborn - Rare Egg"] = new RulesElement({
  ...
  te = Background["Drow - Orphan"] = new RulesElement({
    name: "Drow - Orphan",
    type: "Background",
  ...
  te = Background["Drow - Outcast"] = new RulesElement({
    name: "Drow - Outcast",
    type: "Background",
  ...
  te = Background["Dwarf - Ancestral Home Lost"] = new RulesElement({
  ...
  te = Background["Dwarf - Dedicated to an Ancestor"] = new RulesElement({
  ...
  te = Background["Dwarf - Outcast"] = new RulesElement({
    name: "Dwarf - Outcast",
    type: "Background",
  ...
  te = Background["Eladrin - Drowscarred"] = new RulesElement({
  ...
  te = Background["Eladrin - Estranged Fey"] = new RulesElement({
  ...
  te = Background["Eladrin - Noble Birth"] = new RulesElement({
  ...
  te = Background["Elf - Fey Ally"] = new RulesElement({
    name: "Elf - Fey Ally",
    type: "Background",
  ...
  te = Background["Elf - Urban Elf"] = new RulesElement({
    name: "Elf - Urban Elf",
    type: "Background",
  ...
  te = Background["Elf - Wild Elf"] = new RulesElement({
    name: "Elf - Wild Elf",
    type: "Background",
  ...
  te = Background["Genasi - Academic Exhibit"] = new RulesElement({
  ...
  te = Background["Genasi - Chaos Burn"] = new RulesElement({
  ...
  te = Background["Geography - Desert"] = new RulesElement({
  ...
  te = Background["Geography - Forest"] = new RulesElement({
  ...
  te = Background["Geography - Mountains"] = new RulesElement({
  ...
  te = Background["Geography - Urban"] = new RulesElement({
  ...
  te = Background["Geography - Wetlands"] = new RulesElement({
  ...
  te = Background["Gnome - Estranged Fey"] = new RulesElement({
  ...
  te = Background["Gnome - Fomorian Captivity"] = new RulesElement({
  ...
  te = Background["Goliath - Lightlost"] = new RulesElement({
  ...
  te = Background["Goliath - Skywatcher"] = new RulesElement({
  ...
  te = Background["Half-Elf - Cultural Half-Elf"] = new RulesElement({
  ...
  te = Background["Half-Elf - Outcast"] = new RulesElement({
  ...
  te = Background["Half-Elf - Wanderer"] = new RulesElement({
  ...
  te = Background["Halfling - Avandra's Kiss"] = new RulesElement({
  ...
  te = Background["Halfling - Banned"] = new RulesElement({
  ...
  te = Background["Halfling - Storyteller"] = new RulesElement({
  ...
  te = Background["Half-Orc - First Generation"] = new RulesElement({
  ...
  te = Background["Half-Orc - Orc Birth"] = new RulesElement({
  ...
  te = Background["Half-Orc - Stormtouched"] = new RulesElement({
  ...
  te = Background["Human - Ancestral Holdings"] = new RulesElement({
  ...
  te = Background["Human - Heir of the Forgotten Gods"] = new RulesElement({
  ...
  te = Background["Occupation - Artisan"] = new RulesElement({
  ...
  te = Background["Occupation - Criminal"] = new RulesElement({
  ...
  te = Background["Occupation - Entertainer"] = new RulesElement({
  ...
  te = Background["Occupation - Farmer"] = new RulesElement({
  ...
  te = Background["Occupation - Mariner"] = new RulesElement({
  ...
  te = Background["Occupation - Merchant"] = new RulesElement({
  ...
  te = Background["Occupation - Military"] = new RulesElement({
  ...
  te = Background["Occupation - Scholar"] = new RulesElement({
  ...
  te = Background["Shifter - City Shifter"] = new RulesElement({
  ...
  te = Background["Shifter - Moonspeaker"] = new RulesElement({
  ...
  te = Background["Shifter - Persecution"] = new RulesElement({
  ...
  te = Background["Society - Noble"] = new RulesElement({
    name: "Society - Noble",
    type: "Background",
  ...
  te = Background["Society - Poor"] = new RulesElement({
    name: "Society - Poor",
    type: "Background",
  ...
  te = Background["Society - Wealthy"] = new RulesElement({
  ...
  te = Background["Tiefling - Dark Secret"] = new RulesElement({
  ...
  te = Background["Tiefling - Infernal Nightmares"] = new RulesElement({
  ...
  te = Background["Tiefling - Merchant Dynasty"] = new RulesElement({
