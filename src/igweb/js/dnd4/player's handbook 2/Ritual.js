(function(global, undefined) {
  ...
  te = Ritual["Affect Normal Fire"] = new RulesElement({
  ...
  te = Ritual["Animal Friendship"] = new RulesElement({
  ...
  te = Ritual["Aria of Revelation"] = new RulesElement({
  ...
  te = Ritual["Bloom"] = new RulesElement({
    name: "Bloom",
    type: "Ritual",
  ...
  te = Ritual["Call Wilderness Guide"] = new RulesElement({
  ...
  te = Ritual["Chorus of Truth"] = new RulesElement({
  ...
  te = Ritual["Control Weather"] = new RulesElement({
  ...
  te = Ritual["Create Campsite"] = new RulesElement({
  ...
  te = Ritual["Fool's Speech"] = new RulesElement({
    name: "Fool's Speech",
    type: "Ritual",
  ...
  te = Ritual["Glib Limerick"] = new RulesElement({
    name: "Glib Limerick",
    type: "Ritual",
  ...
  te = Ritual["Ironwood"] = new RulesElement({
    name: "Ironwood",
    type: "Ritual",
  ...
  te = Ritual["Lullaby"] = new RulesElement({
    name: "Lullaby",
    type: "Ritual",
  ...
  te = Ritual["Pyrotechnics"] = new RulesElement({
    name: "Pyrotechnics",
    type: "Ritual",
  ...
  te = Ritual["Reverse Portal"] = new RulesElement({
    name: "Reverse Portal",
    type: "Ritual",
  ...
  te = Ritual["Snare"] = new RulesElement({
    name: "Snare",
    type: "Ritual",
  ...
  te = Ritual["Song of Restfulness"] = new RulesElement({
  ...
  te = Ritual["Song of Sustenance"] = new RulesElement({
  ...
  te = Ritual["Speak with Nature"] = new RulesElement({
  ...
  te = Ritual["Traveler's Chant"] = new RulesElement({
  ...
  te = Ritual["Tree Shape"] = new RulesElement({
    name: "Tree Shape",
    type: "Ritual",
  ...
  te = Ritual["Tree Stride"] = new RulesElement({
    name: "Tree Stride",
    type: "Ritual",
  ...
  te = Ritual["Tune of Merriment"] = new RulesElement({
  ...
  te = Ritual["Wyvern Watch"] = new RulesElement({
    name: "Wyvern Watch",
    type: "Ritual",
