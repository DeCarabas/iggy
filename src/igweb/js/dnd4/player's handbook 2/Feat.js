(function(global, undefined) {
  ...
  te = Feat["Acolyte of Divine Secrets"] = new RulesElement({
  ...
  te = Feat["Advantage of Cunning"] = new RulesElement({
  ...
  te = Feat["Agile Opportunist"] = new RulesElement({
  ...
  te = Feat["Ancient Stone"] = new RulesElement({
    name: "Ancient Stone",
    type: "Feat",
    id: "ID_FMP_FEAT_1051",
    source: "Player's Handbook 2",
  ...
  te = Feat["Anger Unleashed"] = new RulesElement({
  ...
  te = Feat["Arcane Flexibility"] = new RulesElement({
  ...
  te = Feat["Arcane Prodigy"] = new RulesElement({
    name: "Arcane Prodigy",
    type: "Feat",
    id: "ID_FMP_FEAT_669",
    source: "Player's Handbook 2",
  ...
  te = Feat["Arcane Spellfury"] = new RulesElement({
  ...
  te = Feat["Ascendant Lineage"] = new RulesElement({
  ...
  te = Feat["Astral Renewal"] = new RulesElement({
    name: "Astral Renewal",
    type: "Feat",
    id: "ID_FMP_FEAT_1036",
    source: "Player's Handbook 2",
  ...
  te = Feat["Auspicious Lineage"] = new RulesElement({
  ...
  te = Feat["Bardic Dilettante"] = new RulesElement({
  ...
  te = Feat["Bardic Knowledge"] = new RulesElement({
  ...
  te = Feat["Beasthide Shifting"] = new RulesElement({
  ...
  te = Feat["Berserker's Fury"] = new RulesElement({
  ...
  te = Feat["Blurring Claws"] = new RulesElement({
    name: "Blurring Claws",
    type: "Feat",
    id: "ID_FMP_FEAT_1000",
    source: "Player's Handbook 2",
  ...
  te = Feat["Bow Mastery"] = new RulesElement({
    name: "Bow Mastery",
    type: "Feat",
    id: "ID_FMP_FEAT_350",
    source: "Player's Handbook 2",
  ...
  te = Feat["Burst of Savagery"] = new RulesElement({
  ...
  te = Feat["Charging Rampage"] = new RulesElement({
  ...
  te = Feat["Cliffwalk Shiffting"] = new RulesElement({
  ...
  te = Feat["Combat Medic"] = new RulesElement({
    name: "Combat Medic",
    type: "Feat",
    id: "ID_FMP_FEAT_511",
    source: "Player's Handbook 2",
  ...
  te = Feat["Coordinated Explosion"] = new RulesElement({
  ...
  te = Feat["Crushing Earthstrength"] = new RulesElement({
  ...
  te = Feat["Deadly Rage"] = new RulesElement({
    name: "Deadly Rage",
    type: "Feat",
    id: "ID_FMP_FEAT_593",
    source: "Player's Handbook 2",
  ...
  te = Feat["Defender of the Wild"] = new RulesElement({
  ...
  te = Feat["Disciple of Divine Wrath"] = new RulesElement({
  ...
  te = Feat["Disciplined Wild Soul"] = new RulesElement({
  ...
  te = Feat["Distant Advantage"] = new RulesElement({
  ...
  te = Feat["Draconic Spellfury"] = new RulesElement({
  ...
  te = Feat["Earthstrength Resolve"] = new RulesElement({
  ...
  te = Feat["Echoes of Thunder"] = new RulesElement({
  ...
  te = Feat["Enduring Font"] = new RulesElement({
    name: "Enduring Font",
    type: "Feat",
    id: "ID_FMP_FEAT_592",
    source: "Player's Handbook 2",
  ...
  te = Feat["Enduring Rage"] = new RulesElement({
    name: "Enduring Rage",
    type: "Feat",
    id: "ID_FMP_FEAT_468",
    source: "Player's Handbook 2",
  ...
  te = Feat["Enhanced Font of Life"] = new RulesElement({
  ...
  te = Feat["Enraged Boar Form"] = new RulesElement({
  ...
  te = Feat["Epic Fortitude"] = new RulesElement({
    name: "Epic Fortitude",
    type: "Feat",
    id: "ID_FMP_FEAT_537",
    source: "Player's Handbook 2",
  ...
  te = Feat["Epic Reflexes"] = new RulesElement({
    name: "Epic Reflexes",
    type: "Feat",
    id: "ID_FMP_FEAT_538",
    source: "Player's Handbook 2",
  ...
  te = Feat["Epic Will"] = new RulesElement({
    name: "Epic Will",
    type: "Feat",
    id: "ID_FMP_FEAT_539",
    source: "Player's Handbook 2",
  ...
  te = Feat["Expert Ritualist"] = new RulesElement({
  ...
  te = Feat["Fade Ally"] = new RulesElement({
    name: "Fade Ally",
    type: "Feat",
    id: "ID_FMP_FEAT_1040",
    source: "Player's Handbook 2",
  ...
  te = Feat["Ferocious Critical"] = new RulesElement({
  ...
  te = Feat["Ferocious Tiger Form"] = new RulesElement({
  ...
  te = Feat["Fey Trickster"] = new RulesElement({
    name: "Fey Trickster",
    type: "Feat",
    id: "ID_FMP_FEAT_1003",
    source: "Player's Handbook 2",
  ...
  te = Feat["Goliath Greatweapon Prowess"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_INTERNAL_GOLIATH_GREATWEAPON_PROWESS"]);
  ...
  te = Feat["Gorebrute Charge"] = new RulesElement({
  ...
  te = Feat["Group Stealth"] = new RulesElement({
    name: "Group Stealth",
    type: "Feat",
    id: "ID_FMP_FEAT_1006",
    source: "Player's Handbook 2",
  ...
  te = Feat["Guaranteed Retribution"] = new RulesElement({
  ...
  te = Feat["Guardian Spirit"] = new RulesElement({
  ...
  te = Feat["Hunting Wolf Form"] = new RulesElement({
  ...
  te = Feat["Implement Expertise"] = new RulesElement({
  ...
  te = Feat["Implement Expertise (Axe)"] = new RulesElement({
  ...
  te = Feat["Implement Expertise (Blowgun)"] = new RulesElement({
  ...
  te = Feat["Implement Expertise (Bow)"] = new RulesElement({
  ...
  te = Feat["Implement Expertise (Crossbow)"] = new RulesElement({
  ...
  te = Feat["Implement Expertise (Flail)"] = new RulesElement({
  ...
  te = Feat["Implement Expertise (Garrote)"] = new RulesElement({
  ...
  te = Feat["Implement Expertise (Hammer)"] = new RulesElement({
  ...
  te = Feat["Implement Expertise (Heavy Blade)"] = new RulesElement({
  ...
  te = Feat["Implement Expertise (Holy Symbol)"] = new RulesElement({
  ...
  te = Feat["Implement Expertise (Instrument)"] = new RulesElement({
  ...
  te = Feat["Implement Expertise (Ki Focuses)"] = new RulesElement({
  ...
  te = Feat["Implement Expertise (Light Blade)"] = new RulesElement({
  ...
  te = Feat["Implement Expertise (Mace)"] = new RulesElement({
  ...
  te = Feat["Implement Expertise (Orb)"] = new RulesElement({
  ...
  te = Feat["Implement Expertise (Pick)"] = new RulesElement({
  ...
  te = Feat["Implement Expertise (Polearm)"] = new RulesElement({
  ...
  te = Feat["Implement Expertise (Rod)"] = new RulesElement({
  ...
  te = Feat["Implement Expertise (Sling)"] = new RulesElement({
  ...
  te = Feat["Implement Expertise (Spear)"] = new RulesElement({
  ...
  te = Feat["Implement Expertise (Staff)"] = new RulesElement({
  ...
  te = Feat["Implement Expertise (Tome)"] = new RulesElement({
  ...
  te = Feat["Implement Expertise (Totem)"] = new RulesElement({
  ...
  te = Feat["Implement Expertise (Wand)"] = new RulesElement({
  ...
  te = Feat["Improved Armor of Faith"] = new RulesElement({
  ...
  te = Feat["Improved Bull Rush"] = new RulesElement({
  ...
  te = Feat["Improved Cunning"] = new RulesElement({
  ...
  te = Feat["Improved Dragon Soul"] = new RulesElement({
  ...
  te = Feat["Improved Grab"] = new RulesElement({
    name: "Improved Grab",
    type: "Feat",
    id: "ID_FMP_FEAT_658",
    source: "Player's Handbook 2",
  ...
  te = Feat["Improved Majestic Word"] = new RulesElement({
  ...
  te = Feat["Improved Rageblood Vigor"] = new RulesElement({
  ...
  te = Feat["Improved Roar of Triumph"] = new RulesElement({
  ...
  te = Feat["Improved Valor"] = new RulesElement({
    name: "Improved Valor",
    type: "Feat",
    id: "ID_FMP_FEAT_476",
    source: "Player's Handbook 2",
  ...
  te = Feat["Indomitable Will"] = new RulesElement({
  ...
  te = Feat["Inexorable Pursuit"] = new RulesElement({
  ...
  te = Feat["Initiate of the Old Faith"] = new RulesElement({
  ...
  te = Feat["Insightful Preservation"] = new RulesElement({
  ...
  te = Feat["Invigorating Pursuit"] = new RulesElement({
  ...
  te = Feat["Invoked Devastation"] = new RulesElement({
  ...
  te = Feat["Invoker Defense"] = new RulesElement({
  ...
  te = Feat["Long Arm of Virtue"] = new RulesElement({
  ...
  te = Feat["Lyric of Rejuvenation"] = new RulesElement({
  ...
  te = Feat["Markings of the Blessed"] = new RulesElement({
  ...
  te = Feat["Markings of the Victor"] = new RulesElement({
  ...
  te = Feat["Melee Training"] = new RulesElement({
    name: "Melee Training",
    type: "Feat",
    id: "ID_FMP_FEAT_1016",
    source: "Player's Handbook 2",
  ...
  te = Feat["Melee Training (Charisma)"] = new RulesElement({
  ...
  te = Feat["Melee Training (Constitution)"] = new RulesElement({
  ...
  te = Feat["Melee Training (Dexterity)"] = new RulesElement({
  ...
  te = Feat["Melee Training (Intelligence)"] = new RulesElement({
  ...
  te = Feat["Melee Training (Wisdom)"] = new RulesElement({
  ...
  te = Feat["Mighty Enmity"] = new RulesElement({
    name: "Mighty Enmity",
    type: "Feat",
    id: "ID_FMP_FEAT_1055",
    source: "Player's Handbook 2",
  ...
  te = Feat["Mighty Spirit"] = new RulesElement({
    name: "Mighty Spirit",
    type: "Feat",
    id: "ID_FMP_FEAT_566",
    source: "Player's Handbook 2",
  ...
  te = Feat["Nimble Spirit"] = new RulesElement({
    name: "Nimble Spirit",
    type: "Feat",
    id: "ID_FMP_FEAT_565",
    source: "Player's Handbook 2",
  ...
  te = Feat["Oncoming Storm"] = new RulesElement({
    name: "Oncoming Storm",
    type: "Feat",
    id: "ID_FMP_FEAT_519",
    source: "Player's Handbook 2",
  ...
  te = Feat["Onslaught of Enmity"] = new RulesElement({
  ...
  te = Feat["Opportune Reflexes"] = new RulesElement({
  ...
  te = Feat["Overbearing Retribution"] = new RulesElement({
  ...
  te = Feat["Paragon Defenses"] = new RulesElement({
  ...
  te = Feat["Potent Rebirth"] = new RulesElement({
    name: "Potent Rebirth",
    type: "Feat",
    id: "ID_FMP_FEAT_1017",
    source: "Player's Handbook 2",
  ...
  te = Feat["Preserver's Vengeance"] = new RulesElement({
  ...
  te = Feat["Primal Aspect Form"] = new RulesElement({
  ...
  te = Feat["Primal Fury"] = new RulesElement({
    name: "Primal Fury",
    type: "Feat",
    id: "ID_FMP_FEAT_1018",
    source: "Player's Handbook 2",
  ...
  te = Feat["Primal Instinct"] = new RulesElement({
  ...
  te = Feat["Primal Resurgence"] = new RulesElement({
  ...
  te = Feat["Protected Isolation"] = new RulesElement({
  ...
  te = Feat["Protector Spirit Adept"] = new RulesElement({
  ...
  te = Feat["Quick Recovery"] = new RulesElement({
    name: "Quick Recovery",
    type: "Feat",
    id: "ID_FMP_FEAT_532",
    source: "Player's Handbook 2",
  ...
  te = Feat["Quick Wild Shape"] = new RulesElement({
  ...
  te = Feat["Radiant Power"] = new RulesElement({
    name: "Radiant Power",
    type: "Feat",
    id: "ID_FMP_FEAT_1021",
    source: "Player's Handbook 2",
  ...
  te = Feat["Rageblood Recovery"] = new RulesElement({
  ...
  te = Feat["Reserve Maneuver"] = new RulesElement({
  ...
  te = Feat["Resonating Covenant"] = new RulesElement({
  ...
  te = Feat["Restful Healing"] = new RulesElement({
  ...
  te = Feat["Revitalizing Font of Life"] = new RulesElement({
  ...
  te = Feat["Rising Fury"] = new RulesElement({
    name: "Rising Fury",
    type: "Feat",
    id: "ID_FMP_FEAT_454",
    source: "Player's Handbook 2",
  ...
  te = Feat["Robust Defenses"] = new RulesElement({
  ...
  te = Feat["Savage Assault"] = new RulesElement({
    name: "Savage Assault",
    type: "Feat",
    id: "ID_FMP_FEAT_1025",
    source: "Player's Handbook 2",
  ...
  te = Feat["Scouring Wrath"] = new RulesElement({
    name: "Scouring Wrath",
    type: "Feat",
    id: "ID_FMP_FEAT_1079",
    source: "Player's Handbook 2",
  ...
  te = Feat["Shadow Skulk"] = new RulesElement({
    name: "Shadow Skulk",
    type: "Feat",
    id: "ID_FMP_FEAT_1026",
    source: "Player's Handbook 2",
  ...
  te = Feat["Shared Healing Spirit"] = new RulesElement({
  ...
  te = Feat["Sorcerous Blade Channeling"] = new RulesElement({
  ...
  te = Feat["Sorcerous Flux"] = new RulesElement({
    name: "Sorcerous Flux",
    type: "Feat",
    id: "ID_FMP_FEAT_663",
    source: "Player's Handbook 2",
  ...
  te = Feat["Speaker of the Gods"] = new RulesElement({
  ...
  te = Feat["Speed Loader"] = new RulesElement({
    name: "Speed Loader",
    type: "Feat",
    id: "ID_FMP_FEAT_396",
    source: "Player's Handbook 2",
  ...
  te = Feat["Spirit Speaker"] = new RulesElement({
    name: "Spirit Speaker",
    type: "Feat",
    id: "ID_FMP_FEAT_1029",
    source: "Player's Handbook 2",
  ...
  te = Feat["Spirit Talker"] = new RulesElement({
    name: "Spirit Talker",
    type: "Feat",
    id: "ID_FMP_FEAT_668",
    source: "Player's Handbook 2",
  ...
  te = Feat["Stalker Spirit Adept"] = new RulesElement({
  ...
  te = Feat["Stalking Panther Form"] = new RulesElement({
  ...
  te = Feat["Strength From Pain"] = new RulesElement({
  ...
  te = Feat["Strength of Valor"] = new RulesElement({
  ...
  te = Feat["Sudden Roots"] = new RulesElement({
    name: "Sudden Roots",
    type: "Feat",
    id: "ID_FMP_FEAT_585",
    source: "Player's Handbook 2",
  ...
  te = Feat["Surging Flame"] = new RulesElement({
    name: "Surging Flame",
    type: "Feat",
    id: "ID_FMP_FEAT_517",
    source: "Player's Handbook 2",
  ...
  te = Feat["Surprising Disappearance"] = new RulesElement({
  ...
  te = Feat["Thaneborn Advance"] = new RulesElement({
  ...
  te = Feat["Thaneborn Conqueror"] = new RulesElement({
  ...
  te = Feat["Thirst for Battle"] = new RulesElement({
  ...
  te = Feat["Timely Respite"] = new RulesElement({
    name: "Timely Respite",
    type: "Feat",
    id: "ID_FMP_FEAT_507",
    source: "Player's Handbook 2",
  ...
  te = Feat["Transcendent Lineage"] = new RulesElement({
  ...
  te = Feat["Two-Weapon Opening"] = new RulesElement({
  ...
  te = Feat["Two-Weapon Threat"] = new RulesElement({
  ...
  te = Feat["Unrelenting Assault"] = new RulesElement({
  ...
  te = Feat["Unyielding Fortitude"] = new RulesElement({
  ...
  te = Feat["Unyielding Stone"] = new RulesElement({
  ...
  te = Feat["Vanishing Act"] = new RulesElement({
    name: "Vanishing Act",
    type: "Feat",
    id: "ID_FMP_FEAT_1058",
    source: "Player's Handbook 2",
  ...
  te = Feat["Versatile Master"] = new RulesElement({
  ...
  te = Feat["Vexing Flanker"] = new RulesElement({
    name: "Vexing Flanker",
    type: "Feat",
    id: "ID_FMP_FEAT_535",
    source: "Player's Handbook 2",
  ...
  te = Feat["Weapon Expertise"] = new RulesElement({
  ...
  te = Feat["Weapon Expertise (Axe)"] = new RulesElement({
  ...
  te = Feat["Weapon Expertise (Blowgun)"] = new RulesElement({
  ...
  te = Feat["Weapon Expertise (Bow)"] = new RulesElement({
  ...
  te = Feat["Weapon Expertise (Crossbow)"] = new RulesElement({
  ...
  te = Feat["Weapon Expertise (Flail)"] = new RulesElement({
  ...
  te = Feat["Weapon Expertise (Garrote)"] = new RulesElement({
  ...
  te = Feat["Weapon Expertise (Hammer)"] = new RulesElement({
  ...
  te = Feat["Weapon Expertise (Heavy Blade)"] = new RulesElement({
  ...
  te = Feat["Weapon Expertise (Light Blade)"] = new RulesElement({
  ...
  te = Feat["Weapon Expertise (Mace)"] = new RulesElement({
  ...
  te = Feat["Weapon Expertise (Pick)"] = new RulesElement({
  ...
  te = Feat["Weapon Expertise (Polearm)"] = new RulesElement({
  ...
  te = Feat["Weapon Expertise (Sling)"] = new RulesElement({
  ...
  te = Feat["Weapon Expertise (Spear)"] = new RulesElement({
  ...
  te = Feat["Weapon Expertise (Staff)"] = new RulesElement({
  ...
  te = Feat["Weapon Expertise (Unarmed)"] = new RulesElement({
  ...
  te = Feat["Wild Senses"] = new RulesElement({
    name: "Wild Senses",
    type: "Feat",
    id: "ID_FMP_FEAT_1033",
    source: "Player's Handbook 2",
  ...
  te = Feat["Wild Spellfury"] = new RulesElement({
    name: "Wild Spellfury",
    type: "Feat",
    id: "ID_FMP_FEAT_1050",
    source: "Player's Handbook 2",
  ...
  te = Feat["Wildblood Cunning"] = new RulesElement({
  ...
  te = Feat["Wildblood Speed"] = new RulesElement({
