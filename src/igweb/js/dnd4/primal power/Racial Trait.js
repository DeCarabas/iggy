(function(global, undefined) {
  ...
  te = Racial_Trait["Past Spirit (Bladeling)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_COUNTSASRACE_BLADELING"]);
      model.grant(elements.id["ID_FMP_POWER_5599"]);
    }
  });
  byID[te.id] = te;
  
  te = Racial_Trait["Past Spirit (Bugbear)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_COUNTSASRACE_BUGBEAR"]);
      model.grant(elements.id["ID_FMP_POWER_2324"]);
    }
  });
  byID[te.id] = te;
  
  te = Racial_Trait["Past Spirit (Bullywug)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_COUNTSASRACE_BULLYWUG"]);
    }
  });
  byID[te.id] = te;
  
  te = Racial_Trait["Past Spirit (Changeling)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_COUNTSASRACE_CHANGELING"]);
      model.grant(elements.id["ID_FMP_POWER_7546"]);
    }
  });
  byID[te.id] = te;
  
  te = Racial_Trait["Past Spirit (Deva)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_COUNTSASRACE_DEVA"]);
      model.grant(elements.id["ID_FMP_POWER_6186"]);
    }
  });
  byID[te.id] = te;
  
  te = Racial_Trait["Past Spirit (Dragonborn)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_COUNTSASRACE_DRAGONBORN"]);
  ...
  te = Racial_Trait["Past Spirit (Drow)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_COUNTSASRACE_DROW"]);
      model.select('Power', 1, {
  ...
  te = Racial_Trait["Past Spirit (Duergar)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_COUNTSASRACE_DUERGAR"]);
      model.grant(elements.id["ID_FMP_POWER_27"]);
    }
  });
  byID[te.id] = te;
  
  te = Racial_Trait["Past Spirit (Dwarf)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_COUNTSASRACE_DWARF"]);
      model.grant(elements.id["ID_FMP_POWER_13211"]);
    }
  });
  byID[te.id] = te;
  
  te = Racial_Trait["Past Spirit (Eladrin)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_COUNTSASRACE_ELADRIN"]);
      model.grant(elements.id["ID_FMP_POWER_1449"]);
    }
  });
  byID[te.id] = te;
  
  te = Racial_Trait["Past Spirit (Elf)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_COUNTSASRACE_ELF"]);
      model.grant(elements.id["ID_FMP_POWER_1450"]);
    }
  });
  byID[te.id] = te;
  
  te = Racial_Trait["Past Spirit (Genasi)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_COUNTSASRACE_GENASI"]);
      model.select('Power', 1, {
  ...
  te = Racial_Trait["Past Spirit (Githyanki)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_COUNTSASRACE_GITHYANKI"]);
      model.grant(elements.id["ID_FMP_POWER_2474"]);
    }
  });
  byID[te.id] = te;
  
  te = Racial_Trait["Past Spirit (Githzerai)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_COUNTSASRACE_GITHZERAI"]);
      model.grant(elements.id["ID_FMP_POWER_2475"]);
    }
  });
  byID[te.id] = te;
  
  te = Racial_Trait["Past Spirit (Gnoll)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_COUNTSASRACE_GNOLL"]);
      model.grant(elements.id["ID_FMP_POWER_2476"]);
    }
  });
  byID[te.id] = te;
  
  te = Racial_Trait["Past Spirit (Gnome)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_COUNTSASRACE_GNOME"]);
      model.grant(elements.id["ID_FMP_POWER_377"]);
    }
  });
  byID[te.id] = te;
  
  te = Racial_Trait["Past Spirit (Goblin)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_COUNTSASRACE_GOBLIN"]);
    }
  });
  byID[te.id] = te;
  
  te = Racial_Trait["Past Spirit (Goliath)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_COUNTSASRACE_GOLIATH"]);
      model.grant(elements.id["ID_FMP_POWER_6188"]);
    }
  });
  byID[te.id] = te;
  
  te = Racial_Trait["Past Spirit (Half-Elf)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_COUNTSASRACE_HALF-ELF"]);
    }
  });
  byID[te.id] = te;
  
  te = Racial_Trait["Past Spirit (Halfling)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_COUNTSASRACE_HALFLING"]);
      model.grant(elements.id["ID_FMP_POWER_1452"]);
    }
  });
  byID[te.id] = te;
  
  te = Racial_Trait["Past Spirit (Half-Orc)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_COUNTSASRACE_HALF-ORC"]);
      model.grant(elements.id["ID_FMP_POWER_6189"]);
    }
  });
  byID[te.id] = te;
  
  te = Racial_Trait["Past Spirit (Hobgoblin)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_COUNTSASRACE_HOBGOBLIN"]);
      model.grant(elements.id["ID_FMP_POWER_2478"]);
    }
  });
  byID[te.id] = te;
  
  te = Racial_Trait["Past Spirit (Human)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_COUNTSASRACE_HUMAN"]);
    }
  });
  byID[te.id] = te;
  
  te = Racial_Trait["Past Spirit (Kalashtar)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_COUNTSASRACE_KALASHTAR"]);
      model.grant(elements.id["ID_FMP_POWER_7548"]);
    }
  });
  byID[te.id] = te;
  
  te = Racial_Trait["Past Spirit (Kenku)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_COUNTSASRACE_KENKU"]);
    }
  });
  byID[te.id] = te;
  
  te = Racial_Trait["Past Spirit (Kobold)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_COUNTSASRACE_KOBOLD"]);
    }
  });
  byID[te.id] = te;
  
  te = Racial_Trait["Past Spirit (Longtooth Shifter)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_COUNTSASRACE_LONGTOOTH_SHIFTER"]);
      model.grant(elements.id["ID_FMP_POWER_2483"]);
    }
  });
  byID[te.id] = te;
  
  te = Racial_Trait["Past Spirit (Minotaur)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_COUNTSASRACE_MINOTAUR"]);
      model.grant(elements.id["ID_FMP_POWER_2480"]);
    }
  });
  byID[te.id] = te;
  
  te = Racial_Trait["Past Spirit (Orc)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_COUNTSASRACE_ORC"]);
      model.grant(elements.id["ID_FMP_POWER_2481"]);
    }
  });
  byID[te.id] = te;
  
  te = Racial_Trait["Past Spirit (Razorclaw Shifter)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_COUNTSASRACE_RAZORCLAW_SHIFTER"]);
      model.grant(elements.id["ID_FMP_POWER_2484"]);
    }
  });
  byID[te.id] = te;
  
  te = Racial_Trait["Past Spirit (Revenant)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_COUNTSASRACE_REVENANT"]);
      model.grant(elements.id["ID_FMP_POWER_8278"]);
    }
  });
  byID[te.id] = te;
  
  te = Racial_Trait["Past Spirit (Shadar-kai)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_COUNTSASRACE_SHADAR-KAI"]);
      model.grant(elements.id["ID_FMP_POWER_2482"]);
    }
  });
  byID[te.id] = te;
  
  te = Racial_Trait["Past Spirit (Shardmind)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_COUNTSASRACE_SHARDMIND"]);
      model.grant(elements.id["ID_FMP_POWER_11052"]);
    }
  });
  byID[te.id] = te;
  
  te = Racial_Trait["Past Spirit (Tiefling)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_COUNTSASRACE_TIEFLING"]);
      model.grant(elements.id["ID_FMP_POWER_1628"]);
    }
  });
  byID[te.id] = te;
  
  te = Racial_Trait["Past Spirit (Warforged)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_COUNTSASRACE_WARFORGED"]);
      model.grant(elements.id["ID_FMP_POWER_2485"]);
    }
  });
  byID[te.id] = te;
  
  te = Racial_Trait["Past Spirit (Wilden)"] = new RulesElement({
    ...
    rules: function(model) {
      model.grant(elements.id["ID_INTERNAL_COUNTSASRACE_WILDEN"]);
      model.select('Power', 1, {
