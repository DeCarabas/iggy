define(['engine', 'dnd4model'], function(engine, dnd4model) {
  ...
  te = Magic_Item["Awe of the Dragon's Altar (epic tier)"] = new engine.RulesElement({
    ...
    categories: ["Awe of the Dragon's Altar (epic tier)", "ID_FMP_MAGIC_ITEM_9281"],
  ...
  te = Magic_Item["Awe of the Dragon's Altar (heroic tier)"] = new engine.RulesElement({
    ...
    source: "Dungeon Magazine 180",
    categories: ["Awe of the Dragon's Altar (heroic tier)", "ID_FMP_MAGIC_ITEM_9277"],
    rules: function(model) {
      // unsupported rule: cbimporter.Rules.ModifyRule
    }
  });
  ...
  te = Magic_Item["Awe of the Dragon's Altar (paragon tier)"] = new engine.RulesElement({
    ...
    source: "Dungeon Magazine 180",
    categories: ["Awe of the Dragon's Altar (paragon tier)", "ID_FMP_MAGIC_ITEM_9279"],
    rules: function(model) {
      // unsupported rule: cbimporter.Rules.ModifyRule
    }
  });
  ...
  te = Magic_Item["Deadstone Weapon +1"] = new engine.RulesElement({
    ...
    source: "Dungeon Magazine 180",
    categories: ["Deadstone Weapon +1", "ID_FMP_MAGIC_ITEM_9271"]
  });
  byID[te.id] = te;
  ...
  te = Magic_Item["Deadstone Weapon +2"] = new engine.RulesElement({
    ...
    source: "Dungeon Magazine 180",
    categories: ["Deadstone Weapon +2", "ID_FMP_MAGIC_ITEM_9272"]
  });
  byID[te.id] = te;
  ...
  te = Magic_Item["Plague of the Dragon's Altar (epic tier)"] = new engine.RulesElement({
    ...
    source: "Dungeon Magazine 180",
    categories: ["Plague of the Dragon's Altar (epic tier)", "ID_FMP_MAGIC_ITEM_9287"]
  });
  byID[te.id] = te;
  ...
  te = Magic_Item["Plague of the Dragon's Altar (heroic tier)"] = new engine.RulesElement({
    ...
    source: "Dungeon Magazine 180",
    categories: ["Plague of the Dragon's Altar (heroic tier)", "ID_FMP_MAGIC_ITEM_9283"]
  });
  byID[te.id] = te;
  ...
  te = Magic_Item["Plague of the Dragon's Altar (paragon tier)"] = new engine.RulesElement({
    ...
    source: "Dungeon Magazine 180",
    categories: ["Plague of the Dragon's Altar (paragon tier)", "ID_FMP_MAGIC_ITEM_9285"]
  });
  byID[te.id] = te;
  ...
  te = Magic_Item["Scar of the Dragon's Altar (epic tier)"] = new engine.RulesElement({
    ...
    source: "Dungeon Magazine 180",
    categories: ["Scar of the Dragon's Altar (epic tier)", "ID_FMP_MAGIC_ITEM_9293"]
  });
  byID[te.id] = te;
  ...
  te = Magic_Item["Scar of the Dragon's Altar (heroic tier)"] = new engine.RulesElement({
    ...
    source: "Dungeon Magazine 180",
    categories: ["Scar of the Dragon's Altar (heroic tier)", "ID_FMP_MAGIC_ITEM_9289"]
  });
  byID[te.id] = te;
  ...
  te = Magic_Item["Scar of the Dragon's Altar (paragon tier)"] = new engine.RulesElement({
    ...
    source: "Dungeon Magazine 180",
    categories: ["Scar of the Dragon's Altar (paragon tier)", "ID_FMP_MAGIC_ITEM_9291"]
  });
  byID[te.id] = te;
