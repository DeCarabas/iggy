(function(global, undefined) {
  ...
  te = Background["Accursed Lineage"] = new RulesElement({
  ...
  te = Background["Adventurer's Scion"] = new RulesElement({
  ...
  te = Background["Curious Archeologist"] = new RulesElement({
  ...
  te = Background["Lost Kin"] = new RulesElement({
    name: "Lost Kin",
    type: "Background",
  ...
  te = Background["Necromancer's Chattel"] = new RulesElement({
  ...
  te = Background["Restless Dead"] = new RulesElement({
    name: "Restless Dead",
    type: "Background",
  ...
  te = Background["Touched by Darkness"] = new RulesElement({
